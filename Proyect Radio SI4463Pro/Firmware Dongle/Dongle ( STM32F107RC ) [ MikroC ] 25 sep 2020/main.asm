...
; end of _vDongleLoop
_vUARTISR:
;uarthandler.c,71 :: 		void vUARTISR() iv IVT_INT_USART1 ics ICS_AUTO{
SUB	SP, SP, #4
STR	LR, [SP, #0]
;uarthandler.c,72 :: 		LEDBlue =~ LEDBlue;
...
;uarthandler.c,74 :: 		if( USART1_SRbits.RXNE == 1 ){
...
IT	EQ
BEQ	L_vUARTISR4
;uarthandler.c,75 :: 		ucTempByteUART = USART1_DR;
...
STRB	R1, [R0, #0]
;uarthandler.c,76 :: 		if( ucTempByteUART == '\n' ){
LDRB	R0, [R0, #0]
CMP	R0, #10
IT	NE
BNE	L_vUARTISR5
;uarthandler.c,77 :: 		pcRxUARTBuffer[ usUARTMessageLength++ ] = ucTempByteUART;
...
ADDS	R0, R0, #1
STRH	R0, [R3, #0]
;uarthandler.c,78 :: 		ucUARTDataReady = 1;
MOVS	R1, #1
MOVW	R0, #lo_addr(_ucUARTDataReady+0)
MOVT	R0, #hi_addr(_ucUARTDataReady+0)
STRB	R1, [R0, #0]
;uarthandler.c,79 :: 		ucTempByteUART = 0;
MOVS	R0, #0
STRB	R0, [R2, #0]
;uarthandler.c,80 :: 		LEDBlue = PIN_LEVEL_LOW;
MOVS	R1, #0
SXTB	R1, R1
MOVW	R0, #lo_addr(GPIOC_ODR+0)
MOVT	R0, #hi_addr(GPIOC_ODR+0)
...
BAL	L_vUARTISR6
L_vUARTISR5:
;uarthandler.c,83 :: 		pcRxUARTBuffer[ usUARTMessageLength++ ] = ucTempByteUART;
MOVW	R3, #lo_addr(_usUARTMessageLength+0)
MOVT	R3, #hi_addr(_usUARTMessageLength+0)
LDRH	R1, [R3, #0]
MOVW	R0, #lo_addr(_pcRxUARTBuffer+0)
...
ADDS	R0, R0, #1
STRH	R0, [R3, #0]
;uarthandler.c,84 :: 		ucTempByteUART = 0;
MOVS	R0, #0
STRB	R0, [R1, #0]
;uarthandler.c,85 :: 		}
L_vUARTISR6:
;uarthandler.c,86 :: 		}
L_vUARTISR4:
;uarthandler.c,87 :: 		if( USART1_SRbits.ORE == 1 ){
MOVW	R0, #lo_addr(USART1_SRbits+0)
MOVT	R0, #hi_addr(USART1_SRbits+0)
_LX	[R0, ByteOffset(USART1_SRbits+0)]
CMP	R0, #0
IT	EQ
BEQ	L_vUARTISR7
;uarthandler.c,88 :: 		STM_LOGE( "[ IRQ ] UART Overrun\r\n", NULL );
MOVS	R2, #0
SXTB	R2, R2
...
BL	_PrintOut+0
ADD	SP, SP, #12
;uarthandler.c,89 :: 		ucTempByteUART = USART1_SR;
...
MOVT	R1, #hi_addr(_ucTempByteUART+0)
STRB	R0, [R1, #0]
;uarthandler.c,90 :: 		ucTempByteUART = USART1_DR;
MOVW	R0, #lo_addr(USART1_DR+0)
MOVT	R0, #hi_addr(USART1_DR+0)
LDR	R0, [R0, #0]
STRB	R0, [R1, #0]
;uarthandler.c,91 :: 		LEDBlue = PIN_LEVEL_LOW;
MOVS	R1, #0
SXTB	R1, R1
MOVW	R0, #lo_addr(GPIOC_ODR+0)
MOVT	R0, #hi_addr(GPIOC_ODR+0)
...
; end of _vUARTISR
_vUARTTxInit:
;uarthandler.c,101 :: 		void vUARTTxInit(){
SUB	SP, SP, #4
STR	LR, [SP, #0]
;uarthandler.c,102 :: 		UART1_Init_Advanced( 921600, _UART_8_BIT_DATA, _UART_NOPARITY, _UART_ONE_STOPBIT, &_GPIO_MODULE_USART1_PA9_10 );
...
; end of _vUARTTxInit
_vUARTRxInit:
;uarthandler.c,108 :: 		void vUARTRxInit(){
SUB	SP, SP, #4
STR	LR, [SP, #0]
;uarthandler.c,109 :: 		USART1_CR1bits.RE       = 1;
MOVS	R1, #1
SXTB	R1, R1
MOVW	R0, #lo_addr(USART1_CR1bits+0)
MOVT	R0, #hi_addr(USART1_CR1bits+0)
_SX	[R0, ByteOffset(USART1_CR1bits+0)]
;uarthandler.c,110 :: 		USART1_CR1bits.RXNEIE   = 1;
MOVW	R0, #lo_addr(USART1_CR1bits+0)
MOVT	R0, #hi_addr(USART1_CR1bits+0)
_SX	[R0, ByteOffset(USART1_CR1bits+0)]
;uarthandler.c,112 :: 		NVIC_IntEnable( IVT_INT_USART1 );
MOVW	R0, #53
...
; end of _vUARTRxInit
_vUARTRxMessage:
;uarthandler.c,118 :: 		void vUARTRxMessage(){
SUB	SP, SP, #4
STR	LR, [SP, #0]
;uarthandler.c,119 :: 		uint16_t usCounter = 0;
;uarthandler.c,126 :: 		STM_LOGV( "[ UART RX ] Packet: %s", pcRxUARTBuffer );
...
BL	_PrintOut+0
ADD	SP, SP, #12
;uarthandler.c,128 :: 		vUARTCommands( pcRxUARTBuffer );
MOVW	R0, #lo_addr(_pcRxUARTBuffer+0)
MOVT	R0, #hi_addr(_pcRxUARTBuffer+0)
BL	_vUARTCommands+0
;uarthandler.c,130 :: 		memset( pcRxUARTBuffer, '\0', sizeof( pcRxUARTBuffer ) );
MOVW	R2, #2048
SXTH	R2, R2
MOVS	R1, #0
MOVW	R0, #lo_addr(_pcRxUARTBuffer+0)
MOVT	R0, #hi_addr(_pcRxUARTBuffer+0)
BL	_memset+0
;uarthandler.c,131 :: 		usUARTMessageLength = 0;
MOVS	R1, #0
...
_vUARTCommands:
;uarthandler.c,137 :: 		void vUARTCommands( uint8_t * pcInBuffer ){
SUB	SP, SP, #84
STR	LR, [SP, #0]
STR	R0, [SP, #68]
;uarthandler.c,138 :: 		uint8_t ucCommandCounter = 0;
;uarthandler.c,139 :: 		uint8_t ucCounter = 0;
;uarthandler.c,140 :: 		uint8_t ucPosition = 0;
;uarthandler.c,145 :: 		uint16_t usTempData = 0;
;uarthandler.c,146 :: 		uint8_t ucDeviceModel = 0;
;uarthandler.c,148 :: 		uint16_t usTempChannel = 0;
;uarthandler.c,149 :: 		uint16_t usTempNetwork = 0;
;uarthandler.c,150 :: 		uint8_t ucIgnoreNetwork = 0;
MOVS	R1, #0
STRB	R1, [SP, #67]
;uarthandler.c,152 :: 		for( ucCommandCounter = 0; ucCommandCounter < UART_Commands; ucCommandCounter++ ){
MOVS	R1, #0
STRB	R1, [SP, #72]
L_vUARTCommands8:
LDRB	R1, [SP, #72]
...
;uarthandler.c,153 :: 		if( strstr( pcInBuffer, pcUARTCommand[ ucCommandCounter ] ) ){
LDRB	R1, [SP, #72]
LSLS	R2, R1, #2
...
;uarthandler.c,154 :: 		switch( ucCommandCounter ){
IT	AL
BAL	L_vUARTCommands12
;uarthandler.c,155 :: 		case UART_CMD_WHO:
L_vUARTCommands14:
;uarthandler.c,156 :: 		UART1_Write_Text( "DONGLE\r\n" );
ADD	R11, SP, #58
ADD	R10, R11, #9
...
;uarthandler.c,157 :: 		Sound_Play( 1000, 100 );
MOVS	R1, #100
MOVW	R0, #1000
BL	_Sound_Play+0
;uarthandler.c,158 :: 		Delay_ms( 30 );
MOVW	R7, #32319
MOVT	R7, #5
NOP
NOP
...
NOP
NOP
;uarthandler.c,159 :: 		Sound_Play( 1000, 100 );
MOVS	R1, #100
MOVW	R0, #1000
BL	_Sound_Play+0
;uarthandler.c,160 :: 		break;
IT	AL
BAL	L_vUARTCommands13
;uarthandler.c,161 :: 		case UART_CMD_SEND:
L_vUARTCommands17:
;uarthandler.c,162 :: 		STM_LOGD( "[ UART ] Send Message\r\n", NULL );
MOVS	R3, #0
SXTB	R3, R3
...
BL	_PrintOut+0
ADD	SP, SP, #12
;uarthandler.c,163 :: 		vRf4463SetChannels( RF4463_DEFAULT_CHANNEL, RF4463_DEFAULT_CHANNEL );
MOVS	R1, #5
MOVS	R0, #5
BL	_vRf4463SetChannels+0
;uarthandler.c,164 :: 		vRf4463SetNetwork( RF4463_DEFAULT_NETWORK );
MOVS	R0, #5
BL	_vRf4463SetNetwork+0
;uarthandler.c,165 :: 		memset( pcTempBuffer, '\0', 50 );
ADD	R1, SP, #8
MOVS	R2, #50
SXTH	R2, R2
MOV	R0, R1
MOVS	R1, #0
BL	_memset+0
;uarthandler.c,167 :: 		ucPosition = 5;
...
L_vUARTCommands19:
;uarthandler.c,178 :: 		vRF4463SetNode( NODE_FACTORY );
; ucCounter start address is: 0 (R0)
STRB	R0, [SP, #4]
MOVS	R0, #254
BL	_vRF4463SetNode+0
LDRB	R0, [SP, #4]
;uarthandler.c,179 :: 		vRF4463TxMessage( pcTempBuffer, ucCounter, NODE_BROADCAST, TABLE_RF_TEST, RF_TEST_QR );
MOVS	R2, #2
ADD	R1, SP, #8
PUSH	(R2)
STR	R1, [SP, #8]
...
ADD	SP, SP, #4
;uarthandler.c,180 :: 		break;
IT	AL
BAL	L_vUARTCommands13
;uarthandler.c,181 :: 		case UART_CMD_END:
L_vUARTCommands24:
;uarthandler.c,182 :: 		STM_LOGD( "[ UART ] End Factory Stage\r\n", NULL );
MOVS	R3, #0
SXTB	R3, R3
...
BL	_PrintOut+0
ADD	SP, SP, #12
;uarthandler.c,185 :: 		memset( pcSentQR, '\0', 15 );
MOVS	R2, #15
SXTH	R2, R2
MOVS	R1, #0
...
BL	_memset+0
;uarthandler.c,187 :: 		ucPosition = 6;
; ucPosition start address is: 12 (R3)
MOVS	R3, #6
;uarthandler.c,189 :: 		for( ucCounter = 0; ucCounter < usUARTMessageLength; ucCounter++ ){
; ucCounter start address is: 0 (R0)
MOVS	R0, #0
; ucCounter end address is: 0 (R0)
; ucPosition end address is: 12 (R3)
...
;uarthandler.c,190 :: 		if( pcInBuffer[ ucPosition ] == '\r' || pcInBuffer[ ucPosition ] == '\n' ){
LDR	R1, [SP, #68]
ADDS	R1, R1, R3
LDRB	R1, [R1, #0]
CMP	R1, #13
...
L__vUARTCommands341:
L__vUARTCommands340:
;uarthandler.c,191 :: 		break;
IT	AL
BAL	L_vUARTCommands26
;uarthandler.c,192 :: 		}
L_vUARTCommands30:
;uarthandler.c,193 :: 		pcSentQR[ ucCounter ] = pcInBuffer[ ucPosition++ ];
; ucPosition start address is: 12 (R3)
...
L_vUARTCommands26:
;uarthandler.c,196 :: 		vRF4463SetNode( NODE_FACTORY );
; ucCounter start address is: 0 (R0)
STRB	R0, [SP, #4]
MOVS	R0, #254
BL	_vRF4463SetNode+0
LDRB	R0, [SP, #4]
;uarthandler.c,197 :: 		vRF4463TxMessage( pcSentQR, ucCounter, NODE_BROADCAST, TABLE_RF_TEST, RF_TEST_OK );
MOVS	R1, #3
PUSH	(R1)
MOVS	R3, #1
MOVS	R2, #255
...
BL	_vRF4463TxMessage+0
ADD	SP, SP, #4
;uarthandler.c,198 :: 		break;
IT	AL
BAL	L_vUARTCommands13
;uarthandler.c,199 :: 		case UART_CMD_STAGE:
L_vUARTCommands31:
;uarthandler.c,200 :: 		STM_LOGD( "[ UART ] Get Stage\r\n", NULL );
MOVS	R3, #0
SXTB	R3, R3
...
BL	_PrintOut+0
ADD	SP, SP, #12
;uarthandler.c,202 :: 		vRf4463SetChannels( RF4463_DEFAULT_CHANNEL, RF4463_DEFAULT_CHANNEL );
MOVS	R1, #5
MOVS	R0, #5
BL	_vRf4463SetChannels+0
;uarthandler.c,203 :: 		vRf4463SetNetwork( RF4463_DEFAULT_NETWORK );
MOVS	R0, #5
BL	_vRf4463SetNetwork+0
;uarthandler.c,204 :: 		vRF4463SetNode( NODE_FACTORY );
MOVS	R0, #254
BL	_vRF4463SetNode+0
;uarthandler.c,206 :: 		vRF4463TxMessage( NULL, NULL, NODE_BROADCAST, TABLE_RF_TEST, RF_TEST_STAGE );
MOVS	R1, #4
PUSH	(R1)
MOVS	R3, #1
MOVS	R2, #255
...
IT	AL
BAL	L_vUARTCommands13
;uarthandler.c,208 :: 		case UART_CMD_REBOOT:
L_vUARTCommands32:
;uarthandler.c,209 :: 		STM_LOGD( "[ UART ] Reboot\r\n", NULL );
MOVS	R3, #0
SXTB	R3, R3
...
BL	_PrintOut+0
ADD	SP, SP, #12
;uarthandler.c,211 :: 		LEDBlue = 0;
MOVS	R2, #0
SXTB	R2, R2
MOVW	R1, #lo_addr(GPIOC_ODR+0)
MOVT	R1, #hi_addr(GPIOC_ODR+0)
_SX	[R1, ByteOffset(GPIOC_ODR+0)]
;uarthandler.c,212 :: 		LEDGreen = 0;
MOVW	R1, #lo_addr(GPIOC_ODR+0)
MOVT	R1, #hi_addr(GPIOC_ODR+0)
_SX	[R1, ByteOffset(GPIOC_ODR+0)]
;uarthandler.c,213 :: 		LEDRed = 1;
MOVS	R2, #1
SXTB	R2, R2
MOVW	R1, #lo_addr(GPIOC_ODR+0)
MOVT	R1, #hi_addr(GPIOC_ODR+0)
_SX	[R1, ByteOffset(GPIOC_ODR+0)]
;uarthandler.c,215 :: 		Delay_ms( 1000 );
MOVW	R7, #6911
MOVT	R7, #183
NOP
NOP
...
NOP
NOP
;uarthandler.c,216 :: 		SystemReset();
BL	_SystemReset+0
;uarthandler.c,217 :: 		break;
IT	AL
BAL	L_vUARTCommands13
;uarthandler.c,218 :: 		case UART_CMD_PING:
L_vUARTCommands35:
;uarthandler.c,219 :: 		STM_LOGD( "[ UART ] Ping\r\n", NULL );
MOVS	R3, #0
SXTB	R3, R3
...
BL	_PrintOut+0
ADD	SP, SP, #12
;uarthandler.c,220 :: 		vRF4463SetNode( HUB_NODE );
MOVS	R0, #1
BL	_vRF4463SetNode+0
;uarthandler.c,221 :: 		vRF4463TxMessage( NULL, NULL, REMOTE_DEFAULT, TABLE_RF_TEST, RF_TEST_DEVICE_PING );
MOVS	R1, #0
PUSH	(R1)
MOVS	R3, #1
MOVS	R2, #2
...
L_vUARTCommands38:
;uarthandler.c,234 :: 		for( ucSearchedModelId = 0; ucSearchedModelId < DEVICE_MODEL_ID_TOTAL; ucSearchedModelId++ ){
MOVS	R2, #0
...
L_vUARTCommands41:
;uarthandler.c,240 :: 		vRF4463SetNode( HUB_NODE );
MOVS	R0, #1
BL	_vRF4463SetNode+0
;uarthandler.c,241 :: 		vRF4463TxMessage( pcTempBuffer, strlen( pcTempBuffer ), REMOTE_DEFAULT, TABLE_RF_SETUP, RF_SETUP_FIND_BY_QR );
MOVS	R1, #1
STRB	R1, [SP, #80]
ADD	R1, SP, #8
MOV	R0, R1
...
BL	_vRF4463TxMessage+0
ADD	SP, SP, #4
;uarthandler.c,242 :: 		break;
IT	AL
BAL	L_vUARTCommands13
;uarthandler.c,243 :: 		case UART_CMD_REMOVE:
L_vUARTCommands44:
;uarthandler.c,244 :: 		STM_LOGD( "[ UART ] Remove\r\n", NULL );
MOVS	R3, #0
SXTB	R3, R3
...
BL	_PrintOut+0
ADD	SP, SP, #12
;uarthandler.c,246 :: 		memset( pcTempBuffer, '\0', 50 );
ADD	R1, SP, #8
MOVS	R2, #50
SXTH	R2, R2
MOV	R0, R1
MOVS	R1, #0
BL	_memset+0
;uarthandler.c,248 :: 		ucPosition = 7;
; ucPosition start address is: 28 (R7)
MOVS	R7, #7
;uarthandler.c,250 :: 		for( ucCounter = 0; ; ucCounter++ ){
; ucCounter start address is: 0 (R0)
MOVS	R0, #0
; ucPosition end address is: 28 (R7)
; ucCounter end address is: 0 (R0)
UXTB	R3, R7
L_vUARTCommands45:
;uarthandler.c,251 :: 		if( pcInBuffer[ ucPosition ] == '\r' || pcInBuffer[ ucPosition ] == '\n' ){
; ucCounter start address is: 0 (R0)
; ucPosition start address is: 12 (R3)
LDR	R1, [SP, #68]
ADDS	R1, R1, R3
...
L__vUARTCommands343:
L__vUARTCommands342:
;uarthandler.c,252 :: 		break;
IT	AL
BAL	L_vUARTCommands46
;uarthandler.c,253 :: 		}
L_vUARTCommands50:
;uarthandler.c,254 :: 		pcTempBuffer[ ucCounter ] = pcInBuffer[ ucPosition++ ];
; ucPosition start address is: 12 (R3)
; ucCounter start address is: 0 (R0)
ADD	R1, SP, #8
ADDS	R2, R1, R0
...
L_vUARTCommands46:
;uarthandler.c,257 :: 		usTempData = atoi( pcTempBuffer );
ADD	R1, SP, #8
MOV	R0, R1
BL	_atoi+0
; usTempData start address is: 8 (R2)
UXTH	R2, R0
;uarthandler.c,258 :: 		vRF4463SetNode( HUB_NODE );
MOVS	R0, #1
BL	_vRF4463SetNode+0
;uarthandler.c,259 :: 		vRF4463TxMessage( NULL, NULL, usTempData, TABLE_RF_SETUP, RF_SETUP_REMOVE );
MOVS	R1, #5
PUSH	(R1)
MOVS	R3, #2
UXTB	R2, R2
...
BL	_vRF4463TxMessage+0
ADD	SP, SP, #4
;uarthandler.c,260 :: 		break;
IT	AL
BAL	L_vUARTCommands13
;uarthandler.c,261 :: 		case UART_CMD_CHANNEL:
L_vUARTCommands51:
;uarthandler.c,262 :: 		STM_LOGD( "[ UART ] Set Channel\r\n", NULL );
MOVS	R3, #0
SXTB	R3, R3
...
BL	_PrintOut+0
ADD	SP, SP, #12
;uarthandler.c,263 :: 		memset( pcTempBuffer, '\0', 50 );
ADD	R1, SP, #8
MOVS	R2, #50
SXTH	R2, R2
MOV	R0, R1
MOVS	R1, #0
BL	_memset+0
;uarthandler.c,265 :: 		ucPosition = 8;
; ucPosition start address is: 8 (R2)
MOVS	R2, #8
;uarthandler.c,267 :: 		ucRf4463EnterStandbyMode();
STRB	R2, [SP, #4]
BL	_ucRf4463EnterStandbyMode+0
LDRB	R2, [SP, #4]
;uarthandler.c,269 :: 		for( ucCounter = 0; ; ucCounter++ ){
; ucCounter start address is: 0 (R0)
MOVS	R0, #0
; ucCounter end address is: 0 (R0)
; ucPosition end address is: 8 (R2)
UXTB	R7, R2
L_vUARTCommands52:
;uarthandler.c,270 :: 		if( pcInBuffer[ ucPosition ] == ',' ){
; ucCounter start address is: 0 (R0)
; ucPosition start address is: 28 (R7)
LDR	R1, [SP, #68]
ADDS	R1, R1, R7
...
; ucCounter end address is: 0 (R0)
;uarthandler.c,271 :: 		ucPosition++;
ADDS	R1, R7, #1
; ucPosition end address is: 28 (R7)
; ucPosition start address is: 0 (R0)
UXTB	R0, R1
;uarthandler.c,272 :: 		break;
UXTB	R8, R0
...
;uarthandler.c,273 :: 		}
L_vUARTCommands55:
;uarthandler.c,274 :: 		if( pcInBuffer[ ucPosition ] == '\r' || pcInBuffer[ ucPosition ] == '\n' ){
; ucCounter start address is: 0 (R0)
; ucPosition start address is: 28 (R7)
LDR	R1, [SP, #68]
ADDS	R1, R1, R7
...
L__vUARTCommands345:
L__vUARTCommands344:
;uarthandler.c,275 :: 		ucIgnoreNetwork = 1;
MOVS	R1, #1
STRB	R1, [SP, #67]
...
;uarthandler.c,277 :: 		}
L_vUARTCommands58:
;uarthandler.c,278 :: 		pcTempBuffer[ ucCounter ] = pcInBuffer[ ucPosition++ ];
; ucCounter start address is: 0 (R0)
ADD	R1, SP, #8
ADDS	R2, R1, R0
LDR	R1, [SP, #68]
...
L_vUARTCommands53:
;uarthandler.c,281 :: 		usTempChannel = atoi( pcTempBuffer );
...
UXTH	R2, R0
;uarthandler.c,283 :: 		if( ucIgnoreNetwork == 0 ){
LDRB	R1, [SP, #67]
CMP	R1, #0
IT	NE
BNE	L_vUARTCommands59
;uarthandler.c,284 :: 		for( ucCounter = 0; ; ucCounter++ ){
; ucCounter start address is: 0 (R0)
MOVS	R0, #0
...
UXTH	R7, R2
L_vUARTCommands60:
;uarthandler.c,285 :: 		if( pcInBuffer[ ucPosition ] == '\r' || pcInBuffer[ ucPosition ] == '\n' ){
; ucCounter start address is: 0 (R0)
...
;uarthandler.c,287 :: 		}
L_vUARTCommands65:
;uarthandler.c,288 :: 		pcTempBuffer[ ucCounter ] = pcInBuffer[ ucPosition++ ];
; ucPosition start address is: 12 (R3)
; ucCounter start address is: 0 (R0)
ADD	R1, SP, #8
ADDS	R2, R1, R0
...
L_vUARTCommands61:
;uarthandler.c,290 :: 		usTempNetwork = atoi( pcTempBuffer );
ADD	R1, SP, #8
MOV	R0, R1
BL	_atoi+0
STRH	R0, [SP, #74]
;uarthandler.c,292 :: 		vRf4463SetChannels( usTempChannel, usTempChannel );
UXTB	R1, R7
UXTB	R0, R7
; usTempChannel end address is: 28 (R7)
BL	_vRf4463SetChannels+0
;uarthandler.c,293 :: 		vRf4463SetNetwork( usTempNetwork );
LDRH	R0, [SP, #74]
BL	_vRf4463SetNetwork+0
;uarthandler.c,294 :: 		}
IT	AL
...
BL	_vRf4463SetChannels+0
LDRH	R2, [SP, #4]
;uarthandler.c,297 :: 		vRf4463SetNetwork( usTempChannel );
UXTH	R0, R2
; usTempChannel end address is: 8 (R2)
BL	_vRf4463SetNetwork+0
;uarthandler.c,298 :: 		}
L_vUARTCommands66:
;uarthandler.c,299 :: 		ucRf4463RxInit();
BL	_ucRf4463RxInit+0
;uarthandler.c,300 :: 		break;
IT	AL
BAL	L_vUARTCommands13
;uarthandler.c,301 :: 		case UART_CMD_INFO:
L_vUARTCommands67:
;uarthandler.c,302 :: 		STM_LOGD( "[ UART ] Get Device Info\r\n", NULL );
MOVS	R3, #0
SXTB	R3, R3
...
BL	_PrintOut+0
ADD	SP, SP, #12
;uarthandler.c,328 :: 		break;
IT	AL
BAL	L_vUARTCommands13
;uarthandler.c,329 :: 		case UART_CMD_SEARCH:
L_vUARTCommands68:
;uarthandler.c,330 :: 		STM_LOGD( "[ UART ] Search\r\n", NULL );
MOVS	R3, #0
SXTB	R3, R3
...
BL	_PrintOut+0
ADD	SP, SP, #12
;uarthandler.c,331 :: 		vRF4463SetNode( NODE_FACTORY );
MOVS	R0, #254
BL	_vRF4463SetNode+0
;uarthandler.c,332 :: 		vRF4463TxMessage( NULL, NULL, NODE_FACTORY, TABLE_RF_TEST, RF_TEST_DONGLE_SEARCH );
MOVS	R1, #200
PUSH	(R1)
MOVS	R3, #1
MOVS	R2, #254
...
IT	AL
BAL	L_vUARTCommands13
;uarthandler.c,334 :: 		case UART_CMD_OVERRIDE:
L_vUARTCommands69:
;uarthandler.c,335 :: 		STM_LOGD( "[ UART ] Override\r\n", NULL );
MOVS	R3, #0
SXTB	R3, R3
...
IT	AL
BAL	L_vUARTCommands13
;uarthandler.c,337 :: 		case UART_CMD_RESET_FTY:
L_vUARTCommands70:
;uarthandler.c,338 :: 		STM_LOGD( "[ UART ] Reset Factory\r\n", NULL );
MOVS	R3, #0
SXTB	R3, R3
...
IT	AL
BAL	L_vUARTCommands13
;uarthandler.c,340 :: 		case UART_CMD_OVERRIDE_SET:
L_vUARTCommands71:
;uarthandler.c,341 :: 		STM_LOGD( "[ UART ] Set Override\r\n", NULL );
MOVS	R3, #0
SXTB	R3, R3
...
IT	AL
BAL	L_vUARTCommands13
;uarthandler.c,343 :: 		case UART_CMD_DISCOVER:
L_vUARTCommands72:
;uarthandler.c,344 :: 		STM_LOGD( "[ UART ] Discover\r\n", NULL );
MOVS	R3, #0
SXTB	R3, R3
...
BL	_PrintOut+0
ADD	SP, SP, #12
;uarthandler.c,345 :: 		vRF4463SetNode( NODE_FACTORY );
MOVS	R0, #254
BL	_vRF4463SetNode+0
;uarthandler.c,346 :: 		vRF4463TxMessage( NULL, NULL, NODE_BROADCAST, TABLE_RF_SETUP, RF_SETUP_FTY_DISCOVER );
MOVS	R1, #11
PUSH	(R1)
MOVS	R3, #2
MOVS	R2, #255
...
BL	_vRF4463TxMessage+0
ADD	SP, SP, #4
;uarthandler.c,347 :: 		case UART_CMD_FIND:
L_vUARTCommands73:
;uarthandler.c,348 :: 		STM_LOGD( "[ UART ] Find in Channel\r\n", NULL );
MOVS	R3, #0
SXTB	R3, R3
...
BL	_PrintOut+0
ADD	SP, SP, #12
;uarthandler.c,349 :: 		vRF4463SetNode( HUB_NODE );
MOVS	R0, #1
BL	_vRF4463SetNode+0
;uarthandler.c,350 :: 		vRF4463TxMessage( NULL, NULL, NODE_BROADCAST, TABLE_RF_TEST, RF_TEST_CHANNEL );
MOVS	R1, #6
PUSH	(R1)
MOVS	R3, #1
MOVS	R2, #255
...
IT	AL
BAL	L_vUARTCommands13
;uarthandler.c,352 :: 		case UART_CMD_UNBLOCK:
L_vUARTCommands74:
;uarthandler.c,353 :: 		break;
IT	AL
BAL	L_vUARTCommands13
;uarthandler.c,354 :: 		default:
L_vUARTCommands75:
;uarthandler.c,355 :: 		STM_LOGE( "Invalid Command\r\n", NULL );
MOVS	R3, #0
SXTB	R3, R3
...
MOVS	R0, #10
BL	_UART1_Write+0
;rf4463handler.c,94 :: 		vRF4463RxCommand();
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463handler.c,283 :: 		switch( pcRF4463RxBuffer[ RF_MESSAGE_COMMAND ] ){
IT	AL
BAL	L_vRF4463RxCommand151
;rf4463handler.c,284 :: 		case RF_TEST_STATUS:
L_vRF4463RxCommand153:
;rf4463handler.c,285 :: 		STM_LOGI( "[ RF4463 ] Status Command\r\n", NULL );
MOVS	R2, #0
SXTB	R2, R2
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463handler.c,286 :: 		break;
IT	AL
BAL	L_vRF4463RxCommand152
;rf4463handler.c,287 :: 		default:
L_vRF4463RxCommand154:
;rf4463handler.c,288 :: 		STM_LOGE( "[ RF4463 ] Unhandled command\r\n", NULL );
MOVS	R2, #0
SXTB	R2, R2
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463handler.c,351 :: 		if( pcRF4463RxBuffer[ RF_MESSAGE_SOURCE ] == HUB_NODE ){
MOVW	R0, #lo_addr(_pcRF4463RxBuffer+2)
MOVT	R0, #hi_addr(_pcRF4463RxBuffer+2)
LDRB	R0, [R0, #0]
CMP	R0, #1
...
;rf4463handler.c,352 :: 		STM_LOGE( "[ RF4463 ] Hub node request\r\n", NULL );
MOVS	R2, #0
SXTB	R2, R2
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463handler.c,353 :: 		return;
IT	AL
BAL	L_end_vRF4463RxCommand
;rf4463handler.c,354 :: 		}
L_vRF4463RxCommand176:
;rf4463handler.c,359 :: 		switch( pcRF4463RxBuffer[ RF_MESSAGE_COMMAND ] ){
IT	AL
BAL	L_vRF4463RxCommand177
;rf4463handler.c,360 :: 		default:
L_vRF4463RxCommand179:
;rf4463handler.c,361 :: 		STM_LOGE( "[ RF4463 ] Unhandled command\r\n", NULL );
MOVS	R2, #0
SXTB	R2, R2
...
;rf4463handler.c,368 :: 		case TABLE_RF_SWITCH:
L_vRF4463RxCommand180:
;rf4463handler.c,369 :: 		STM_LOGI( "[ RF4463 ] Switch Table\r\n", NULL );
MOVS	R2, #0
SXTB	R2, R2
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463handler.c,374 :: 		if( pcRF4463RxBuffer[ RF_MESSAGE_SOURCE ] == HUB_NODE ){
MOVW	R0, #lo_addr(_pcRF4463RxBuffer+2)
MOVT	R0, #hi_addr(_pcRF4463RxBuffer+2)
LDRB	R0, [R0, #0]
CMP	R0, #1
...
;rf4463handler.c,375 :: 		STM_LOGE( "[ RF4463 ] Hub node request\r\n", NULL );
MOVS	R2, #0
SXTB	R2, R2
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463handler.c,376 :: 		return;
IT	AL
BAL	L_end_vRF4463RxCommand
;rf4463handler.c,377 :: 		}
L_vRF4463RxCommand181:
;rf4463handler.c,382 :: 		STM_LOGI( "[ RF4463 ] Node: %d\r\n", pcRF4463RxBuffer[ RF_MESSAGE_SOURCE ] );
MOVW	R0, #lo_addr(_pcRF4463RxBuffer+2)
MOVT	R0, #hi_addr(_pcRF4463RxBuffer+2)
LDRB	R2, [R0, #0]
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463handler.c,383 :: 		switch( pcRF4463RxBuffer[ RF_MESSAGE_COMMAND ] ){
IT	AL
BAL	L_vRF4463RxCommand182
;rf4463handler.c,384 :: 		default:
L_vRF4463RxCommand184:
;rf4463handler.c,385 :: 		STM_LOGE( "[ RF4463 ] Unhandled command\r\n", NULL );
MOVS	R2, #0
SXTB	R2, R2
...
;rf4463handler.c,392 :: 		case TABLE_RF_DIMMER:
L_vRF4463RxCommand185:
;rf4463handler.c,393 :: 		STM_LOGI( "[ RF4463 ] Dimmer Table\r\n", NULL );
MOVS	R2, #0
SXTB	R2, R2
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463handler.c,398 :: 		if( pcRF4463RxBuffer[ RF_MESSAGE_SOURCE ] == HUB_NODE ){
MOVW	R0, #lo_addr(_pcRF4463RxBuffer+2)
MOVT	R0, #hi_addr(_pcRF4463RxBuffer+2)
LDRB	R0, [R0, #0]
CMP	R0, #1
...
;rf4463handler.c,399 :: 		STM_LOGE( "[ RF4463 ] Hub node request\r\n", NULL );
MOVS	R2, #0
SXTB	R2, R2
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463handler.c,400 :: 		return;
IT	AL
BAL	L_end_vRF4463RxCommand
;rf4463handler.c,401 :: 		}
L_vRF4463RxCommand186:
;rf4463handler.c,406 :: 		switch( pcRF4463RxBuffer[ RF_MESSAGE_COMMAND ] ){
IT	AL
BAL	L_vRF4463RxCommand187
;rf4463handler.c,407 :: 		default:
L_vRF4463RxCommand189:
;rf4463handler.c,408 :: 		STM_LOGE( "[ RF4463 ] Unhandled command\r\n", NULL );
MOVS	R2, #0
SXTB	R2, R2
...
;rf4463handler.c,415 :: 		case TABLE_RF_OUTLET:
L_vRF4463RxCommand190:
;rf4463handler.c,416 :: 		STM_LOGI( "[ RF4463 ] Outlet Table\r\n", NULL );
MOVS	R2, #0
SXTB	R2, R2
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463handler.c,421 :: 		if( pcRF4463RxBuffer[ RF_MESSAGE_SOURCE ] == HUB_NODE ){
MOVW	R0, #lo_addr(_pcRF4463RxBuffer+2)
MOVT	R0, #hi_addr(_pcRF4463RxBuffer+2)
LDRB	R0, [R0, #0]
CMP	R0, #1
...
;rf4463handler.c,422 :: 		STM_LOGE( "[ RF4463 ] Hub node request\r\n", NULL );
MOVS	R2, #0
SXTB	R2, R2
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463handler.c,423 :: 		return;
IT	AL
BAL	L_end_vRF4463RxCommand
;rf4463handler.c,424 :: 		}
L_vRF4463RxCommand191:
;rf4463handler.c,429 :: 		switch( pcRF4463RxBuffer[ RF_MESSAGE_COMMAND ] ){
IT	AL
BAL	L_vRF4463RxCommand192
;rf4463handler.c,430 :: 		default:
L_vRF4463RxCommand194:
;rf4463handler.c,431 :: 		STM_LOGE( "[ RF4463 ] Unhandled command\r\n", NULL );
MOVS	R2, #0
SXTB	R2, R2
...
;rf4463handler.c,438 :: 		default:
L_vRF4463RxCommand195:
;rf4463handler.c,439 :: 		STM_LOGE( "[ RF4463 ] Unhandled table\r\n", NULL );
MOVS	R2, #0
SXTB	R2, R2
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463handler.c,440 :: 		STM_LOGV( "[ RF4463 ] Source node:%d\r\n", pcRF4463RxBuffer[ RF_MESSAGE_SOURCE ] );
MOVW	R0, #lo_addr(_pcRF4463RxBuffer+2)
MOVT	R0, #hi_addr(_pcRF4463RxBuffer+2)
LDRB	R2, [R0, #0]
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463handler.c,441 :: 		STM_LOGV( "[ RF4463 ] Destination node:%d\r\n", pcRF4463RxBuffer[ RF_MESSAGE_DESTINATION ] );
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463handler.c,442 :: 		STM_LOGV( "[ RF4463 ] Table: %d\r\n", pcRF4463RxBuffer[ RF_MESSAGE_TABLE ] );
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463handler.c,443 :: 		STM_LOGV( "[ RF4463 ] Command: %d\r\n", pcRF4463RxBuffer[ RF_MESSAGE_COMMAND ] );
MOVW	R0, #lo_addr(_pcRF4463RxBuffer+4)
MOVT	R0, #hi_addr(_pcRF4463RxBuffer+4)
LDRB	R2, [R0, #0]
...
_vRF4463RxFTY:
;rf4463handler.c,451 :: 		void vRF4463RxFTY(){
SUBW	SP, SP, #808
STR	LR, [SP, #0]
;rf4463handler.c,455 :: 		uint16_t usCounter = 0;
;rf4463handler.c,456 :: 		uint8_t ucPosition = 0;
; ucPosition start address is: 32 (R8)
MOVW	R8, #0
;rf4463handler.c,472 :: 		if( pcRF4463RxBuffer[ RF_MESSAGE_DESTINATION ] == NODE_FACTORY ){
MOVW	R0, #lo_addr(_pcRF4463RxBuffer+1)
MOVT	R0, #hi_addr(_pcRF4463RxBuffer+1)
LDRB	R0, [R0, #0]
CMP	R0, #254
...
;rf4463handler.c,473 :: 		switch( pcRF4463RxBuffer[ RF_MESSAGE_TABLE ] ){
IT	AL
BAL	L_vRF4463RxFTY197
;rf4463handler.c,474 :: 		case TABLE_RF_TEST:
L_vRF4463RxFTY199:
;rf4463handler.c,475 :: 		switch( pcRF4463RxBuffer[ RF_MESSAGE_COMMAND ] ){
IT	AL
BAL	L_vRF4463RxFTY200
; ucPosition end address is: 32 (R8)
;rf4463handler.c,476 :: 		case RF_TEST_LOOP:
L_vRF4463RxFTY202:
;rf4463handler.c,478 :: 		vRF4463SetNode( NODE_FACTORY );
MOVS	R0, #254
BL	_vRF4463SetNode+0
;rf4463handler.c,479 :: 		vRF4463TxMessage( &pcRF4463RxBuffer[ RF_MESSAGE_CONTENT ], ( pcRF4463RxBuffer[ RF_MESSAGE_SIZE ] - RF_MESSAGE_HEADER_SIZE ), NODE_BROADCAST, TABLE_RF_TEST, RF_TEST_LOOP );
MOVS	R1, #5
MOVW	R0, #lo_addr(_pcRF4463RxBuffer+0)
MOVT	R0, #hi_addr(_pcRF4463RxBuffer+0)
LDRB	R0, [R0, #0]
...
BL	_vRF4463TxMessage+0
ADD	SP, SP, #4
;rf4463handler.c,480 :: 		break;
IT	AL
BAL	L_vRF4463RxFTY201
;rf4463handler.c,481 :: 		case RF_TEST_QR:
L_vRF4463RxFTY203:
;rf4463handler.c,482 :: 		UART1_Write_Text( "RCV|" );
MOVS	R0, #82
STRB	R0, [SP, #744]
MOVS	R0, #67
STRB	R0, [SP, #745]
...
ADD	R0, SP, #744
BL	_UART1_Write_Text+0
;rf4463handler.c,483 :: 		for( usCounter = RF_MESSAGE_CONTENT; usCounter < pcRF4463RxBuffer[ RF_MESSAGE_SIZE ]; usCounter++ ){
; usCounter start address is: 16 (R4)
MOVS	R4, #5
; usCounter end address is: 16 (R4)
L_vRF4463RxFTY204:
...
;rf4463handler.c,484 :: 		UART1_Write( pcRF4463RxBuffer[ usCounter ] );
MOVW	R0, #lo_addr(_pcRF4463RxBuffer+0)
MOVT	R0, #hi_addr(_pcRF4463RxBuffer+0)
ADDS	R0, R0, R4
LDRB	R0, [R0, #0]
...
L_vRF4463RxFTY205:
;rf4463handler.c,486 :: 		UART1_Write( '\r' );
MOVS	R0, #13
BL	_UART1_Write+0
;rf4463handler.c,487 :: 		UART1_Write( '\n' );
MOVS	R0, #10
BL	_UART1_Write+0
;rf4463handler.c,488 :: 		break;
IT	AL
BAL	L_vRF4463RxFTY201
;rf4463handler.c,489 :: 		case RF_TEST_OK:
L_vRF4463RxFTY207:
;rf4463handler.c,490 :: 		for( usCounter = 0; usCounter < 12; usCounter++ ){
...
;rf4463handler.c,491 :: 		pcReceivedQR[ usCounter ] = pcRF4463RxBuffer[ RF_MESSAGE_CONTENT + usCounter ];
...
L_vRF4463RxFTY209:
;rf4463handler.c,494 :: 		if( memcmp( pcReceivedQR, pcSentQR, 12 ) == 0 ){
MOVS	R2, #12
SXTH	R2, R2
MOVW	R1, #lo_addr(main_pcSentQR+0)
MOVT	R1, #hi_addr(main_pcSentQR+0)
...
;rf4463handler.c,495 :: 		UART1_Write_Text( "FINISH|" );
ADDW	R11, SP, #749
ADD	R10, R11, #8
...
ADDW	R0, SP, #749
BL	_UART1_Write_Text+0
;rf4463handler.c,496 :: 		for( usCounter = 0; usCounter < 12; usCounter++ ){
; usCounter start address is: 16 (R4)
MOVS	R4, #0
; usCounter end address is: 16 (R4)
L_vRF4463RxFTY212:
...
;rf4463handler.c,497 :: 		UART1_Write( pcReceivedQR[ usCounter ] );
MOVW	R0, #lo_addr(main_pcReceivedQR+0)
MOVT	R0, #hi_addr(main_pcReceivedQR+0)
ADDS	R0, R0, R4
LDRB	R0, [R0, #0]
...
L_vRF4463RxFTY213:
;rf4463handler.c,499 :: 		UART1_Write( '\r' );
MOVS	R0, #13
BL	_UART1_Write+0
;rf4463handler.c,500 :: 		UART1_Write( '\n' );
MOVS	R0, #10
BL	_UART1_Write+0
;rf4463handler.c,501 :: 		}
L_vRF4463RxFTY211:
;rf4463handler.c,502 :: 		break;
IT	AL
BAL	L_vRF4463RxFTY201
;rf4463handler.c,503 :: 		case RF_TEST_MESSAGE:
L_vRF4463RxFTY215:
;rf4463handler.c,504 :: 		UART1_Write_Text( "RCV|" );
MOVS	R0, #82
STRB	R0, [SP, #757]
MOVS	R0, #67
STRB	R0, [SP, #758]
...
ADDW	R0, SP, #757
BL	_UART1_Write_Text+0
;rf4463handler.c,505 :: 		for( usCounter = RF_MESSAGE_CONTENT; usCounter < pcRF4463RxBuffer[ RF_MESSAGE_SIZE ]; usCounter++ ){
; usCounter start address is: 16 (R4)
MOVS	R4, #5
; usCounter end address is: 16 (R4)
L_vRF4463RxFTY216:
...
;rf4463handler.c,506 :: 		UART1_Write( pcRF4463RxBuffer[ usCounter ] );
MOVW	R0, #lo_addr(_pcRF4463RxBuffer+0)
MOVT	R0, #hi_addr(_pcRF4463RxBuffer+0)
ADDS	R0, R0, R4
LDRB	R0, [R0, #0]
...
L_vRF4463RxFTY217:
;rf4463handler.c,508 :: 		UART1_Write( '\r' );
MOVS	R0, #13
BL	_UART1_Write+0
;rf4463handler.c,509 :: 		UART1_Write( '\n' );
MOVS	R0, #10
BL	_UART1_Write+0
;rf4463handler.c,510 :: 		break;
IT	AL
BAL	L_vRF4463RxFTY201
;rf4463handler.c,511 :: 		case RF_TEST_DONGLE_SEARCH:
L_vRF4463RxFTY219:
;rf4463handler.c,513 :: 		if( ucSearchActive == 0 ){
...
;rf4463handler.c,514 :: 		ucSearchActive = 1;
MOVS	R1, #1
MOVW	R0, #lo_addr(_ucSearchActive+0)
MOVT	R0, #hi_addr(_ucSearchActive+0)
STRB	R1, [R0, #0]
;rf4463handler.c,515 :: 		vTimerSearchLed();
BL	_vTimerSearchLed+0
;rf4463handler.c,516 :: 		}
IT	AL
BAL	L_vRF4463RxFTY221
L_vRF4463RxFTY220:
;rf4463handler.c,518 :: 		ucSearchActive = 0;
MOVS	R1, #0
MOVW	R0, #lo_addr(_ucSearchActive+0)
MOVT	R0, #hi_addr(_ucSearchActive+0)
STRB	R1, [R0, #0]
;rf4463handler.c,519 :: 		vTimerStop( TIMER_SEARCH );
MOVS	R0, #0
BL	_vTimerStop+0
;rf4463handler.c,520 :: 		LEDGreen = On;
MOVS	R1, #1
SXTB	R1, R1
MOVW	R0, #lo_addr(GPIOC_ODR+0)
MOVT	R0, #hi_addr(GPIOC_ODR+0)
...
;rf4463handler.c,521 :: 		}
L_vRF4463RxFTY221:
;rf4463handler.c,522 :: 		break;
IT	AL
BAL	L_vRF4463RxFTY201
;rf4463handler.c,523 :: 		case RF_TEST_INFO:
L_vRF4463RxFTY222:
;rf4463handler.c,524 :: 		for( usCounter = 0; usCounter < ( pcRF4463RxBuffer[ RF_MESSAGE_SIZE ] - RF_MESSAGE_HEADER_SIZE ); usCounter++ ){
; ucPosition start address is: 32 (R8)
...
;rf4463handler.c,525 :: 		pcTempBuffer[ usCounter ] = pcRF4463RxBuffer[ usCounter + RF_MESSAGE_CONTENT ];
ADD	R0, SP, #8
ADD	R2, R0, R9, LSL #0
ADD	R1, R9, #5
UXTH	R1, R1
...
L_vRF4463RxFTY224:
;rf4463handler.c,527 :: 		memset( pcRxRF4463AuxBuffer, '\0', RF_MAX_BUFFER_LENGTH );
MOVS	R2, #64
SXTH	R2, R2
MOVS	R1, #0
...
BL	_memset+0
;rf4463handler.c,528 :: 		vXORRFMessage( pcTempBuffer, pcRxRF4463AuxBuffer, usCounter );
ADD	R0, SP, #8
UXTB	R2, R9
; usCounter end address is: 36 (R9)
...
BL	_vXORRFMessage+0
;rf4463handler.c,529 :: 		switch( pcRxRF4463AuxBuffer[ ucPosition++ ] ){
UXTB	R1, R8
ADD	R7, R8, #1
UXTB	R7, R7
; ucPosition end address is: 32 (R8)
...
;rf4463handler.c,530 :: 		case DEVICE_MODEL_ID_HUB:
L_vRF4463RxFTY228:
;rf4463handler.c,531 :: 		UART1_Write_Text( "QR: " );
MOVS	R0, #81
STRB	R0, [SP, #762]
MOVS	R0, #82
STRB	R0, [SP, #763]
...
ADDW	R0, SP, #762
BL	_UART1_Write_Text+0
;rf4463handler.c,532 :: 		for( usCounter = 0; usCounter < 12; usCounter++ ){
; usCounter start address is: 16 (R4)
MOVS	R4, #0
; ucPosition end address is: 28 (R7)
; usCounter end address is: 16 (R4)
...
;rf4463handler.c,533 :: 		UART1_Write( pcRxRF4463AuxBuffer[ ucPosition++ ] );
MOVW	R0, #lo_addr(_pcRxRF4463AuxBuffer+0)
MOVT	R0, #hi_addr(_pcRxRF4463AuxBuffer+0)
ADDS	R0, R0, R7
LDRB	R0, [R0, #0]
...
L_vRF4463RxFTY230:
;rf4463handler.c,535 :: 		UART1_Write( '\r' );
MOVS	R0, #13
BL	_UART1_Write+0
;rf4463handler.c,536 :: 		UART1_Write( '\n' );
MOVS	R0, #10
BL	_UART1_Write+0
;rf4463handler.c,538 :: 		for( usCounter = 0; usCounter < 12; usCounter++ ){
...
;rf4463handler.c,539 :: 		pcUIDHex[ usCounter ] = pcRxRF4463AuxBuffer[ ucPosition++ ];
ADD	R0, SP, #161
ADDS	R1, R0, R2
MOVW	R0, #lo_addr(_pcRxRF4463AuxBuffer+0)
MOVT	R0, #hi_addr(_pcRxRF4463AuxBuffer+0)
...
L_vRF4463RxFTY233:
;rf4463handler.c,542 :: 		vSerializeUUID( pcUIDText, pcUIDHex );
ADD	R1, SP, #161
ADD	R0, SP, #136
BL	_vSerializeUUID+0
;rf4463handler.c,544 :: 		UART1_Write_Text( "UID: " );
MOVS	R0, #85
STRB	R0, [SP, #767]
MOVS	R0, #73
STRB	R0, [SP, #768]
...
ADDW	R0, SP, #767
BL	_UART1_Write_Text+0
;rf4463handler.c,545 :: 		UART1_Write_Text( pcUIDText );
ADD	R0, SP, #136
BL	_UART1_Write_Text+0
;rf4463handler.c,546 :: 		UART1_Write( '\r' );
MOVS	R0, #13
BL	_UART1_Write+0
;rf4463handler.c,547 :: 		UART1_Write( '\n' );
MOVS	R0, #10
BL	_UART1_Write+0
;rf4463handler.c,549 :: 		for( usCounter = 0; usCounter < 6; usCounter++ ){
; usCounter start address is: 8 (R2)
MOVS	R2, #0
; ucPosition end address is: 28 (R7)
; usCounter end address is: 8 (R2)
...
;rf4463handler.c,550 :: 		pcMACHex[ usCounter ] = pcRxRF4463AuxBuffer[ ucPosition++ ];
ADD	R0, SP, #194
ADDS	R1, R0, R2
MOVW	R0, #lo_addr(_pcRxRF4463AuxBuffer+0)
MOVT	R0, #hi_addr(_pcRxRF4463AuxBuffer+0)
...
L_vRF4463RxFTY236:
;rf4463handler.c,552 :: 		vSerializeMACAddress( pcMACText, pcMACHex );
ADD	R1, SP, #194
ADD	R0, SP, #174
BL	_vSerializeMACAddress+0
;rf4463handler.c,553 :: 		UART1_Write_Text( "MAC: " );
MOVS	R0, #77
STRB	R0, [SP, #773]
MOVS	R0, #65
STRB	R0, [SP, #774]
...
ADDW	R0, SP, #773
BL	_UART1_Write_Text+0
;rf4463handler.c,554 :: 		UART1_Write_Text( pcMACText );
ADD	R0, SP, #174
BL	_UART1_Write_Text+0
;rf4463handler.c,555 :: 		UART1_Write( '\r' );
MOVS	R0, #13
BL	_UART1_Write+0
;rf4463handler.c,556 :: 		UART1_Write( '\n' );
MOVS	R0, #10
BL	_UART1_Write+0
;rf4463handler.c,558 :: 		for( usCounter = 0; usCounter < 4; usCounter++ ){
; usCounter start address is: 8 (R2)
MOVS	R2, #0
; ucPosition end address is: 32 (R8)
; usCounter end address is: 8 (R2)
...
;rf4463handler.c,559 :: 		pcIPHex[ usCounter ] = pcRxRF4463AuxBuffer[ ucPosition++ ];
ADD	R0, SP, #226
ADDS	R1, R0, R2
MOVW	R0, #lo_addr(_pcRxRF4463AuxBuffer+0)
MOVT	R0, #hi_addr(_pcRxRF4463AuxBuffer+0)
...
L_vRF4463RxFTY239:
;rf4463handler.c,561 :: 		vSerializeIPAddress( pcIPText, pcIPHex );
ADD	R1, SP, #226
ADD	R0, SP, #206
STRB	R3, [SP, #4]
BL	_vSerializeIPAddress+0
;rf4463handler.c,562 :: 		UART1_Write_Text( "IP: " );
MOVS	R0, #73
STRB	R0, [SP, #779]
MOVS	R0, #80
STRB	R0, [SP, #780]
...
ADDW	R0, SP, #779
BL	_UART1_Write_Text+0
;rf4463handler.c,563 :: 		UART1_Write_Text( pcIPText );
ADD	R0, SP, #206
BL	_UART1_Write_Text+0
;rf4463handler.c,564 :: 		UART1_Write( '\r' );
MOVS	R0, #13
BL	_UART1_Write+0
;rf4463handler.c,565 :: 		UART1_Write( '\n' );
MOVS	R0, #10
BL	_UART1_Write+0
;rf4463handler.c,567 :: 		memset( pcTempBuffer, '\0', NULL );
ADD	R0, SP, #8
MOVS	R2, #0
SXTH	R2, R2
MOVS	R1, #0
...
BL	_sprintf+0
ADD	SP, SP, #20
;rf4463handler.c,569 :: 		UART1_Write_Text( pcTempBuffer );
ADD	R0, SP, #8
BL	_UART1_Write_Text+0
;rf4463handler.c,570 :: 		break;
IT	AL
BAL	L_vRF4463RxFTY227
;rf4463handler.c,571 :: 		case DEVICE_MODEL_ID_SWITCH:
L_vRF4463RxFTY241:
;rf4463handler.c,572 :: 		break;
IT	AL
BAL	L_vRF4463RxFTY227
;rf4463handler.c,573 :: 		case DEVICE_MODEL_ID_DIMMER:
L_vRF4463RxFTY242:
;rf4463handler.c,574 :: 		break;
IT	AL
BAL	L_vRF4463RxFTY227
;rf4463handler.c,575 :: 		case DEVICE_MODEL_ID_OUTLET:
L_vRF4463RxFTY243:
;rf4463handler.c,576 :: 		break;
IT	AL
BAL	L_vRF4463RxFTY227
;rf4463handler.c,577 :: 		}
L_vRF4463RxFTY226:
...
; ucPosition end address is: 32 (R8)
L_vRF4463RxFTY201:
;rf4463handler.c,580 :: 		break;
IT	AL
BAL	L_vRF4463RxFTY198
;rf4463handler.c,581 :: 		case TABLE_RF_SETUP:
L_vRF4463RxFTY244:
;rf4463handler.c,582 :: 		switch( pcRF4463RxBuffer[ RF_MESSAGE_COMMAND ] ){
IT	AL
BAL	L_vRF4463RxFTY245
;rf4463handler.c,583 :: 		case RF_SETUP_FTY_DISCOVER:
L_vRF4463RxFTY247:
;rf4463handler.c,584 :: 		memset( pcTempConvBuffer, '\0', RF_MAX_BUFFER_LENGTH );
ADD	R0, SP, #72
MOVS	R2, #64
SXTH	R2, R2
MOVS	R1, #0
BL	_memset+0
;rf4463handler.c,585 :: 		memset( pcTempBuffer, '\0', RF_MAX_BUFFER_LENGTH );
ADD	R0, SP, #8
MOVS	R2, #64
SXTH	R2, R2
MOVS	R1, #0
BL	_memset+0
;rf4463handler.c,586 :: 		for( usCounter = 0; usCounter < 12; usCounter++ ){
; usCounter start address is: 12 (R3)
MOVS	R3, #0
; usCounter end address is: 12 (R3)
L_vRF4463RxFTY248:
...
;rf4463handler.c,587 :: 		pcTempBuffer[ usCounter ] = pcRF4463RxBuffer[ RF_MESSAGE_CONTENT + usCounter ];
ADD	R0, SP, #8
ADDS	R2, R0, R3
ADDS	R1, R3, #5
UXTH	R1, R1
...
L_vRF4463RxFTY249:
;rf4463handler.c,590 :: 		vHexToASCII( pcTempConvBuffer, pcTempBuffer, 12 );
ADD	R1, SP, #8
ADD	R0, SP, #72
MOVS	R2, #12
BL	_vHexToASCII+0
;rf4463handler.c,592 :: 		UART1_Write_Text( "UID: " );
MOVS	R0, #85
STRB	R0, [SP, #784]
MOVS	R0, #73
STRB	R0, [SP, #785]
...
ADD	R0, SP, #784
BL	_UART1_Write_Text+0
;rf4463handler.c,593 :: 		UART1_Write_Text( pcTempConvBuffer );
ADD	R0, SP, #72
BL	_UART1_Write_Text+0
;rf4463handler.c,594 :: 		UART1_Write( '\r' );
MOVS	R0, #13
BL	_UART1_Write+0
;rf4463handler.c,595 :: 		UART1_Write( '\n' );
MOVS	R0, #10
BL	_UART1_Write+0
;rf4463handler.c,596 :: 		break;
IT	AL
...
L_vRF4463RxFTY196:
;rf4463handler.c,604 :: 		else if( pcRF4463RxBuffer[ RF_MESSAGE_DESTINATION ] == HUB_NODE ){
MOVW	R0, #lo_addr(_pcRF4463RxBuffer+1)
MOVT	R0, #hi_addr(_pcRF4463RxBuffer+1)
LDRB	R0, [R0, #0]
CMP	R0, #1
...
;rf4463handler.c,605 :: 		switch( pcRF4463RxBuffer[ RF_MESSAGE_TABLE ] ){
IT	AL
BAL	L_vRF4463RxFTY253
;rf4463handler.c,606 :: 		case RF_SETUP_TABLE:
L_vRF4463RxFTY255:
;rf4463handler.c,607 :: 		switch( pcRF4463RxBuffer[ RF_MESSAGE_COMMAND ] ){
IT	AL
BAL	L_vRF4463RxFTY256
;rf4463handler.c,608 :: 		case RF_SETUP_FIND_BY_QR:
L_vRF4463RxFTY258:
;rf4463handler.c,609 :: 		memset( pcTempConvBuffer, '\0', RF_MAX_BUFFER_LENGTH );
ADD	R0, SP, #72
MOVS	R2, #64
SXTH	R2, R2
MOVS	R1, #0
BL	_memset+0
;rf4463handler.c,610 :: 		for( usCounter = 0; usCounter < 12; usCounter++ ){
; usCounter start address is: 12 (R3)
MOVS	R3, #0
; usCounter end address is: 12 (R3)
L_vRF4463RxFTY259:
...
;rf4463handler.c,611 :: 		pcTempBuffer[ usCounter ] = pcRF4463RxBuffer[ RF_MESSAGE_CONTENT + usCounter ];
ADD	R0, SP, #8
ADDS	R2, R0, R3
ADDS	R1, R3, #5
UXTH	R1, R1
...
L_vRF4463RxFTY260:
;rf4463handler.c,613 :: 		vHexToASCII( pcTempConvBuffer, pcTempBuffer, 12 );
ADD	R1, SP, #8
ADD	R0, SP, #72
MOVS	R2, #12
BL	_vHexToASCII+0
;rf4463handler.c,615 :: 		UART1_Write_Text( "UID: " );
MOVS	R0, #85
STRB	R0, [SP, #790]
MOVS	R0, #73
STRB	R0, [SP, #791]
...
ADDW	R0, SP, #790
BL	_UART1_Write_Text+0
;rf4463handler.c,616 :: 		UART1_Write_Text( pcTempConvBuffer );
ADD	R0, SP, #72
BL	_UART1_Write_Text+0
;rf4463handler.c,617 :: 		UART1_Write( '\r' );
MOVS	R0, #13
BL	_UART1_Write+0
;rf4463handler.c,618 :: 		UART1_Write( '\n' );
MOVS	R0, #10
BL	_UART1_Write+0
;rf4463handler.c,620 :: 		memset( pcJSONBuffer, '\0', 512 );
ADD	R0, SP, #232
MOVW	R2, #512
SXTH	R2, R2
MOVS	R1, #0
BL	_memset+0
;rf4463handler.c,621 :: 		sprintf( pcJSONBuffer, "{\"qrCode\":\"%s\",\"location\":1,\"mac\":\"\",\"modelId\":%d,\"uuiddevice\":\"%s\"}\r\n", pcTempQR, ucSearchedModelId, pcTempConvBuffer );
ADD	R4, SP, #72
...
BL	_sprintf+0
ADD	SP, SP, #20
;rf4463handler.c,623 :: 		UART1_Write_Text( pcJSONBuffer );
ADD	R0, SP, #232
BL	_UART1_Write_Text+0
;rf4463handler.c,624 :: 		break;
IT	AL
BAL	L_vRF4463RxFTY257
;rf4463handler.c,625 :: 		case RF_SETUP_FTY_DISCOVER:
L_vRF4463RxFTY262:
;rf4463handler.c,626 :: 		memset( pcTempConvBuffer, '\0', RF_MAX_BUFFER_LENGTH );
ADD	R0, SP, #72
MOVS	R2, #64
SXTH	R2, R2
MOVS	R1, #0
BL	_memset+0
;rf4463handler.c,627 :: 		memset( pcTempBuffer, '\0', RF_MAX_BUFFER_LENGTH );
ADD	R0, SP, #8
MOVS	R2, #64
SXTH	R2, R2
MOVS	R1, #0
BL	_memset+0
;rf4463handler.c,628 :: 		for( usCounter = 0; usCounter < 12; usCounter++ ){
; usCounter start address is: 12 (R3)
MOVS	R3, #0
; usCounter end address is: 12 (R3)
L_vRF4463RxFTY263:
...
;rf4463handler.c,629 :: 		pcTempBuffer[ usCounter ] = pcRF4463RxBuffer[ RF_MESSAGE_CONTENT + usCounter ];
ADD	R0, SP, #8
ADDS	R2, R0, R3
ADDS	R1, R3, #5
UXTH	R1, R1
...
L_vRF4463RxFTY264:
;rf4463handler.c,632 :: 		vHexToASCII( pcTempConvBuffer, pcTempBuffer, 12 );
ADD	R1, SP, #8
ADD	R0, SP, #72
MOVS	R2, #12
BL	_vHexToASCII+0
;rf4463handler.c,634 :: 		UART1_Write_Text( "UID: " );
MOVS	R0, #85
STRB	R0, [SP, #796]
MOVS	R0, #73
STRB	R0, [SP, #797]
...
ADD	R0, SP, #796
BL	_UART1_Write_Text+0
;rf4463handler.c,635 :: 		UART1_Write_Text( pcTempConvBuffer );
ADD	R0, SP, #72
BL	_UART1_Write_Text+0
;rf4463handler.c,636 :: 		UART1_Write( '\r' );
MOVS	R0, #13
BL	_UART1_Write+0
;rf4463handler.c,637 :: 		UART1_Write( '\n' );
MOVS	R0, #10
BL	_UART1_Write+0
;rf4463handler.c,638 :: 		break;
IT	AL
BAL	L_vRF4463RxFTY257
;rf4463handler.c,639 :: 		}
L_vRF4463RxFTY256:
...
_ucRF4463GetIRQFlag:
;rf4463handler.c,651 :: 		uint8_t ucRF4463GetIRQFlag(){
SUB	SP, SP, #4
;rf4463handler.c,652 :: 		return ucRF4463IRQ;
MOVW	R0, #lo_addr(main_ucRF4463IRQ+0)
MOVT	R0, #hi_addr(main_ucRF4463IRQ+0)
LDRB	R0, [R0, #0]
;rf4463handler.c,653 :: 		}
...
;rf4463handler.c,658 :: 		void vRF4463ResetIRQFlag(){
SUB	SP, SP, #4
;rf4463handler.c,659 :: 		ucRF4463IRQ = 0;
MOVS	R1, #0
MOVW	R0, #lo_addr(main_ucRF4463IRQ+0)
MOVT	R0, #hi_addr(main_ucRF4463IRQ+0)
STRB	R1, [R0, #0]
...
;rf4463handler.c,665 :: 		void vRF4463SetPinSelect( uint8_t ucPinVal ){
; ucPinVal start address is: 0 (R0)
SUB	SP, SP, #4
; ucPinVal end address is: 0 (R0)
; ucPinVal start address is: 0 (R0)
;rf4463handler.c,666 :: 		RF4463nSEL = ucPinVal;
...
_vRF4463SetPinSDN:
;rf4463handler.c,672 :: 		void vRF4463SetPinSDN( uint8_t ucPinVal ){
; ucPinVal start address is: 0 (R0)
SUB	SP, SP, #4
; ucPinVal end address is: 0 (R0)
; ucPinVal start address is: 0 (R0)
;rf4463handler.c,673 :: 		RF4463nSDN = ucPinVal;
MOVW	R1, #lo_addr(GPIOB_ODR+0)
MOVT	R1, #hi_addr(GPIOB_ODR+0)
_SX	[R1, ByteOffset(GPIOB_ODR+0)]
; ucPinVal end address is: 0 (R0)
