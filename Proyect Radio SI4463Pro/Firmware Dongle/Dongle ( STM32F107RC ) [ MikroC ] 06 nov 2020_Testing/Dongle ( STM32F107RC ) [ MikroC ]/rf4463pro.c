...
const unsigned char RF_GLOBAL_XO_TUNE_2_data[]         = { RF_GLOBAL_XO_TUNE_2 };
...
void vRf4463Init( uint8_t ucSetTxChannel, uint8_t ucSetRxChannel, uint16_t usNetwork, uint8_t ucTxPower, uint8_t ucFrequency ){
    ...
    *********************************************************************/
        ...
        ucRf4463SetCommand( sizeof(RF_GPIO_PIN_CFG_data), RF4463_CMD_GPIO_PIN_CFG, RF_GPIO_PIN_CFG_data );
    ...
    *********************************************************************/
      //  pcBuffer[ 0 ] = 98;
       ...
       /* pcBuffer[0]  = 0x00;    
        ...
        // ucRf4463SetCommand( RF4463_PROPERTY_GLOBAL_XO_TUNE, sizeof(RF_GLOBAL_XO_TUNE_2_data), RF_GLOBAL_XO_TUNE_2_data );
        // vBufferSetToZero( pcBuffer, 20 );
    /*********************************************************************
...
/*        pcBuffer[0]  = 0x11;  
    ...
    *********************************************************************/
    ...
    pcBuffer[3]  = 0x00;                                                     
    pcBuffer[4]  = 0x08;
    pcBuffer[5]  = 0X7f;                          // set max power
    pcBuffer[6]  = 0x00;
    pcBuffer[7]  = 0x3d;
    ucRf4463SetProperty( RF4463_PROPERTY_PA_MODE, sizeof( pcBuffer ), pcBuffer );
...
uint8_t ucRf4463SetTxPower( uint8_t ucPower ){
    uint8_t pcBuffer[8];// = { 0x08, 0x00, 0x00, 0x3D };
    ...
    pcBuffer[3]  = 0x00;                                                     
    pcBuffer[4]  = 0x08;
    //pcBuffer[5]  = ucPower;                          // set max power
    pcBuffer[6]  = 0x00;
    pcBuffer[7]  = 0x3d;
