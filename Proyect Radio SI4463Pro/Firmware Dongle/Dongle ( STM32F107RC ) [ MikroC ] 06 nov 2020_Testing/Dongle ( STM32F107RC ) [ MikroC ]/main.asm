...
ADD	R11, SP, #58
ADD	R10, R11, #9
MOVW	R12, #lo_addr(?ICS?lstr36_main+0)
MOVT	R12, #hi_addr(?ICS?lstr36_main+0)
BL	___CC2DW+0
ADD	R1, SP, #58
MOV	R0, R1
...
CMP	R1, #13
IT	EQ
BEQ	L__vUARTCommands363
LDR	R1, [SP, #68]
ADDS	R1, R1, R3
LDRB	R1, [R1, #0]
CMP	R1, #10
IT	EQ
BEQ	L__vUARTCommands362
IT	AL
...
CMP	R1, #13
IT	EQ
BEQ	L__vUARTCommands365
LDR	R1, [SP, #68]
ADDS	R1, R1, R3
LDRB	R1, [R1, #0]
CMP	R1, #10
IT	EQ
BEQ	L__vUARTCommands364
IT	AL
...
CMP	R1, #13
IT	EQ
BEQ	L__vUARTCommands367
LDR	R1, [SP, #68]
ADDS	R1, R1, R3
LDRB	R1, [R1, #0]
CMP	R1, #10
IT	EQ
BEQ	L__vUARTCommands366
IT	AL
...
CMP	R1, #13
IT	EQ
BEQ	L__vUARTCommands369
LDR	R1, [SP, #68]
ADDS	R1, R1, R7
LDRB	R1, [R1, #0]
CMP	R1, #10
IT	EQ
BEQ	L__vUARTCommands368
IT	AL
...
ADD	R11, SP, #4
ADD	R10, R11, #23
MOVW	R12, #lo_addr(?ICS?lstr67_main+0)
MOVT	R12, #hi_addr(?ICS?lstr67_main+0)
BL	___CC2DW+0
ADD	R0, SP, #4
BL	_UART1_Write_Text+0
...
ADD	R11, SP, #4
ADD	R10, R11, #23
MOVW	R12, #lo_addr(?ICS?lstr70_main+0)
MOVT	R12, #hi_addr(?ICS?lstr70_main+0)
BL	___CC2DW+0
ADD	R4, SP, #4
MOV	R0, R4
BL	_UART1_Write_Text+0
...
ADDW	R11, SP, #749
ADD	R10, R11, #8
MOVW	R12, #lo_addr(?ICS?lstr110_main+0)
MOVT	R12, #hi_addr(?ICS?lstr110_main+0)
BL	___CC2DW+0
ADDW	R0, SP, #749
BL	_UART1_Write_Text+0
...
CMP	R4, #1
IT	EQ
BEQ	L_vRf4463Init293
CMP	R4, #2
IT	EQ
BEQ	L_vRf4463Init294
; ucFrequency end address is: 16 (R4)
IT	AL
BAL	L_vRf4463Init295
L_vRf4463Init292:
...
MOVW	R2, #lo_addr(_RF_GPIO_PIN_CFG_data+0)
MOVT	R2, #hi_addr(_RF_GPIO_PIN_CFG_data+0)
MOVS	R1, #19
MOVS	R0, #8
...
CMP	R1, #0
IT	EQ
BEQ	L__vRf4463SetChannels346
CMP	R1, #50
IT	HI
BHI	L__vRf4463SetChannels345
L__vRf4463SetChannels342:
CMP	R0, #0
IT	EQ
BEQ	L__vRf4463SetChannels344
CMP	R0, #50
IT	HI
BHI	L__vRf4463SetChannels343
L__vRf4463SetChannels341:
IT	AL
BAL	L_vRf4463SetChannels306
; ucSetRxChannel end address is: 0 (R0)
; ucSetTxChannel end address is: 4 (R1)
...
MOVS	R4, #0
SXTB	R4, R4
MOVW	R3, #lo_addr(?lstr_125_main+0)
MOVT	R3, #hi_addr(?lstr_125_main+0)
...
; ucSetTxChannel start address is: 4 (R1)
; ucSetRxChannel start address is: 0 (R0)
MOVW	R3, #lo_addr(?lstr_126_main+0)
MOVT	R3, #hi_addr(?lstr_126_main+0)
MOVW	R2, #lo_addr(_vDebugPrint+0)
MOVT	R2, #hi_addr(_vDebugPrint+0)
STRB	R1, [SP, #4]
STRB	R0, [SP, #8]
...
CMP	R0, #0
IT	NE
BNE	L_vRf4463SetNetwork307
; usNetwork end address is: 0 (R0)
;rf4463pro.c,281 :: 		STM_LOGE( "[ RF4463 ] Invalid Network\r\n", NULL );
MOVS	R3, #0
SXTB	R3, R3
MOVW	R2, #lo_addr(?lstr_128_main+0)
MOVT	R2, #hi_addr(?lstr_128_main+0)
MOVW	R1, #lo_addr(_vDebugPrint+0)
MOVT	R1, #hi_addr(_vDebugPrint+0)
PUSH	(R3)
PUSH	(R2)
...
; usNetwork start address is: 0 (R0)
MOVW	R2, #lo_addr(?lstr_129_main+0)
MOVT	R2, #hi_addr(?lstr_129_main+0)
MOVW	R1, #lo_addr(_vDebugPrint+0)
MOVT	R1, #hi_addr(_vDebugPrint+0)
STRH	R0, [SP, #4]
PUSH	(R0)
...
CMP	R1, R2
IT	CS
BCS	L_vRf4463SetConfiguration309
; pcParameters end address is: 0 (R0)
...
UXTH	R1, R6
IT	AL
BAL	L_vRf4463SetConfiguration308
...
;rf4463pro.c,384 :: 		uint8_t ucRf4463GetProperty( uint16_t usStartProperty, uint8_t ucLength, uint8_t * pcParametersBuffer ){
; usStartProperty start address is: 0 (R0)
SUB	SP, SP, #20
STR	LR, [SP, #0]
STRB	R1, [SP, #12]
...
; usStartProperty end address is: 0 (R0)
; usStartProperty start address is: 4 (R1)
;rf4463pro.c,387 :: 		if( ucRf4463CheckCTS() == NOT_SUCCESS ){
STRH	R1, [SP, #4]
BL	_ucRf4463CheckCTS+0
LDRH	R1, [SP, #4]
CMP	R0, #1
IT	NE
BNE	L_ucRf4463GetProperty314
; usStartProperty end address is: 4 (R1)
;rf4463pro.c,388 :: 		return NOT_SUCCESS;
MOVS	R0, #1
IT	AL
BAL	L_end_ucRf4463GetProperty
;rf4463pro.c,389 :: 		}
L_ucRf4463GetProperty314:
;rf4463pro.c,391 :: 		pcBuffer[ 0 ] = RF4463_CMD_GET_PROPERTY;
; usStartProperty start address is: 4 (R1)
ADD	R5, SP, #8
MOVS	R3, #18
STRB	R3, [R5, #0]
;rf4463pro.c,392 :: 		pcBuffer[ 1 ] = ( usStartProperty >> 8 );
ADDS	R4, R5, #1
LSRS	R3, R1, #8
STRB	R3, [R4, #0]
;rf4463pro.c,393 :: 		pcBuffer[ 2 ] = ucLength;
ADDS	R4, R5, #2
LDRB	R3, [SP, #12]
STRB	R3, [R4, #0]
;rf4463pro.c,394 :: 		pcBuffer[ 3 ] = ( usStartProperty & 0xFF );
ADDS	R4, R5, #3
AND	R3, R1, #255
; usStartProperty end address is: 4 (R1)
STRB	R3, [R4, #0]
;rf4463pro.c,396 :: 		vRF4463SetPinSelect( PIN_LEVEL_LOW );
MOVS	R0, #0
BL	_vRF4463SetPinSelect+0
;rf4463pro.c,397 :: 		vRf4463SPIWriteBuffer( 4, pcBuffer );
ADD	R3, SP, #8
MOV	R1, R3
MOVS	R0, #4
BL	_vRf4463SPIWriteBuffer+0
;rf4463pro.c,399 :: 		if( ucRf4463CheckCTS() == NOT_SUCCESS ){
BL	_ucRf4463CheckCTS+0
CMP	R0, #1
IT	NE
BNE	L_ucRf4463GetProperty315
;rf4463pro.c,400 :: 		return NOT_SUCCESS;
MOVS	R0, #1
IT	AL
BAL	L_end_ucRf4463GetProperty
;rf4463pro.c,401 :: 		}
L_ucRf4463GetProperty315:
;rf4463pro.c,403 :: 		vRF4463SetPinSelect( PIN_LEVEL_LOW );
MOVS	R0, #0
BL	_vRF4463SetPinSelect+0
;rf4463pro.c,404 :: 		ucRf4463SPIByte( RF4463_CMD_READ_BUF );
MOVS	R0, #68
BL	_ucRf4463SPIByte+0
;rf4463pro.c,405 :: 		vRf4463SPIReadBuffer( ucLength, pcParametersBuffer );
LDR	R1, [SP, #16]
LDRB	R0, [SP, #12]
BL	_vRf4463SPIReadBuffer+0
;rf4463pro.c,406 :: 		vRF4463SetPinSelect( PIN_LEVEL_HIGH );
MOVS	R0, #1
BL	_vRF4463SetPinSelect+0
...
CMP	R1, #0
IT	EQ
BEQ	L__ucRf4463SetSyncWords349
CMP	R1, #3
IT	HI
BHI	L__ucRf4463SetSyncWords348
IT	AL
BAL	L_ucRf4463SetSyncWords318
; pcSyncWords end address is: 0 (R0)
; ucLength end address is: 4 (R1)
...
;rf4463pro.c,429 :: 		uint8_t ucRf4463SetPreambleLength( uint8_t ucLength ){
SUB	SP, SP, #8
STR	LR, [SP, #0]
STRB	R0, [SP, #4]
;rf4463pro.c,430 :: 		return ucRf4463SetProperty( RF4463_PROPERTY_PREAMBLE_TX_LENGTH, 1, &ucLength );
ADD	R1, SP, #4
MOV	R2, R1
MOVS	R1, #1
MOVW	R0, #4096
...
CMP	R0, #1
IT	NE
BNE	L_ucRf4463DeviceAvailability322
...
CMP	R1, R0
IT	EQ
BEQ	L_ucRf4463DeviceAvailability323
...
;rf4463pro.c,543 :: 		uint8_t ucRf4463SetGPIOMode( uint8_t ucGPIO0Mode, uint8_t ucGPIO1Mode ){
...
; ucGPIO0Mode start address is: 0 (R0)
; ucGPIO1Mode start address is: 4 (R1)
;rf4463pro.c,544 :: 		uint8_t pcBuffer[ 6 ] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
MOVS	R2, #0
STRB	R2, [SP, #4]
MOVS	R2, #0
STRB	R2, [SP, #5]
...
MOVS	R2, #0
STRB	R2, [SP, #9]
;rf4463pro.c,546 :: 		pcBuffer[ 0 ] = ucGPIO0Mode;
ADD	R3, SP, #4
STRB	R0, [R3, #0]
; ucGPIO0Mode end address is: 0 (R0)
;rf4463pro.c,547 :: 		pcBuffer[ 1 ] = ucGPIO1Mode;
ADDS	R2, R3, #1
STRB	R1, [R2, #0]
; ucGPIO1Mode end address is: 4 (R1)
;rf4463pro.c,549 :: 		return ucRf4463SetCommand( sizeof( pcBuffer ), RF4463_CMD_GPIO_PIN_CFG, pcBuffer );
MOV	R2, R3
MOVS	R1, #19
MOVS	R0, #6
BL	_ucRf4463SetCommand+0
...
;rf4463pro.c,594 :: 		uint8_t ucRf4463SetTxInterrupt(){
SUB	SP, SP, #8
STR	LR, [SP, #0]
;rf4463pro.c,595 :: 		uint8_t pcBuffer[ 3 ] = { 0x01, 0x20, 0x00 };
MOVS	R0, #1
STRB	R0, [SP, #4]
MOVS	R0, #32
STRB	R0, [SP, #5]
MOVS	R0, #0
STRB	R0, [SP, #6]
;rf4463pro.c,596 :: 		return ucRf4463SetProperty( RF4463_PROPERTY_INT_CTL_ENABLE, 3, pcBuffer );
ADD	R0, SP, #4
MOV	R2, R0
MOVS	R1, #3
MOVW	R0, #256
...
CMP	R0, #127
IT	LS
BLS	L__ucRf4463SetTxPower350
;rf4463pro.c,615 :: 		STM_LOGE( "[ RF4463 ] Invalid Power Value: %d\r\n", ucPower );
MOVW	R2, #lo_addr(?lstr_133_main+0)
MOVT	R2, #hi_addr(?lstr_133_main+0)
MOVW	R1, #lo_addr(_vDebugPrint+0)
MOVT	R1, #hi_addr(_vDebugPrint+0)
PUSH	(R0)
; ucPower end address is: 0 (R0)
...
MOVW	R2, #lo_addr(?lstr_134_main+0)
MOVT	R2, #hi_addr(?lstr_134_main+0)
MOVW	R1, #lo_addr(_vDebugPrint+0)
MOVT	R1, #hi_addr(_vDebugPrint+0)
PUSH	(R0)
; ucPower end address is: 0 (R0)
...
;rf4463pro.c,659 :: 		uint8_t ucRf4463TxPacket_Seq( uint8_t * pcTxBuffer, uint8_t ucTxLength ){
SUB	SP, SP, #12
STR	LR, [SP, #0]
STR	R0, [SP, #4]
STRB	R1, [SP, #8]
;rf4463pro.c,661 :: 		uint8_t ucCounter = 0;
;rf4463pro.c,663 :: 		vRf4463FIFOReset();
BL	_vRf4463FIFOReset+0
;rf4463pro.c,664 :: 		vRf4463WriteTxFIFO( pcTxBuffer, ucTxLength );
LDRB	R1, [SP, #8]
LDR	R0, [SP, #4]
BL	_vRf4463WriteTxFIFO+0
;rf4463pro.c,665 :: 		ucRf4463ClearInterrupts();
BL	_ucRf4463ClearInterrupts+0
;rf4463pro.c,666 :: 		vRf4463EnterTxMode();
BL	_vRf4463EnterTxMode+0
;rf4463pro.c,668 :: 		for( ;; ){
L_ucRf4463TxPacket_Seq325:
;rf4463pro.c,669 :: 		if( ucRF4463GetIRQFlag() == 1 ){
BL	_ucRF4463GetIRQFlag+0
CMP	R0, #1
IT	NE
BNE	L_ucRf4463TxPacket_Seq328
;rf4463pro.c,670 :: 		break;
IT	AL
BAL	L_ucRf4463TxPacket_Seq326
;rf4463pro.c,671 :: 		}
L_ucRf4463TxPacket_Seq328:
;rf4463pro.c,672 :: 		}
IT	AL
BAL	L_ucRf4463TxPacket_Seq325
L_ucRf4463TxPacket_Seq326:
;rf4463pro.c,674 :: 		return SUCCESS;
MOVS	R0, #0
;rf4463pro.c,675 :: 		}
...
;rf4463pro.c,692 :: 		uint8_t ucRf4463SetRxInterrupt(){
SUB	SP, SP, #8
STR	LR, [SP, #0]
;rf4463pro.c,693 :: 		uint8_t pcBuffer[ 3 ] = { 0x03, 0x18, 0x00 };
MOVS	R0, #3
STRB	R0, [SP, #4]
MOVS	R0, #24
STRB	R0, [SP, #5]
MOVS	R0, #0
STRB	R0, [SP, #6]
;rf4463pro.c,694 :: 		return ucRf4463SetProperty( RF4463_PROPERTY_INT_CTL_ENABLE, 3, pcBuffer );
ADD	R0, SP, #4
MOV	R2, R0
MOVS	R1, #3
MOVW	R0, #256
...
;rf4463pro.c,755 :: 		uint8_t ucRF4463GetModemStatus(){
SUB	SP, SP, #8
STR	LR, [SP, #0]
;rf4463pro.c,758 :: 		ucRf4463GetCommand( 3, RF4463_CMD_GET_MODEM_STATUS, pcData );
ADD	R0, SP, #4
MOV	R2, R0
MOVS	R1, #34
MOVS	R0, #3
BL	_ucRf4463GetCommand+0
;rf4463pro.c,760 :: 		STM_LOGV( "[ RF4463 ] Modem Status\r\n", NULL );
MOVS	R2, #0
SXTB	R2, R2
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463pro.c,761 :: 		STM_LOGV( "[ ] CTS:          0x%X\r\n", pcData[ 0 ] );
ADD	R0, SP, #4
LDRB	R0, [R0, #0]
UXTB	R2, R0
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463pro.c,762 :: 		STM_LOGV( "[ ] MODEM_PEND:   0x%X\r\n", pcData[ 1 ] );
ADD	R0, SP, #4
ADDS	R0, R0, #1
LDRB	R0, [R0, #0]
UXTB	R2, R0
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463pro.c,763 :: 		STM_LOGV( "[ ] MODEM_STATUS: 0x%X\r\n", pcData[ 2 ] );
ADD	R0, SP, #4
ADDS	R0, R0, #2
LDRB	R0, [R0, #0]
UXTB	R2, R0
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463pro.c,765 :: 		return pcData[ 2 ];
ADD	R0, SP, #4
ADDS	R0, R0, #2
LDRB	R0, [R0, #0]
;rf4463pro.c,766 :: 		}
...
;rf4463pro.c,771 :: 		uint8_t ucRF4463GetIntStatus(){
SUB	SP, SP, #16
STR	LR, [SP, #0]
;rf4463pro.c,774 :: 		ucRf4463GetCommand( 9, RF4463_CMD_GET_INT_STATUS , pcData );
ADD	R0, SP, #4
MOV	R2, R0
MOVS	R1, #32
MOVS	R0, #9
BL	_ucRf4463GetCommand+0
;rf4463pro.c,776 :: 		if( pcData[ GET_INT_STATUS_REPLY_INDEX_CHIP_STATUS ] == ( GET_INT_STATUS_REPLY_CHIP_STATUS_FIFO_UNDERFLOW_OVERFLOW_ERROR | GET_INT_STATUS_REPLY_CHIP_STATUS_STATE_CHANGE ) ){
ADD	R0, SP, #4
ADDS	R0, #8
LDRB	R0, [R0, #0]
CMP	R0, #48
IT	NE
BNE	L_ucRF4463GetIntStatus330
;rf4463pro.c,777 :: 		STM_LOGI( "[ RF4463 ] Underflow Overflow flag is active\r\n", NULL );
MOVS	R2, #0
SXTB	R2, R2
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463pro.c,788 :: 		return 1;
MOVS	R0, #1
IT	AL
BAL	L_end_ucRF4463GetIntStatus
;rf4463pro.c,789 :: 		}
L_ucRF4463GetIntStatus330:
;rf4463pro.c,790 :: 		return 0;
MOVS	R0, #0
;rf4463pro.c,791 :: 		}
...
;rf4463pro.c,796 :: 		uint8_t ucRF4463CheckIntStatus(){
SUB	SP, SP, #16
STR	LR, [SP, #0]
;rf4463pro.c,799 :: 		ucRf4463GetCommand( 9, RF4463_CMD_GET_INT_STATUS , pcData );
ADD	R0, SP, #4
MOV	R2, R0
MOVS	R1, #32
MOVS	R0, #9
BL	_ucRf4463GetCommand+0
;rf4463pro.c,801 :: 		STM_LOGV( "[ RF4463 ] Get Interrupt Flags Status\r\n", NULL );
MOVS	R2, #0
SXTB	R2, R2
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463pro.c,803 :: 		STM_LOGV( "[ RF4463 INT_STATUS ] INT_PEND:     0x%02x\r\n", pcData[ GET_INT_STATUS_REPLY_INDEX_INT_PEND ] );
ADD	R0, SP, #4
ADDS	R0, R0, #1
LDRB	R0, [R0, #0]
UXTB	R2, R0
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463pro.c,804 :: 		STM_LOGV( "[ RF4463 INT_STATUS ] INT_STATUS:   0x%02x\r\n", pcData[ GET_INT_STATUS_REPLY_INDEX_INT_STATUS ] );
ADD	R0, SP, #4
ADDS	R0, R0, #2
LDRB	R0, [R0, #0]
UXTB	R2, R0
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463pro.c,805 :: 		STM_LOGV( "[ RF4463 INT_STATUS ] PH_PEND:      0x%02x\r\n", pcData[ GET_INT_STATUS_REPLY_INDEX_PH_PEND ] );
ADD	R0, SP, #4
ADDS	R0, R0, #3
LDRB	R0, [R0, #0]
UXTB	R2, R0
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463pro.c,806 :: 		STM_LOGV( "[ RF4463 INT_STATUS ] PH_STATUS:    0x%02x\r\n", pcData[ GET_INT_STATUS_REPLY_INDEX_PH_STATUS ] );
ADD	R0, SP, #4
ADDS	R0, R0, #4
LDRB	R0, [R0, #0]
UXTB	R2, R0
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463pro.c,807 :: 		STM_LOGV( "[ RF4463 INT_STATUS ] MODEM_PEND:   0x%02x\r\n", pcData[ GET_INT_STATUS_REPLY_INDEX_MODEM_PEND ] );
ADD	R0, SP, #4
ADDS	R0, R0, #5
LDRB	R0, [R0, #0]
UXTB	R2, R0
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463pro.c,808 :: 		STM_LOGV( "[ RF4463 INT_STATUS ] MODEM_STATUS: 0x%02x\r\n", pcData[ GET_INT_STATUS_REPLY_INDEX_MODEM_STATUS ] );
ADD	R0, SP, #4
ADDS	R0, R0, #6
LDRB	R0, [R0, #0]
UXTB	R2, R0
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463pro.c,809 :: 		STM_LOGV( "[ RF4463 INT_STATUS ] CHIP_PEND:    0x%02x\r\n", pcData[ GET_INT_STATUS_REPLY_INDEX_CHIP_PEND ] );
ADD	R0, SP, #4
ADDS	R0, R0, #7
LDRB	R0, [R0, #0]
UXTB	R2, R0
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463pro.c,810 :: 		STM_LOGV( "[ RF4463 INT_STATUS ] CHIP_STATUS:  0x%02x\r\n", pcData[ GET_INT_STATUS_REPLY_INDEX_CHIP_STATUS ] );
ADD	R0, SP, #4
ADDS	R0, #8
LDRB	R0, [R0, #0]
UXTB	R2, R0
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463pro.c,812 :: 		return ( pcData[ GET_INT_STATUS_REPLY_INDEX_CHIP_STATUS ] & GET_INT_STATUS_REPLY_CHIP_STATUS_FIFO_UNDERFLOW_OVERFLOW_ERROR );
ADD	R0, SP, #4
ADDS	R0, #8
LDRB	R0, [R0, #0]
AND	R0, R0, #32
...
_vRF4463CheckState:
;rf4463pro.c,818 :: 		void vRF4463CheckState(){
SUB	SP, SP, #8
STR	LR, [SP, #0]
;rf4463pro.c,821 :: 		if( ucRf4463CheckCTS() == NOT_SUCCESS ){
BL	_ucRf4463CheckCTS+0
CMP	R0, #1
IT	NE
BNE	L_vRF4463CheckState331
;rf4463pro.c,822 :: 		STM_LOGE( "[ RF4463 ] Failed CTS\r\n", NULL );
MOVS	R2, #0
SXTB	R2, R2
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463pro.c,823 :: 		return;
IT	AL
BAL	L_end_vRF4463CheckState
;rf4463pro.c,824 :: 		}
L_vRF4463CheckState331:
;rf4463pro.c,826 :: 		ucRf4463GetCommand( 3, RF4463_CMD_REQUEST_DEVICE_STATE, pcData );
ADD	R0, SP, #4
MOV	R2, R0
MOVS	R1, #51
MOVS	R0, #3
BL	_ucRf4463GetCommand+0
;rf4463pro.c,828 :: 		STM_LOGV( "[ RF4463 ] Main State: 0x%02X\r\n", pcData[ 1 ] );
ADD	R0, SP, #4
ADDS	R0, R0, #1
LDRB	R0, [R0, #0]
UXTB	R2, R0
...
BL	_PrintOut+0
ADD	SP, SP, #12
;rf4463pro.c,829 :: 		STM_LOGV( "[ RF4463 ] Current Channel: 0x%02X\r\n", pcData[ 2 ] );
ADD	R0, SP, #4
ADDS	R0, R0, #2
LDRB	R0, [R0, #0]
UXTB	R2, R0
...
_vRF4463SetState:
;rf4463pro.c,835 :: 		void vRF4463SetState( uint8_t ucState ){
; ucState start address is: 0 (R0)
SUB	SP, SP, #8
STR	LR, [SP, #0]
; ucState end address is: 0 (R0)
; ucState start address is: 0 (R0)
;rf4463pro.c,838 :: 		pcData[ 0 ] = ucState;
ADD	R1, SP, #4
STRB	R0, [R1, #0]
; ucState end address is: 0 (R0)
;rf4463pro.c,840 :: 		ucRf4463SetCommand( 1, RF4463_CMD_CHANGE_STATE, pcData );
MOV	R2, R1
MOVS	R1, #52
MOVS	R0, #1
BL	_ucRf4463SetCommand+0
...
CMP	R3, #0
IT	EQ
BEQ	L_vRf4463SPIWriteBuffer333
; usWriteLength end address is: 16 (R4)
...
IT	AL
BAL	L_vRf4463SPIWriteBuffer332
