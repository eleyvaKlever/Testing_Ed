...
CMP	R0, #0
IT	HI
BLHI	L__vRF4463Init396
MOVW	R0, #lo_addr(_ucRF4463Power+0)
MOVT	R0, #hi_addr(_ucRF4463Power+0)
LDRB	R0, [R0, #0]
CMP	R0, #127
IT	CC
BLCC	L__vRF4463Init396
IT	AL
...
CMP	R0, #7
IT	LS
BLLS	L__vRF4463Init395
MOVW	R0, #lo_addr(_ucRF4463Rate+0)
MOVT	R0, #hi_addr(_ucRF4463Rate+0)
LDRB	R0, [R0, #0]
CMP	R0, #10
IT	EQ
BLEQ	L__vRF4463Init395
IT	AL
...
ORRS	R0, R1
_SX	[R2, ByteOffset(_Flag+0)]
;driverrf4463pro.c,566 :: 		Level7Led = ~Level7Led;
...
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #1
ANDS	R1, R3
BEQ	L__vRF4463TxData446
MOVS	R1, #2
ORRS	R0, R1
B	L__vRF4463TxData445
L__vRF4463TxData446:
MOVS	R1, #2
BICS	R0, R1
L__vRF4463TxData445:
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;driverrf4463pro.c,568 :: 		vRF4463FifoReset();            // fifo_reset();  // Buffer empty
BL	_vRF4463FifoReset+0
;driverrf4463pro.c,569 :: 		spi_write_fifo();              // Fill the buffer with data
BL	_spi_write_fifo+0
;driverrf4463pro.c,570 :: 		vRF4463EnableTxInterrupt();    // enable_tx_interrupt();
BL	_vRF4463EnableTxInterrupt+0
;driverrf4463pro.c,571 :: 		vRF4463ClearInterrupts();       // clr_interrupt();  // Clear interrupt factor
BL	_vRF4463ClearInterrupts+0
;driverrf4463pro.c,572 :: 		vRF4463TxStart();              // tx_start();    // Enter launch mode, start launch
BL	_vRF4463TxStart+0
;driverrf4463pro.c,573 :: 		rf_timeout = 0;
MOVS	R1, #0
MOVW	R0, #lo_addr(_rf_timeout+0)
MOVT	R0, #hi_addr(_rf_timeout+0)
STRH	R1, [R0, #0]
;driverrf4463pro.c,575 :: 		Flag.rf_reach_timeout = 0;
MOVW	R2, #lo_addr(_Flag+0)
MOVT	R2, #hi_addr(_Flag+0)
_LX	[R2, ByteOffset(_Flag+0)]
MOVS	R1, #4
BICS	R0, R1
_SX	[R2, ByteOffset(_Flag+0)]
;driverrf4463pro.c,577 :: 		if ( ucRF4463IRQ ) {
MOVW	R0, #lo_addr(DriverRF4463PROMain_ucRF4463IRQ+0)
MOVT	R0, #hi_addr(DriverRF4463PROMain_ucRF4463IRQ+0)
LDRB	R0, [R0, #0]
CMP	R0, #0
...
;driverrf4463pro.c,578 :: 		UART1_Write_Text( "[ UART1 ] TX INT\r\n" );
MOV	R6, SP
MOVS	R5, #19
ADDS	R5, R5, R6
...
L_vRF4463TxData93:
;driverrf4463pro.c,582 :: 		while ( nIRQ ) {     //nIRQ
L_vRF4463TxData94:
...
;driverrf4463pro.c,585 :: 		if ( Flag.rf_reach_timeout ) {
...
;driverrf4463pro.c,586 :: 		VRF4463SDNReset();
BL	_VRF4463SDNReset+0
;driverrf4463pro.c,587 :: 		vRF4463Init();        //SI4463_init();  // RF Module initialization
BL	_vRF4463Init+0
;driverrf4463pro.c,588 :: 		break;                // Forced out
IT	AL
...
MOVT	R0, #hi_addr(_tx_cnt+0)
STR	R1, [R0, #0]
;driverrf4463pro.c,594 :: 		vRF4463RxInit();          // rx_init();                //rf After the transmission is completed, enter the receiving mode
BL	_vRF4463RxInit+0
;driverrf4463pro.c,595 :: 		}
L_end_vRF4463TxData:
ADD	SP, SP, #20
POP	(R15)
; end of _vRF4463TxData
_vRF4463TxCont:
;driverrf4463pro.c,600 :: 		void vRF4463TxCont( void ) {
PUSH	(R14)
;driverrf4463pro.c,603 :: 		Level7Led = ~Level7Led;
MOVW	R0, #lo_addr(GPIOA_ODR+0)
MOVT	R0, #hi_addr(GPIOA_ODR+0)
_LX	[R0, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #2
...
MOVS	R1, #1
ANDS	R1, R3
BEQ	L__vRF4463TxCont449
MOVS	R1, #2
ORRS	R0, R1
B	L__vRF4463TxCont448
L__vRF4463TxCont449:
MOVS	R1, #2
BICS	R0, R1
L__vRF4463TxCont448:
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;driverrf4463pro.c,604 :: 		vRF4463FifoReset();                     //  fifo_reset();  // Buffer empty
BL	_vRF4463FifoReset+0
;driverrf4463pro.c,605 :: 		spi_write_fifo();                       // Fill the buffer with data
BL	_spi_write_fifo+0
;driverrf4463pro.c,606 :: 		vRF4463EnableTxInterrupt();             //  enable_tx_interrupt();
BL	_vRF4463EnableTxInterrupt+0
;driverrf4463pro.c,607 :: 		vRF4463ClearInterrupts();               //  clr_interrupt();  // Clear interrupt factor
BL	_vRF4463ClearInterrupts+0
;driverrf4463pro.c,608 :: 		vRF4463TxStart();                       //  tx_start();    // Enter launch mode, start launch
BL	_vRF4463TxStart+0
;driverrf4463pro.c,609 :: 		rf_timeout = 0;
MOVS	R1, #0
MOVW	R0, #lo_addr(_rf_timeout+0)
MOVT	R0, #hi_addr(_rf_timeout+0)
STRH	R1, [R0, #0]
;driverrf4463pro.c,610 :: 		Flag.rf_reach_timeout = 0;
MOVW	R2, #lo_addr(_Flag+0)
MOVT	R2, #hi_addr(_Flag+0)
_LX	[R2, ByteOffset(_Flag+0)]
MOVS	R1, #4
BICS	R0, R1
_SX	[R2, ByteOffset(_Flag+0)]
;driverrf4463pro.c,612 :: 		ucRF4463IRQ = 0;
MOVS	R1, #0
MOVW	R0, #lo_addr(DriverRF4463PROMain_ucRF4463IRQ+0)
MOVT	R0, #hi_addr(DriverRF4463PROMain_ucRF4463IRQ+0)
STRB	R1, [R0, #0]
;driverrf4463pro.c,615 :: 		while( nIRQ ) {          //nIRQ ) {
L_vRF4463TxCont97:
MOVW	R0, #lo_addr(GPIOH_IDR+0)
MOVT	R0, #hi_addr(GPIOH_IDR+0)
_LX	[R0, ByteOffset(GPIOH_IDR+0)]
...
_rf_init_freq:
;driverrf4463pro.c,629 :: 		void rf_init_freq ( void ) {
PUSH	(R14)
SUB	SP, SP, #64
;driverrf4463pro.c,635 :: 		ulFrequency = ( ucRF4463Freq3 * 100 ) + ( ucRF4463Freq2 * 10 ) + ucRF4463Freq1;
MOVW	R0, #lo_addr(_ucRF4463Freq3+0)
MOVT	R0, #hi_addr(_ucRF4463Freq3+0)
LDRB	R1, [R0, #0]
MOVS	R0, #100
...
SXTH	R0, R0
STR	R0, [SP, #40]
;driverrf4463pro.c,637 :: 		ulFrequency = ( ulFrequency * 10000 );
LDR	R2, [SP, #40]
MOVW	R1, #10000
MOVT	R1, #0
MOV	R0, R1
MULS	R0, R2, R0
STR	R0, [SP, #40]
;driverrf4463pro.c,640 :: 		if ( ulFrequency >= 7600000 ) {
LDR	R1, [SP, #40]
MOVW	R0, #63360
MOVT	R0, #115
CMP	R1, R0
...
;driverrf4463pro.c,641 :: 		ucOUTDIV = 4;
MOVS	R0, #4
STR	R0, [SP, #0]
;driverrf4463pro.c,642 :: 		ucBAND = 0;
MOVS	R0, #0
STR	R0, [SP, #16]
;driverrf4463pro.c,643 :: 		ucVCO = 0xFF;
MOVS	R0, #255
STR	R0, [SP, #8]
;driverrf4463pro.c,644 :: 		}
IT	AL
BLAL	L_rf_init_freq100
L_rf_init_freq99:
;driverrf4463pro.c,647 :: 		else if ( ulFrequency >= 5460000 ) {
LDR	R1, [SP, #40]
MOVW	R0, #20512
MOVT	R0, #83
CMP	R1, R0
...
;driverrf4463pro.c,648 :: 		ucOUTDIV = 6;
MOVS	R0, #6
STR	R0, [SP, #0]
;driverrf4463pro.c,649 :: 		ucBAND   = 1;
MOVS	R0, #1
STR	R0, [SP, #16]
;driverrf4463pro.c,650 :: 		ucVCO    = 0xFE;
MOVS	R0, #254
STR	R0, [SP, #8]
...
L_rf_init_freq101:
;driverrf4463pro.c,654 :: 		else if ( ulFrequency >= 3850000 ) {
LDR	R1, [SP, #40]
MOVW	R0, #48912
MOVT	R0, #58
CMP	R1, R0
...
;driverrf4463pro.c,655 :: 		ucOUTDIV = 8;
MOVS	R0, #8
STR	R0, [SP, #0]
;driverrf4463pro.c,656 :: 		ucBAND   = 2;
MOVS	R0, #2
STR	R0, [SP, #16]
;driverrf4463pro.c,657 :: 		ucVCO    = 0xFE;
MOVS	R0, #254
STR	R0, [SP, #8]
;driverrf4463pro.c,658 :: 		}
IT	AL
BLAL	L_rf_init_freq104
L_rf_init_freq103:
;driverrf4463pro.c,661 :: 		else if ( ulFrequency >= 2730000 ) {
LDR	R1, [SP, #40]
MOVW	R0, #43024
MOVT	R0, #41
CMP	R1, R0
...
;driverrf4463pro.c,662 :: 		ucOUTDIV = 12;
MOVS	R0, #12
STR	R0, [SP, #0]
;driverrf4463pro.c,663 :: 		ucBAND   = 3;
MOVS	R0, #3
STR	R0, [SP, #16]
;driverrf4463pro.c,664 :: 		ucVCO    = 0xFD;
MOVS	R0, #253
STR	R0, [SP, #8]
;driverrf4463pro.c,665 :: 		}
IT	AL
BLAL	L_rf_init_freq106
L_rf_init_freq105:
;driverrf4463pro.c,668 :: 		else if ( ulFrequency >= 1940000 ) {
LDR	R1, [SP, #40]
MOVW	R0, #39456
MOVT	R0, #29
CMP	R1, R0
...
;driverrf4463pro.c,669 :: 		ucOUTDIV = 16;
MOVS	R0, #16
STR	R0, [SP, #0]
;driverrf4463pro.c,670 :: 		ucBAND   = 4;
MOVS	R0, #4
STR	R0, [SP, #16]
;driverrf4463pro.c,671 :: 		ucVCO    = 0xFC;
MOVS	R0, #252
STR	R0, [SP, #8]
;driverrf4463pro.c,672 :: 		}
IT	AL
BLAL	L_rf_init_freq108
L_rf_init_freq107:
;driverrf4463pro.c,676 :: 		ucOUTDIV = 24;
MOVS	R0, #24
STR	R0, [SP, #0]
;driverrf4463pro.c,677 :: 		ucBAND   = 5;
MOVS	R0, #5
STR	R0, [SP, #16]
;driverrf4463pro.c,678 :: 		ucVCO    = 0xFA;
MOVS	R0, #250
STR	R0, [SP, #8]
...
L_rf_init_freq102:
L_rf_init_freq100:
;driverrf4463pro.c,681 :: 		ucDIV = ucOUTDIV / 2;
LDR	R0, [SP, #0]
UXTB	R0, R0
MOVS	R2, #2
BL	__Div_32x32_U+0
STR	R0, [SP, #4]
;driverrf4463pro.c,683 :: 		ulData = ( ulFrequency * ucDIV ) / 3;          // ucDIV = 88.5 = 88   //// UCdiv = 2
LDR	R2, [SP, #4]
UXTB	R2, R2
LDR	R0, [SP, #40]
MOV	R1, R2
...
BL	__Div_32x32_U+0
STR	R0, [SP, #36]
;driverrf4463pro.c,684 :: 		ucINTE = ( ulData / 100000) - 1;               // ulData = 6 000 000  //// ULdATA = 9 000 000
LDR	R0, [SP, #36]
MOVW	R2, #34464
MOVT	R2, #1
BL	__Div_32x32_U+0
SUBS	R0, R0, #1
STR	R0, [SP, #12]
;driverrf4463pro.c,685 :: 		ulFRAC = ( ulData - ( ucINTE + 1 ) * 100000 ) * 16384 / 3125;         // ulFRAC = 15 728 640
LDR	R0, [SP, #12]
UXTB	R0, R0
ADDS	R2, R0, #1
SXTH	R2, R2
...
BL	__Div_32x32_U+0
STR	R0, [SP, #32]
;driverrf4463pro.c,686 :: 		ulFRAC = ulFRAC + 0x80000;
LDR	R1, [SP, #32]
MOVW	R0, #0
MOVT	R0, #8
ADDS	R0, R1, R0
STR	R0, [SP, #32]
;driverrf4463pro.c,688 :: 		ucFRAC_0 = ulFRAC;
LDR	R0, [SP, #32]
STR	R0, [SP, #28]
...
LSRS	R0, R0, #8
STR	R0, [SP, #32]
;driverrf4463pro.c,690 :: 		ucFRAC_1 = ulFRAC;
LDR	R0, [SP, #32]
STR	R0, [SP, #24]
;driverrf4463pro.c,691 :: 		ulFRAC >>= 8;
LDR	R0, [SP, #32]
LSRS	R0, R0, #8
STR	R0, [SP, #32]
;driverrf4463pro.c,692 :: 		ucFRAC_2 = ulFRAC;
LDR	R0, [SP, #32]
STR	R0, [SP, #20]
;driverrf4463pro.c,696 :: 		app_command_buf[ 0 ] = 0x11;           // SET property    MODEM_CLKGEN_BAND
MOVS	R0, #44
ADD	R0, SP, R0
ADDS	R1, R0, #0
MOVS	R0, #17
STRB	R0, [R1, #0]
;driverrf4463pro.c,697 :: 		app_command_buf[ 1 ] = 0x20;           // Group  // 0x2051
MOVS	R0, #44
ADD	R0, SP, R0
ADDS	R1, R0, #1
MOVS	R0, #32
STRB	R0, [R1, #0]
;driverrf4463pro.c,698 :: 		app_command_buf[ 2 ] = 0x01;           // Num Arguments // Total 1 Parameters
MOVS	R0, #44
ADD	R0, SP, R0
ADDS	R1, R0, #2
MOVS	R0, #1
STRB	R0, [R1, #0]
;driverrf4463pro.c,699 :: 		app_command_buf[ 3 ] = 0x51;           // Number  // 0x2051
MOVS	R0, #44
ADD	R0, SP, R0
ADDS	R1, R0, #3
MOVS	R0, #81
STRB	R0, [R1, #0]
;driverrf4463pro.c,700 :: 		app_command_buf[ 4 ] = 0x08 | ucBAND;  // Argumento  //  high performance mode , clk outpu = osc /4
MOVS	R0, #44
ADD	R0, SP, R0
ADDS	R2, R0, #4
LDR	R1, [SP, #16]
...
ORRS	R0, R1
STRB	R0, [R2, #0]
;driverrf4463pro.c,701 :: 		spi_write( 5, app_command_buf );
MOVS	R0, #44
ADD	R0, SP, R0
PUSH	(R0)
MOVS	R0, #5
...
BL	_spi_write+0
ADD	SP, SP, #8
;driverrf4463pro.c,703 :: 		app_command_buf[ 0 ]  = 0x11;
MOVS	R0, #44
ADD	R0, SP, R0
ADDS	R1, R0, #0
MOVS	R0, #17
STRB	R0, [R1, #0]
;driverrf4463pro.c,704 :: 		app_command_buf[ 1 ]  = 0x40;    // 0x4000         FREQ_CONTROL_INTE
MOVS	R0, #44
ADD	R0, SP, R0
ADDS	R1, R0, #1
MOVS	R0, #64
STRB	R0, [R1, #0]
;driverrf4463pro.c,705 :: 		app_command_buf[ 2 ]  = 0x08;    // Total 8 Parameters
MOVS	R0, #44
ADD	R0, SP, R0
ADDS	R1, R0, #2
MOVS	R0, #8
STRB	R0, [R1, #0]
;driverrf4463pro.c,706 :: 		app_command_buf[ 3 ]  = 0x00;   // 0x4000
MOVS	R0, #44
ADD	R0, SP, R0
ADDS	R1, R0, #3
MOVS	R0, #0
STRB	R0, [R1, #0]
;driverrf4463pro.c,707 :: 		app_command_buf[ 4 ]  = ucINTE;   //  default value
MOVS	R0, #44
ADD	R0, SP, R0
ADDS	R1, R0, #4
LDR	R0, [SP, #12]
UXTB	R0, R0
STRB	R0, [R1, #0]
;driverrf4463pro.c,708 :: 		app_command_buf[ 5 ]  = ucFRAC_2;   //  defaul value
MOVS	R0, #44
ADD	R0, SP, R0
ADDS	R1, R0, #5
LDR	R0, [SP, #20]
UXTB	R0, R0
STRB	R0, [R1, #0]
;driverrf4463pro.c,709 :: 		app_command_buf[ 6 ]  = ucFRAC_1;   //  default value
MOVS	R0, #44
ADD	R0, SP, R0
ADDS	R1, R0, #6
LDR	R0, [SP, #24]
UXTB	R0, R0
STRB	R0, [R1, #0]
;driverrf4463pro.c,710 :: 		app_command_buf[ 7 ]  = ucFRAC_0;   // frac ,from WDS
MOVS	R0, #44
ADD	R0, SP, R0
ADDS	R1, R0, #7
LDR	R0, [SP, #28]
UXTB	R0, R0
STRB	R0, [R1, #0]
;driverrf4463pro.c,713 :: 		if ( ulRF4463Step == 250 ) {
...
;driverrf4463pro.c,714 :: 		app_command_buf[ 8 ]  = step_250K_step1;   // channel step1  from wds  // al parecer aqu? esta el ancho del canal
MOVS	R0, #44
ADD	R0, SP, R0
MOV	R1, R0
ADDS	R1, #8
MOVS	R0, #34
STRB	R0, [R1, #0]
;driverrf4463pro.c,715 :: 		app_command_buf[ 9 ]  = step_250K_step0;   // channel step0  from wds
MOVS	R0, #44
ADD	R0, SP, R0
MOV	R1, R0
ADDS	R1, #9
MOVS	R0, #34
STRB	R0, [R1, #0]
;driverrf4463pro.c,716 :: 		}
IT	AL
BLAL	L_rf_init_freq110
L_rf_init_freq109:
;driverrf4463pro.c,717 :: 		else if ( ulRF4463Step == 500 ) {
MOVW	R0, #lo_addr(_ulRF4463Step+0)
MOVT	R0, #hi_addr(_ulRF4463Step+0)
LDR	R1, [R0, #0]
MOVS	R0, #255
...
;driverrf4463pro.c,718 :: 		app_command_buf[ 8 ]  = step_500K_step1;   // channel step1  from wds  // al parecer aqu? esta el ancho del canal
MOVS	R0, #44
ADD	R0, SP, R0
MOV	R1, R0
ADDS	R1, #8
MOVS	R0, #68
STRB	R0, [R1, #0]
;driverrf4463pro.c,719 :: 		app_command_buf[ 9 ]  = step_500K_step0;   // channel step0  from wds
MOVS	R0, #44
ADD	R0, SP, R0
MOV	R1, R0
ADDS	R1, #9
...
UXTB	R0, R0
STRB	R0, [R1, #0]
;driverrf4463pro.c,724 :: 		spi_write( 12, app_command_buf );
MOVS	R0, #44
ADD	R0, SP, R0
PUSH	(R0)
MOVS	R0, #12
...
_ucRf4463SPIByte:
;driverrf4463pro.c,745 :: 		unsigned char ucRf4463SPIByte( unsigned char ucData ) {
PUSH	(R14)
;driverrf4463pro.c,747 :: 		ucSPI2ByteReceived = 0;
MOVS	R1, #0
MOVW	R0, #lo_addr(_ucSPI2ByteReceived+0)
MOVT	R0, #hi_addr(_ucSPI2ByteReceived+0)
STRB	R1, [R0, #0]
;driverrf4463pro.c,749 :: 		SPI2_DR = ucData;
LDR	R1, [SP, #4]
UXTB	R1, R1
MOVW	R0, #lo_addr(SPI2_DR+0)
MOVT	R0, #hi_addr(SPI2_DR+0)
STR	R1, [R0, #0]
;driverrf4463pro.c,751 :: 		while ( !SPI2_SRbits.TXE );                // espera a que el buffer este vacio
...
;driverrf4463pro.c,753 :: 		while ( SPI2_SRbits.BSY );                // espera a que el buffer este vacio
...
;driverrf4463pro.c,755 :: 		return ( ucSPI2ByteReceived );
MOVW	R0, #lo_addr(_ucSPI2ByteReceived+0)
MOVT	R0, #hi_addr(_ucSPI2ByteReceived+0)
LDRB	R0, [R0, #0]
;driverrf4463pro.c,757 :: 		}
L_end_ucRf4463SPIByte:
POP	(R15)
; end of _ucRf4463SPIByte
_spi_write:
;driverrf4463pro.c,762 :: 		void spi_write( unsigned char tx_length, unsigned char *p ) {
PUSH	(R14)
SUB	SP, SP, #8
;driverrf4463pro.c,765 :: 		i = 0;
MOVS	R0, #0
STR	R0, [SP, #0]
;driverrf4463pro.c,766 :: 		while ( i != 0xFF ) {
L_spi_write116:
LDR	R0, [SP, #0]
UXTB	R0, R0
CMP	R0, #255
IT	EQ
BLEQ	L_spi_write117
;driverrf4463pro.c,767 :: 		i = check_cts();
BL	_check_cts+0
STR	R0, [SP, #0]
...
BLAL	L_spi_write116
L_spi_write117:
;driverrf4463pro.c,770 :: 		nSEL = 0;                              // habilita escritura
...
;driverrf4463pro.c,772 :: 		for ( i = 0; i < tx_length; i++ ) {
MOVS	R0, #0
STR	R0, [SP, #0]
L_spi_write118:
LDR	R1, [SP, #12]
...
LDRB	R0, [R0, #0]
STR	R0, [SP, #4]
;driverrf4463pro.c,774 :: 		ucRf4463SPIByte( j );
LDR	R0, [SP, #4]
UXTB	R0, R0
PUSH	(R0)
...
ADDS	R0, #1
STR	R0, [SP, #0]
;driverrf4463pro.c,775 :: 		}
IT	AL
BLAL	L_spi_write118
L_spi_write119:
;driverrf4463pro.c,777 :: 		nSEL = 1;                              // desabilita escritura
MOVW	R2, #lo_addr(GPIOB_ODR+0)
MOVT	R2, #hi_addr(GPIOB_ODR+0)
_LX	[R2, ByteOffset(GPIOB_ODR+0)]
MOVS	R1, #1
...
; end of _spi_write
_check_cts:
;driverrf4463pro.c,783 :: 		unsigned char check_cts( void ) {           // This Command follows the Command and reads the response
PUSH	(R14)
SUB	SP, SP, #4
;driverrf4463pro.c,786 :: 		nSEL = 1;
MOVW	R2, #lo_addr(GPIOB_ODR+0)
MOVT	R2, #hi_addr(GPIOB_ODR+0)
_LX	[R2, ByteOffset(GPIOB_ODR+0)]
MOVS	R1, #1
...
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOB_ODR+0)]
;driverrf4463pro.c,788 :: 		ucRf4463SPIByte( 0x44 );
MOVS	R0, #68
PUSH	(R0)
BL	_ucRf4463SPIByte+0
ADD	SP, SP, #4
;driverrf4463pro.c,789 :: 		i = ucRf4463SPIByte( 0 );
MOVS	R0, #0
PUSH	(R0)
BL	_ucRf4463SPIByte+0
ADD	SP, SP, #4
...
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOB_ODR+0)]
;driverrf4463pro.c,791 :: 		return ( i );
LDR	R0, [SP, #0]
UXTB	R0, R0
;driverrf4463pro.c,792 :: 		}
L_end_check_cts:
ADD	SP, SP, #4
POP	(R15)
; end of _check_cts
_spi_read:
;driverrf4463pro.c,797 :: 		void spi_read( unsigned char data_length, unsigned char api_command ) {
PUSH	(R14)
SUB	SP, SP, #12
;driverrf4463pro.c,801 :: 		p[ 0 ] = api_command;
MOVS	R0, #4
ADD	R0, SP, R0
ADDS	R1, R0, #0
LDR	R0, [SP, #20]
UXTB	R0, R0
STRB	R0, [R1, #0]
;driverrf4463pro.c,802 :: 		i = 0;
MOVS	R0, #0
STR	R0, [SP, #0]
;driverrf4463pro.c,803 :: 		while ( i != 0xFF ) {
L_spi_read121:
LDR	R0, [SP, #0]
UXTB	R0, R0
CMP	R0, #255
IT	EQ
BLEQ	L_spi_read122
;driverrf4463pro.c,804 :: 		i = check_cts();                // Check if you can send Command
BL	_check_cts+0
STR	R0, [SP, #0]
;driverrf4463pro.c,805 :: 		}
IT	AL
BLAL	L_spi_read121
L_spi_read122:
;driverrf4463pro.c,807 :: 		spi_write( 1, p );    // Send Command
MOVS	R0, #4
ADD	R0, SP, R0
PUSH	(R0)
MOVS	R0, #1
...
BL	_spi_write+0
ADD	SP, SP, #8
;driverrf4463pro.c,809 :: 		i = 0;
MOVS	R0, #0
STR	R0, [SP, #0]
;driverrf4463pro.c,810 :: 		while ( i != 0xFF ) {
L_spi_read123:
LDR	R0, [SP, #0]
UXTB	R0, R0
CMP	R0, #255
IT	EQ
BLEQ	L_spi_read124
;driverrf4463pro.c,811 :: 		i = check_cts();        //Check whether the data can be read
BL	_check_cts+0
STR	R0, [SP, #0]
;driverrf4463pro.c,812 :: 		}
IT	AL
BLAL	L_spi_read123
L_spi_read124:
;driverrf4463pro.c,814 :: 		nSEL = 1;
MOVW	R2, #lo_addr(GPIOB_ODR+0)
MOVT	R2, #hi_addr(GPIOB_ODR+0)
_LX	[R2, ByteOffset(GPIOB_ODR+0)]
MOVS	R1, #1
...
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOB_ODR+0)]
;driverrf4463pro.c,816 :: 		ucRf4463SPIByte( 0x44 );
MOVS	R0, #68
PUSH	(R0)
BL	_ucRf4463SPIByte+0
ADD	SP, SP, #4
;driverrf4463pro.c,817 :: 		for ( i = 0; i < data_length; i++ ) {        // Read data
MOVS	R0, #0
STR	R0, [SP, #0]
L_spi_read125:
LDR	R1, [SP, #16]
...
IT	CS
BLCS	L_spi_read126
;driverrf4463pro.c,818 :: 		spi_read_buf[ i ] = ucRf4463SPIByte( 0x00 );             // 0x00
LDR	R1, [SP, #0]
UXTB	R1, R1
...
LDR	R1, [SP, #8]
STRB	R0, [R1, #0]
;driverrf4463pro.c,819 :: 		Delay_ms(1);
LDR	R7, [PC, #5332]
NOP
L_spi_read128:
SUBS	R7, R7, #1
...
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOB_ODR+0)]
;driverrf4463pro.c,822 :: 		}
L_end_spi_read:
ADD	SP, SP, #12
POP	(R15)
; end of _spi_read
_spi_fast_read:
;driverrf4463pro.c,827 :: 		void spi_fast_read( unsigned char api_command ) {
PUSH	(R14)
SUB	SP, SP, #12
;driverrf4463pro.c,830 :: 		p[0] = api_command;
MOVS	R0, #4
ADD	R0, SP, R0
ADDS	R1, R0, #0
LDR	R0, [SP, #16]
UXTB	R0, R0
STRB	R0, [R1, #0]
;driverrf4463pro.c,831 :: 		i = 0;
MOVS	R0, #0
STR	R0, [SP, #0]
;driverrf4463pro.c,832 :: 		while ( i != 0xFF ) {
L_spi_fast_read130:
LDR	R0, [SP, #0]
UXTB	R0, R0
CMP	R0, #255
...
;driverrf4463pro.c,833 :: 		i = check_cts();                // Check if you can send Command
BL	_check_cts+0
STR	R0, [SP, #0]
...
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOB_ODR+0)]
;driverrf4463pro.c,838 :: 		ucRf4463SPIByte( api_command );    // Send Command
LDR	R0, [SP, #16]
UXTB	R0, R0
PUSH	(R0)
BL	_ucRf4463SPIByte+0
ADD	SP, SP, #4
;driverrf4463pro.c,839 :: 		for ( i = 0; i < 4; i++ ) {
MOVS	R0, #0
STR	R0, [SP, #0]
L_spi_fast_read132:
LDR	R0, [SP, #0]
...
;driverrf4463pro.c,840 :: 		spi_read_buf[ i ] = ucRf4463SPIByte( 0xFF );   // Read out all the 4 registers Value of
LDR	R1, [SP, #0]
UXTB	R1, R1
MOVW	R0, #lo_addr(_spi_read_buf+0)
MOVT	R0, #hi_addr(_spi_read_buf+0)
...
_spi_write_fifo:
;driverrf4463pro.c,848 :: 		void spi_write_fifo( void ) {
PUSH	(R14)
SUB	SP, SP, #4
;driverrf4463pro.c,851 :: 		i = 0;
MOVS	R0, #0
STR	R0, [SP, #0]
;driverrf4463pro.c,852 :: 		while ( i != 0xFF ) {
L_spi_write_fifo135:
LDR	R0, [SP, #0]
UXTB	R0, R0
CMP	R0, #255
...
;driverrf4463pro.c,853 :: 		i = check_cts();                // Check if you can send Command
BL	_check_cts+0
STR	R0, [SP, #0]
;driverrf4463pro.c,854 :: 		}
IT	AL
BLAL	L_spi_write_fifo135
L_spi_write_fifo136:
;driverrf4463pro.c,856 :: 		nSEL = 1;
MOVW	R2, #lo_addr(GPIOB_ODR+0)
MOVT	R2, #hi_addr(GPIOB_ODR+0)
_LX	[R2, ByteOffset(GPIOB_ODR+0)]
MOVS	R1, #1
...
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOB_ODR+0)]
;driverrf4463pro.c,858 :: 		ucRf4463SPIByte( WRITE_TX_FIFO );
MOVS	R0, #102
PUSH	(R0)
BL	_ucRf4463SPIByte+0
ADD	SP, SP, #4
;driverrf4463pro.c,860 :: 		if ( ucRF4463Mode == tx_test_mode) {
MOVW	R0, #lo_addr(_ucRF4463Mode+0)
MOVT	R0, #hi_addr(_ucRF4463Mode+0)
LDRB	R0, [R0, #0]
CMP	R0, #2
...
;driverrf4463pro.c,861 :: 		for ( i = 0; i < payload_length; i++ ) {
MOVS	R0, #0
STR	R0, [SP, #0]
L_spi_write_fifo138:
LDR	R0, [SP, #0]
...
;driverrf4463pro.c,862 :: 		ucRf4463SPIByte( tx_test_aa_data[ i ] );   // Send 10 test data
LDR	R1, [SP, #0]
UXTB	R1, R1
...
;driverrf4463pro.c,867 :: 		ucRf4463SPIByte( ucRF4463TXdata[ i ] );
LDR	R1, [SP, #0]
UXTB	R1, R1
...
_spi_read_fifo:
;driverrf4463pro.c,876 :: 		void spi_read_fifo( void ) {
PUSH	(R14)
SUB	SP, SP, #8
;driverrf4463pro.c,879 :: 		i = 0;
MOVS	R0, #0
STR	R0, [SP, #0]
;driverrf4463pro.c,880 :: 		while ( i != 0xFF ) {
L_spi_read_fifo145:
LDR	R0, [SP, #0]
UXTB	R0, R0
CMP	R0, #255
...
;driverrf4463pro.c,881 :: 		i = check_cts();                   // Check if you can send Command
BL	_check_cts+0
STR	R0, [SP, #0]
...
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOB_ODR+0)]
;driverrf4463pro.c,886 :: 		ucRf4463SPIByte( READ_RX_FIFO );
MOVS	R0, #119
PUSH	(R0)
BL	_ucRf4463SPIByte+0
ADD	SP, SP, #4
;driverrf4463pro.c,887 :: 		for ( i = 0; i < payload_length; i++ ) {
MOVS	R0, #0
STR	R0, [SP, #0]
L_spi_read_fifo147:
LDR	R0, [SP, #0]
...
;driverrf4463pro.c,888 :: 		rx_buf[ i ] = ucRf4463SPIByte( 0xFF );      // Receive 10 test data
LDR	R1, [SP, #0]
UXTB	R1, R1
...
_VRF4463SDNReset:
;driverrf4463pro.c,896 :: 		void VRF4463SDNReset( void ) {
PUSH	(R14)
SUB	SP, SP, #4
;driverrf4463pro.c,899 :: 		SDN = 1;
MOVW	R2, #lo_addr(GPIOH_ODR+0)
MOVT	R2, #hi_addr(GPIOH_ODR+0)
_LX	[R2, ByteOffset(GPIOH_ODR+0)]
MOVS	R1, #2
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOH_ODR+0)]
;driverrf4463pro.c,900 :: 		Delay_ms( 6 );        // RF Module reset  DELAY
LDR	R7, [PC, #31998]
NOP
...
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOH_ODR+0)]
;driverrf4463pro.c,902 :: 		Delay_ms( 10 );       // Delay 10ms for RF module to enter working state
LDR	R7, [PC, #53332]
NOP
...
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOB_ODR+0)]
;driverrf4463pro.c,906 :: 		for ( i = 0; i < 7; i++ ) {
MOVS	R0, #0
STR	R0, [SP, #0]
...
;driverrf4463pro.c,907 :: 		ucRf4463SPIByte( RF_POWER_UP_data[ i ] );   // send power up Command
LDR	R1, [SP, #0]
UXTB	R1, R1
...
PUSH	(R14)
;uarthandler.c,115 :: 		Level1Led =~ Level1Led;
MOVW	R0, #lo_addr(GPIOA_ODR+0)
MOVT	R0, #hi_addr(GPIOA_ODR+0)
_LX	[R0, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #128
...
L__vUARTISR469:
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;uarthandler.c,117 :: 		if( USART1_ISRbits.RXNE ){
...
IT	EQ
BLEQ	L_vUARTISR187
;uarthandler.c,118 :: 		ucData1 = USART1_RDR;
...
STRB	R1, [R0, #0]
;uarthandler.c,119 :: 		if ( ucData1 != CHR_CR && ucData1 != CHR_LF && ulUSART1ByteReceived < BUFFER_MAX_USART ) {
MOVW	R0, #lo_addr(_ucData1+0)
MOVT	R0, #hi_addr(_ucData1+0)
LDRB	R0, [R0, #0]
CMP	R0, #13
...
BLCS	L_vUARTISR190
L__vUARTISR401:
;uarthandler.c,122 :: 		ucData1 == CHR_s ||
MOVW	R0, #lo_addr(_ucData1+0)
MOVT	R0, #hi_addr(_ucData1+0)
LDRB	R0, [R0, #0]
CMP	R0, #83
...
IT	AL
BLAL	L_vUARTISR195
;uarthandler.c,125 :: 		ulUSART1ByteReceived == 0 ) {
L__vUARTISR400:
MOVW	R0, #lo_addr(_ulUSART1ByteReceived+0)
MOVT	R0, #hi_addr(_ulUSART1ByteReceived+0)
LDR	R0, [R0, #0]
...
BLNE	L_vUARTISR195
L__vUARTISR399:
;uarthandler.c,126 :: 		ucUSART1RXBuffer[ ulUSART1ByteReceived++ ] = ucData1;
MOVW	R0, #lo_addr(_ulUSART1ByteReceived+0)
MOVT	R0, #hi_addr(_ulUSART1ByteReceived+0)
LDR	R1, [R0, #0]
...
BLAL	L_vUARTISR196
L_vUARTISR195:
;uarthandler.c,130 :: 		ucUSART1RXBuffer[ 0 ] == CHR_s ||
MOVW	R0, #lo_addr(_ucUSART1RXBuffer+0)
MOVT	R0, #hi_addr(_ucUSART1RXBuffer+0)
LDRB	R0, [R0, #0]
CMP	R0, #83
...
BLAL	L_vUARTISR199
L__vUARTISR398:
;uarthandler.c,133 :: 		ucUSART1RXBuffer[ ulUSART1ByteReceived++ ] = ucData1;
MOVW	R0, #lo_addr(_ulUSART1ByteReceived+0)
MOVT	R0, #hi_addr(_ulUSART1ByteReceived+0)
LDR	R1, [R0, #0]
MOVW	R0, #lo_addr(_ucUSART1RXBuffer+0)
...
BLAL	L_vUARTISR200
L_vUARTISR190:
;uarthandler.c,137 :: 		else if ( ucData1 == CHR_CR ) {
MOVW	R0, #lo_addr(_ucData1+0)
MOVT	R0, #hi_addr(_ucData1+0)
LDRB	R0, [R0, #0]
CMP	R0, #13
IT	NE
BLNE	L_vUARTISR201
;uarthandler.c,138 :: 		ucUSART1RXBuffer[ ulUSART1ByteReceived++ ] = ucData1;
MOVW	R0, #lo_addr(_ulUSART1ByteReceived+0)
MOVT	R0, #hi_addr(_ulUSART1ByteReceived+0)
LDR	R1, [R0, #0]
MOVW	R0, #lo_addr(_ucUSART1RXBuffer+0)
...
BLAL	L_vUARTISR202
L_vUARTISR201:
;uarthandler.c,141 :: 		else if ( ucData1 == CHR_LF && ucUSART1RXBuffer[ ulUSART1ByteReceived - 1 ] == CHR_CR ) {
MOVW	R0, #lo_addr(_ucData1+0)
MOVT	R0, #hi_addr(_ucData1+0)
LDRB	R0, [R0, #0]
CMP	R0, #10
...
BLNE	L_vUARTISR205
L__vUARTISR397:
;uarthandler.c,142 :: 		ucUSART1RXBuffer[ ulUSART1ByteReceived++ ] = ucData1;
MOVW	R0, #lo_addr(_ulUSART1ByteReceived+0)
MOVT	R0, #hi_addr(_ulUSART1ByteReceived+0)
LDR	R1, [R0, #0]
MOVW	R0, #lo_addr(_ucUSART1RXBuffer+0)
...
MOVT	R0, #hi_addr(_ulUSART1ByteReceived+0)
STR	R1, [R0, #0]
;uarthandler.c,143 :: 		fUSART1Buffer = READY_TO_READ;
MOVS	R1, #1
...
; end of _vUARTISR
_vUSARTConfigUSART1:
;uarthandler.c,152 :: 		void vUSARTConfigUSART1 ( unsigned long ulBaudRate ) {
PUSH	(R14)
;uarthandler.c,154 :: 		UART1_Init_Advanced( ulBaudRate, _UART_8_BIT_DATA, _UART_NOPARITY, _UART_ONE_STOPBIT, &_GPIO_MODULE_USART1_PA9_10 );
...
ADD	SP, SP, #4
;uarthandler.c,155 :: 		USART1_CR1bits.UE = 0;
...
;uarthandler.c,157 :: 		ulClk = Clock_MHz() * 1000000;         // paso extra para verificacion en depuracion
MOVW	R1, #9216
MOVT	R1, #244
MOVW	R0, #lo_addr(_ulClk+0)
MOVT	R0, #hi_addr(_ulClk+0)
STR	R1, [R0, #0]
;uarthandler.c,161 :: 		USART1_CR1bits.UE = 1;
MOVW	R2, #lo_addr(USART1_CR1bits+0)
MOVT	R2, #hi_addr(USART1_CR1bits+0)
_LX	[R2, ByteOffset(USART1_CR1bits+0)]
MOVS	R1, #1
...
_vUARTRxMessage:
;uarthandler.c,171 :: 		void vUARTRxMessage(){
PUSH	(R14)
SUB	SP, SP, #4
;uarthandler.c,172 :: 		unsigned int usCounter = 0;
MOV	R6, SP
MOVS	R5, #2
ADDS	R5, R5, R6
...
BL	___CC2DW+0
;uarthandler.c,184 :: 		usUARTMessageLength = 0;
MOVS	R1, #0
...
CMP	R1, R0
IT	EQ
BLEQ	L__vRF4463MainCommandProcessor413
LDR	R1, [SP, #508]
MOVW	R0, #868
MOVT	R0, #0
CMP	R1, R0
...
CMP	R0, #250
IT	EQ
BLEQ	L__vRF4463MainCommandProcessor411
LDR	R1, [SP, #508]
MOVS	R0, #255
ADDS	R0, #245
CMP	R1, R0
...
L__vRF4463MainCommandProcessor402:
...
B	#4
	#10666665
NOP
;DriverRF4463PROMain.c,501 :: 		GPIO_Digital_Output( &GPIOA_BASE, _GPIO_PINMASK_7 );
MOVS	R1, #128
MOVW	R0, #lo_addr(GPIOA_BASE+0)
MOVT	R0, #hi_addr(GPIOA_BASE+0)
BL	_GPIO_Digital_Output+0
;DriverRF4463PROMain.c,502 :: 		GPIO_Digital_Output( &GPIOA_BASE, _GPIO_PINMASK_6 );
MOVS	R1, #64
MOVW	R0, #lo_addr(GPIOA_BASE+0)
MOVT	R0, #hi_addr(GPIOA_BASE+0)
BL	_GPIO_Digital_Output+0
;DriverRF4463PROMain.c,503 :: 		GPIO_Digital_Output( &GPIOA_BASE, _GPIO_PINMASK_5 );
MOVS	R1, #32
MOVW	R0, #lo_addr(GPIOA_BASE+0)
MOVT	R0, #hi_addr(GPIOA_BASE+0)
BL	_GPIO_Digital_Output+0
;DriverRF4463PROMain.c,504 :: 		GPIO_Digital_Output( &GPIOA_BASE, _GPIO_PINMASK_4 );
MOVS	R1, #16
MOVW	R0, #lo_addr(GPIOA_BASE+0)
MOVT	R0, #hi_addr(GPIOA_BASE+0)
BL	_GPIO_Digital_Output+0
;DriverRF4463PROMain.c,505 :: 		GPIO_Digital_Output( &GPIOA_BASE, _GPIO_PINMASK_3 );
MOVS	R1, #8
MOVW	R0, #lo_addr(GPIOA_BASE+0)
MOVT	R0, #hi_addr(GPIOA_BASE+0)
BL	_GPIO_Digital_Output+0
;DriverRF4463PROMain.c,506 :: 		GPIO_Digital_Output( &GPIOA_BASE, _GPIO_PINMASK_2 );
MOVS	R1, #4
MOVW	R0, #lo_addr(GPIOA_BASE+0)
MOVT	R0, #hi_addr(GPIOA_BASE+0)
BL	_GPIO_Digital_Output+0
;DriverRF4463PROMain.c,507 :: 		GPIO_Digital_Output( &GPIOA_BASE, _GPIO_PINMASK_1 );
MOVS	R1, #2
MOVW	R0, #lo_addr(GPIOA_BASE+0)
MOVT	R0, #hi_addr(GPIOA_BASE+0)
BL	_GPIO_Digital_Output+0
;DriverRF4463PROMain.c,512 :: 		GPIO_Digital_Input( &GPIOH_BASE, _GPIO_PINMASK_0 );      //nIRQ
MOVS	R1, #1
MOVW	R0, #lo_addr(GPIOH_BASE+0)
MOVT	R0, #hi_addr(GPIOH_BASE+0)
BL	_GPIO_Digital_Input+0
;DriverRF4463PROMain.c,513 :: 		GPIO_Digital_Output( &GPIOH_BASE, _GPIO_PINMASK_1 );     //SDN
MOVS	R1, #2
MOVW	R0, #lo_addr(GPIOH_BASE+0)
MOVT	R0, #hi_addr(GPIOH_BASE+0)
BL	_GPIO_Digital_Output+0
;DriverRF4463PROMain.c,515 :: 		GPIO_Digital_Output( &GPIOB_BASE, _GPIO_PINMASK_12 );    // nSel
MOVW	R1, #4096
MOVT	R1, #0
MOVW	R0, #lo_addr(GPIOB_BASE+0)
MOVT	R0, #hi_addr(GPIOB_BASE+0)
BL	_GPIO_Digital_Output+0
;DriverRF4463PROMain.c,531 :: 		RCC_APB2ENR.SYSCFGEN = 1;
...
;DriverRF4463PROMain.c,532 :: 		SYSCFG_EXTICR1  = 0x0005;
MOVS	R1, #5
MOVW	R0, #lo_addr(SYSCFG_EXTICR1+0)
MOVT	R0, #hi_addr(SYSCFG_EXTICR1+0)
STR	R1, [R0, #0]
;DriverRF4463PROMain.c,533 :: 		EXTI_IMR.B0     |= 1;
...
;DriverRF4463PROMain.c,534 :: 		EXTI_FTSR.B0    |= 1;
...
;DriverRF4463PROMain.c,536 :: 		nSEL = 1;
MOVW	R2, #lo_addr(GPIOB_ODR+0)
MOVT	R2, #hi_addr(GPIOB_ODR+0)
_LX	[R2, ByteOffset(GPIOB_ODR+0)]
MOVS	R1, #1
...
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOB_ODR+0)]
;DriverRF4463PROMain.c,538 :: 		Level1Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #128
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,539 :: 		Level7Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #2
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,543 :: 		InitTimer2();
BL	_InitTimer2+0
;DriverRF4463PROMain.c,544 :: 		NVIC_IntEnable( IVT_INT_EXTI0_1 );
MOVS	R0, #21
BL	_NVIC_IntEnable+0
;DriverRF4463PROMain.c,547 :: 		vUSARTConfigUSART1( 115200 );  // configura todos las parametros de USART
MOVW	R0, #49664
MOVT	R0, #1
PUSH	(R0)
BL	_vUSARTConfigUSART1+0
ADD	SP, SP, #4
;DriverRF4463PROMain.c,549 :: 		UART1_Write_Text("[ SYS STM32L072CB ] Start System\r\n");
MOVS	R6, #8
ADD	R6, SP, R6
MOVS	R5, #35
ADDS	R5, R5, R6
...
MOV	R0, R4
BL	_UART1_Write_Text+0
;DriverRF4463PROMain.c,551 :: 		vSPI2Init();           // configura todos los parametros de SPI
BL	_vSPI2Init+0
;DriverRF4463PROMain.c,556 :: 		ucRF4463Freq3 = 9;
MOVS	R1, #9
MOVW	R0, #lo_addr(_ucRF4463Freq3+0)
MOVT	R0, #hi_addr(_ucRF4463Freq3+0)
STRB	R1, [R0, #0]
;DriverRF4463PROMain.c,557 :: 		ucRF4463Freq2 = 1;
MOVS	R1, #1
MOVW	R0, #lo_addr(_ucRF4463Freq2+0)
MOVT	R0, #hi_addr(_ucRF4463Freq2+0)
STRB	R1, [R0, #0]
;DriverRF4463PROMain.c,558 :: 		ucRF4463Freq1 = 5;
MOVS	R1, #5
MOVW	R0, #lo_addr(_ucRF4463Freq1+0)
MOVT	R0, #hi_addr(_ucRF4463Freq1+0)
STRB	R1, [R0, #0]
;DriverRF4463PROMain.c,561 :: 		ucRF4463Power = 127;            // 34
MOVS	R1, #127
MOVW	R0, #lo_addr(_ucRF4463Power+0)
MOVT	R0, #hi_addr(_ucRF4463Power+0)
STRB	R1, [R0, #0]
;DriverRF4463PROMain.c,563 :: 		ucRF4463Rate  = dr_1p2;                // BAUDRATE
MOVS	R1, #0
MOVW	R0, #lo_addr(_ucRF4463Rate+0)
MOVT	R0, #hi_addr(_ucRF4463Rate+0)
STRB	R1, [R0, #0]
;DriverRF4463PROMain.c,565 :: 		ucRF4463Mode  = master_mode;          // para transmision continua usar: tx_test_mode
MOVS	R1, #0
MOVW	R0, #lo_addr(_ucRF4463Mode+0)
MOVT	R0, #hi_addr(_ucRF4463Mode+0)
STRB	R1, [R0, #0]
;DriverRF4463PROMain.c,567 :: 		ucRF4463FreqChannel = 1;
MOVS	R1, #1
MOVW	R0, #lo_addr(_ucRF4463FreqChannel+0)
MOVT	R0, #hi_addr(_ucRF4463FreqChannel+0)
STRB	R1, [R0, #0]
;DriverRF4463PROMain.c,571 :: 		reset_mode = 0;
MOVS	R1, #0
MOVW	R0, #lo_addr(_reset_mode+0)
MOVT	R0, #hi_addr(_reset_mode+0)
STRB	R1, [R0, #0]
;DriverRF4463PROMain.c,576 :: 		vRF4463MainSetTXString();    // usada para establecer el encabezdo predeterminado
BL	_vRF4463MainSetTXString+0
;DriverRF4463PROMain.c,577 :: 		VRF4463SDNReset();
BL	_VRF4463SDNReset+0
;DriverRF4463PROMain.c,578 :: 		vRF4463Init();
BL	_vRF4463Init+0
;DriverRF4463PROMain.c,579 :: 		vRF4463ClearInterrupts();
BL	_vRF4463ClearInterrupts+0
;DriverRF4463PROMain.c,580 :: 		vRF4463PartInfo ();          // SOLICITA EL MODELO DEL RADIO
BL	_vRF4463PartInfo+0
;DriverRF4463PROMain.c,587 :: 		UART1_Write_Text( "[ SYS STM32L072CB ] RF Radio ready\r\n" );
MOVS	R6, #44
ADD	R6, SP, R6
MOVS	R5, #37
ADDS	R5, R5, R6
...
MOV	R0, R4
BL	_UART1_Write_Text+0
;DriverRF4463PROMain.c,590 :: 		while ( 1 ) {
L_main327:
;DriverRF4463PROMain.c,593 :: 		if ( fUSART1Buffer == READY_TO_READ ) {
MOVW	R0, #lo_addr(_fUSART1Buffer+0)
MOVT	R0, #hi_addr(_fUSART1Buffer+0)
LDR	R0, [R0, #0]
CMP	R0, #1
...
L_main329:
;DriverRF4463PROMain.c,606 :: 		if ( ucRF4463Mode == master_mode ) {
MOVW	R0, #lo_addr(_ucRF4463Mode+0)
MOVT	R0, #hi_addr(_ucRF4463Mode+0)
LDRB	R0, [R0, #0]
CMP	R0, #0
IT	NE
BLNE	L_main330
;DriverRF4463PROMain.c,607 :: 		vRF4463TxData();
BL	_vRF4463TxData+0
;DriverRF4463PROMain.c,608 :: 		}
IT	AL
BLAL	L_main331
L_main330:
;DriverRF4463PROMain.c,611 :: 		else if ( ucRF4463Mode == slave_mode ) {
MOVW	R0, #lo_addr(_ucRF4463Mode+0)
MOVT	R0, #hi_addr(_ucRF4463Mode+0)
LDRB	R0, [R0, #0]
CMP	R0, #1
IT	NE
BLNE	L_main332
;DriverRF4463PROMain.c,612 :: 		vRF4463RxInit();
BL	_vRF4463RxInit+0
;DriverRF4463PROMain.c,613 :: 		}
IT	AL
BLAL	L_main333
L_main332:
;DriverRF4463PROMain.c,616 :: 		else if ( ucRF4463Mode == rf_off ) {
MOVW	R0, #lo_addr(_ucRF4463Mode+0)
MOVT	R0, #hi_addr(_ucRF4463Mode+0)
LDRB	R0, [R0, #0]
CMP	R0, #4
...
L_main333:
L_main331:
;DriverRF4463PROMain.c,621 :: 		if ( ucRF4463Mode == tx_test_mode ) {
MOVW	R0, #lo_addr(_ucRF4463Mode+0)
MOVT	R0, #hi_addr(_ucRF4463Mode+0)
LDRB	R0, [R0, #0]
CMP	R0, #2
IT	NE
BLNE	L_main335
;DriverRF4463PROMain.c,622 :: 		vRF4463TxCont();
BL	_vRF4463TxCont+0
;DriverRF4463PROMain.c,623 :: 		while ( 1 ) {
L_main336:
;DriverRF4463PROMain.c,625 :: 		if ( fUSART1Buffer == READY_TO_READ ) {
MOVW	R0, #lo_addr(_fUSART1Buffer+0)
MOVT	R0, #hi_addr(_fUSART1Buffer+0)
LDR	R0, [R0, #0]
CMP	R0, #1
IT	NE
BLNE	L_main338
;DriverRF4463PROMain.c,626 :: 		break;
IT	AL
BLAL	L_main337
;DriverRF4463PROMain.c,627 :: 		}
L_main338:
;DriverRF4463PROMain.c,629 :: 		if ( !nIRQ ) {
MOVW	R0, #lo_addr(GPIOH_IDR+0)
MOVT	R0, #hi_addr(GPIOH_IDR+0)
_LX	[R0, ByteOffset(GPIOH_IDR+0)]
MOVS	R0, #1
...
IT	NE
BLNE	L_main339
;DriverRF4463PROMain.c,630 :: 		vRF4463TxCont();
BL	_vRF4463TxCont+0
;DriverRF4463PROMain.c,631 :: 		}
L_main339:
;DriverRF4463PROMain.c,632 :: 		}
IT	AL
BLAL	L_main336
L_main337:
;DriverRF4463PROMain.c,633 :: 		}
L_main335:
;DriverRF4463PROMain.c,635 :: 		if ( ucRF4463Mode == rx_test_mode ) {
MOVW	R0, #lo_addr(_ucRF4463Mode+0)
MOVT	R0, #hi_addr(_ucRF4463Mode+0)
LDRB	R0, [R0, #0]
CMP	R0, #3
IT	NE
BLNE	L_main340
;DriverRF4463PROMain.c,636 :: 		vRF4463RxInit ();
BL	_vRF4463RxInit+0
;DriverRF4463PROMain.c,637 :: 		while ( 1 ) {
L_main341:
;DriverRF4463PROMain.c,639 :: 		if ( fUSART1Buffer == READY_TO_READ ) {
MOVW	R0, #lo_addr(_fUSART1Buffer+0)
MOVT	R0, #hi_addr(_fUSART1Buffer+0)
LDR	R0, [R0, #0]
CMP	R0, #1
IT	NE
BLNE	L_main343
;DriverRF4463PROMain.c,640 :: 		break;
IT	AL
BLAL	L_main342
...
L_main340:
;DriverRF4463PROMain.c,647 :: 		if ( reset_mode == 0 ) {
MOVW	R0, #lo_addr(_reset_mode+0)
MOVT	R0, #hi_addr(_reset_mode+0)
LDRB	R0, [R0, #0]
CMP	R0, #0
IT	NE
BLNE	L_main344
;DriverRF4463PROMain.c,649 :: 		while ( 1 ) {
L_main345:
;DriverRF4463PROMain.c,651 :: 		if ( fUSART1Buffer == READY_TO_READ ) {
MOVW	R0, #lo_addr(_fUSART1Buffer+0)
MOVT	R0, #hi_addr(_fUSART1Buffer+0)
LDR	R0, [R0, #0]
CMP	R0, #1
IT	NE
BLNE	L_main347
;DriverRF4463PROMain.c,652 :: 		break;
IT	AL
BLAL	L_main346
;DriverRF4463PROMain.c,653 :: 		}
L_main347:
;DriverRF4463PROMain.c,655 :: 		if ( Flag.reach_1s ) {
MOVW	R0, #lo_addr(_Flag+0)
MOVT	R0, #hi_addr(_Flag+0)
_LX	[R0, ByteOffset(_Flag+0)]
MOVS	R0, #1
...
IT	EQ
BLEQ	L_main348
;DriverRF4463PROMain.c,656 :: 		Flag.reach_1s = 0;
MOVW	R2, #lo_addr(_Flag+0)
MOVT	R2, #hi_addr(_Flag+0)
_LX	[R2, ByteOffset(_Flag+0)]
MOVS	R1, #1
BICS	R0, R1
_SX	[R2, ByteOffset(_Flag+0)]
;DriverRF4463PROMain.c,657 :: 		if ( ucRF4463Mode == master_mode ) {
MOVW	R0, #lo_addr(_ucRF4463Mode+0)
MOVT	R0, #hi_addr(_ucRF4463Mode+0)
LDRB	R0, [R0, #0]
CMP	R0, #0
IT	NE
BLNE	L_main349
;DriverRF4463PROMain.c,658 :: 		vRF4463TxData();
BL	_vRF4463TxData+0
;DriverRF4463PROMain.c,659 :: 		}
L_main349:
;DriverRF4463PROMain.c,660 :: 		}
L_main348:
;DriverRF4463PROMain.c,663 :: 		if ( !Flag.is_tx ) {
MOVW	R0, #lo_addr(_Flag+0)
MOVT	R0, #hi_addr(_Flag+0)
_LX	[R0, ByteOffset(_Flag+0)]
MOVS	R0, #2
...
IT	NE
BLNE	L_main350
;DriverRF4463PROMain.c,664 :: 		if ( !nIRQ ) {          // !nIRQ
MOVW	R0, #lo_addr(GPIOH_IDR+0)
MOVT	R0, #hi_addr(GPIOH_IDR+0)
_LX	[R0, ByteOffset(GPIOH_IDR+0)]
MOVS	R0, #1
...
IT	NE
BLNE	L_main351
;DriverRF4463PROMain.c,665 :: 		spi_read(9,0x22);  // aqui hay que leer  el RSSI
MOVS	R0, #34
PUSH	(R0)
MOVS	R0, #9
PUSH	(R0)
BL	_spi_read+0
ADD	SP, SP, #8
;DriverRF4463PROMain.c,666 :: 		iVal = ( float ) spi_read_buf[3];
...
STR	R1, [R0, #0]
;DriverRF4463PROMain.c,667 :: 		rssi = ((iVal / 2) - 64) -70;
MOVW	R0, #lo_addr(_iVal+0)
MOVT	R0, #hi_addr(_iVal+0)
LDR	R0, [R0, #0]
MOVW	R2, #0
...
STR	R0, [R1, #0]
;DriverRF4463PROMain.c,668 :: 		vRF4463ClearInterrupts();
BL	_vRF4463ClearInterrupts+0
;DriverRF4463PROMain.c,670 :: 		if ( ( spi_read_buf[ 4 ] & 0x08) == 0 ) { // crc error check
...
IT	NE
BLNE	L_main352
;DriverRF4463PROMain.c,674 :: 		spi_read_fifo();
BL	_spi_read_fifo+0
;DriverRF4463PROMain.c,675 :: 		vRF4463FifoReset();
BL	_vRF4463FifoReset+0
;DriverRF4463PROMain.c,677 :: 		chksum = 0;
MOVS	R0, #0
STR	R0, [SP, #4]
;DriverRF4463PROMain.c,678 :: 		for ( i = 4; i < payload_length - 1; i++ )                // Calculation Checksum
MOVS	R0, #4
STR	R0, [SP, #0]
L_main353:
LDR	R0, [SP, #0]
...
IT	GE
BLGE	L_main354
;DriverRF4463PROMain.c,679 :: 		chksum += rx_buf[ i ];
LDR	R1, [SP, #0]
UXTB	R1, R1
MOVW	R0, #lo_addr(_rx_buf+0)
MOVT	R0, #hi_addr(_rx_buf+0)
...
BLAL	L_main353
L_main354:
;DriverRF4463PROMain.c,681 :: 		if ( ( chksum == rx_buf[ payload_length - 1 ] )&&( rx_buf[ 4 ] == 0x41 )) {
...
BLNE	L_main358
L__main418:
;DriverRF4463PROMain.c,685 :: 		UART1_Write_Text( "[ Message ] = " );
MOVS	R6, #84
ADD	R6, SP, R6
MOVS	R5, #15
ADDS	R5, R5, R6
...
MOV	R0, R4
BL	_UART1_Write_Text+0
;DriverRF4463PROMain.c,686 :: 		UART1_Write_Text( rx_buf );
MOVW	R0, #lo_addr(_rx_buf+0)
MOVT	R0, #hi_addr(_rx_buf+0)
BL	_UART1_Write_Text+0
;DriverRF4463PROMain.c,687 :: 		UART1_Write_Text("\r\n");
MOVS	R6, #100
ADD	R6, SP, R6
MOVS	R5, #3
ADDS	R5, R5, R6
...
MOV	R0, R4
BL	_UART1_Write_Text+0
;DriverRF4463PROMain.c,690 :: 		rx_cnt++;
...
MOVT	R0, #hi_addr(_rx_cnt+0)
STR	R1, [R0, #0]
;DriverRF4463PROMain.c,691 :: 		getRSSI();
BL	_getRSSI+0
;DriverRF4463PROMain.c,696 :: 		}
IT	AL
BLAL	L_main359
L_main358:
;DriverRF4463PROMain.c,698 :: 		vRF4463RxInit();    // The received data is wrong, you must continue to receive
BL	_vRF4463RxInit+0
L_main359:
;DriverRF4463PROMain.c,699 :: 		}
IT	AL
BLAL	L_main360
L_main352:
;DriverRF4463PROMain.c,703 :: 		UART1_Write_Text( "[ CRC ] Fail\r\n" );
MOVS	R6, #104
ADD	R6, SP, R6
MOVS	R5, #15
ADDS	R5, R5, R6
...
MOV	R0, R4
BL	_UART1_Write_Text+0
;DriverRF4463PROMain.c,704 :: 		VRF4463SDNReset();
BL	_VRF4463SDNReset+0
;DriverRF4463PROMain.c,705 :: 		vRF4463Init();
BL	_vRF4463Init+0
;DriverRF4463PROMain.c,706 :: 		vRF4463RxInit();
BL	_vRF4463RxInit+0
;DriverRF4463PROMain.c,707 :: 		}
L_main360:
;DriverRF4463PROMain.c,708 :: 		}
L_main351:
;DriverRF4463PROMain.c,709 :: 		}
L_main350:
;DriverRF4463PROMain.c,710 :: 		}
IT	AL
BLAL	L_main345
L_main346:
;DriverRF4463PROMain.c,711 :: 		}
L_main344:
;DriverRF4463PROMain.c,712 :: 		}
IT	AL
BLAL	L_main327
...
; end of _main
_getRSSI:
;DriverRF4463PROMain.c,715 :: 		void getRSSI()
PUSH	(R14)
SUB	SP, SP, #180
;DriverRF4463PROMain.c,717 :: 		ShortToStr(rssi,Value );
...
SXTB	R0, R4
BL	_ShortToStr+0
;DriverRF4463PROMain.c,718 :: 		UART1_Write_Text("[ RSSI ] = ");
MOV	R6, SP
MOVS	R5, #12
ADDS	R5, R5, R6
...
MOV	R0, R4
BL	_UART1_Write_Text+0
;DriverRF4463PROMain.c,719 :: 		UART1_Write_Text( Value );
MOVW	R0, #lo_addr(_Value+0)
MOVT	R0, #hi_addr(_Value+0)
BL	_UART1_Write_Text+0
;DriverRF4463PROMain.c,720 :: 		UART1_Write_Text(" dBm\r\n");
MOVS	R6, #12
ADD	R6, SP, R6
MOVS	R5, #7
ADDS	R5, R5, R6
...
MOV	R0, R4
BL	_UART1_Write_Text+0
;DriverRF4463PROMain.c,721 :: 		newValueRssi = rssi;
MOVW	R0, #lo_addr(_rssi+0)
MOVT	R0, #hi_addr(_rssi+0)
LDR	R0, [R0, #0]
BL	__FloatToUnsignedIntegral+0
UXTB	R0, R0
MOVW	R1, #lo_addr(_newValueRssi+0)
MOVT	R1, #hi_addr(_newValueRssi+0)
STRB	R0, [R1, #0]
;DriverRF4463PROMain.c,723 :: 		if( (newValueRssi >= 0 ) && ( newValueRssi <= 15 )  )
MOVW	R0, #lo_addr(_newValueRssi+0)
MOVT	R0, #hi_addr(_newValueRssi+0)
LDRB	R0, [R0, #0]
CMP	R0, #0
IT	CC
BLCC	L_getRSSI363
...
BLHI	L_getRSSI363
L__getRSSI426:
;DriverRF4463PROMain.c,725 :: 		UART1_Write_Text("[ Level 1 ]\r\n");
MOVS	R6, #20
ADD	R6, SP, R6
MOVS	R5, #14
ADDS	R5, R5, R6
MOVW	R7, #lo_addr(?ICS?lstr25_DriverRF4463PROMain+0)
MOVT	R7, #hi_addr(?ICS?lstr25_DriverRF4463PROMain+0)
BL	___CC2DW+0
MOVS	R0, #20
ADD	R0, SP, R0
MOV	R4, R0
MOV	R0, R4
BL	_UART1_Write_Text+0
;DriverRF4463PROMain.c,726 :: 		Level1Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #128
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,727 :: 		Level2Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #64
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,728 :: 		Level3Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #32
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,729 :: 		Level4Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #16
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,730 :: 		Level5Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #8
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,731 :: 		Level6Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #4
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,732 :: 		Level7Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #2
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,733 :: 		}
IT	AL
BLAL	L_getRSSI364
L_getRSSI363:
;DriverRF4463PROMain.c,734 :: 		else if( (newValueRssi >= 15 ) && ( newValueRssi <= 28 )  )
MOVW	R0, #lo_addr(_newValueRssi+0)
MOVT	R0, #hi_addr(_newValueRssi+0)
LDRB	R0, [R0, #0]
CMP	R0, #15
...
BLHI	L_getRSSI367
L__getRSSI425:
;DriverRF4463PROMain.c,736 :: 		UART1_Write_Text("[ Level 2 ]\r\n");
MOVS	R6, #36
ADD	R6, SP, R6
MOVS	R5, #14
ADDS	R5, R5, R6
MOVW	R7, #lo_addr(?ICS?lstr26_DriverRF4463PROMain+0)
MOVT	R7, #hi_addr(?ICS?lstr26_DriverRF4463PROMain+0)
BL	___CC2DW+0
MOVS	R0, #36
ADD	R0, SP, R0
MOV	R4, R0
MOV	R0, R4
BL	_UART1_Write_Text+0
;DriverRF4463PROMain.c,737 :: 		Level1Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #128
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,738 :: 		Level2Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #64
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,739 :: 		Level3Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #32
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,740 :: 		Level4Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #16
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,741 :: 		Level5Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #8
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,742 :: 		Level6Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #4
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,743 :: 		Level7Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #2
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,744 :: 		}
IT	AL
BLAL	L_getRSSI368
L_getRSSI367:
;DriverRF4463PROMain.c,745 :: 		else if( (newValueRssi >= 28 ) && ( newValueRssi <= 43 )  )
MOVW	R0, #lo_addr(_newValueRssi+0)
MOVT	R0, #hi_addr(_newValueRssi+0)
LDRB	R0, [R0, #0]
CMP	R0, #28
...
BLHI	L_getRSSI371
L__getRSSI424:
;DriverRF4463PROMain.c,747 :: 		UART1_Write_Text("[ Level 3 ]\r\n");
MOVS	R6, #52
ADD	R6, SP, R6
MOVS	R5, #14
ADDS	R5, R5, R6
MOVW	R7, #lo_addr(?ICS?lstr27_DriverRF4463PROMain+0)
MOVT	R7, #hi_addr(?ICS?lstr27_DriverRF4463PROMain+0)
BL	___CC2DW+0
MOVS	R0, #52
ADD	R0, SP, R0
MOV	R4, R0
MOV	R0, R4
BL	_UART1_Write_Text+0
;DriverRF4463PROMain.c,748 :: 		Level1Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #128
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,749 :: 		Level2Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #64
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,750 :: 		Level3Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #32
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,751 :: 		Level4Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #16
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,752 :: 		Level5Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #8
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,753 :: 		Level6Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #4
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,754 :: 		Level7Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #2
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,755 :: 		}
IT	AL
BLAL	L_getRSSI372
L_getRSSI371:
;DriverRF4463PROMain.c,756 :: 		else if( (newValueRssi >= 43 ) && ( newValueRssi <= 58 )  )
MOVW	R0, #lo_addr(_newValueRssi+0)
MOVT	R0, #hi_addr(_newValueRssi+0)
LDRB	R0, [R0, #0]
CMP	R0, #43
...
BLHI	L_getRSSI375
L__getRSSI423:
;DriverRF4463PROMain.c,758 :: 		UART1_Write_Text("[ Level 4 ]\r\n");
MOVS	R6, #68
ADD	R6, SP, R6
MOVS	R5, #14
ADDS	R5, R5, R6
MOVW	R7, #lo_addr(?ICS?lstr28_DriverRF4463PROMain+0)
MOVT	R7, #hi_addr(?ICS?lstr28_DriverRF4463PROMain+0)
BL	___CC2DW+0
MOVS	R0, #68
ADD	R0, SP, R0
MOV	R4, R0
MOV	R0, R4
BL	_UART1_Write_Text+0
;DriverRF4463PROMain.c,759 :: 		Level1Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #128
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,760 :: 		Level2Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #64
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,761 :: 		Level3Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #32
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,762 :: 		Level4Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #16
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,763 :: 		Level5Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #8
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,764 :: 		Level6Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #4
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,765 :: 		Level7Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #2
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,766 :: 		}
IT	AL
BLAL	L_getRSSI376
L_getRSSI375:
;DriverRF4463PROMain.c,767 :: 		else if( (newValueRssi >= 58 ) && ( newValueRssi <= 73 )  )
MOVW	R0, #lo_addr(_newValueRssi+0)
MOVT	R0, #hi_addr(_newValueRssi+0)
LDRB	R0, [R0, #0]
CMP	R0, #58
...
BLHI	L_getRSSI379
L__getRSSI422:
;DriverRF4463PROMain.c,769 :: 		UART1_Write_Text("[ Level 5 ]\r\n");
MOVS	R6, #84
ADD	R6, SP, R6
MOVS	R5, #14
ADDS	R5, R5, R6
MOVW	R7, #lo_addr(?ICS?lstr29_DriverRF4463PROMain+0)
MOVT	R7, #hi_addr(?ICS?lstr29_DriverRF4463PROMain+0)
BL	___CC2DW+0
MOVS	R0, #84
ADD	R0, SP, R0
MOV	R4, R0
MOV	R0, R4
BL	_UART1_Write_Text+0
;DriverRF4463PROMain.c,770 :: 		Level1Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #128
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,771 :: 		Level2Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #64
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,772 :: 		Level3Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #32
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,773 :: 		Level4Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #16
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,774 :: 		Level5Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #8
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,775 :: 		Level6Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #4
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,776 :: 		Level7Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #2
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,777 :: 		}
IT	AL
BLAL	L_getRSSI380
L_getRSSI379:
;DriverRF4463PROMain.c,778 :: 		else if( (newValueRssi >= 73 ) && ( newValueRssi <= 88 )  )
MOVW	R0, #lo_addr(_newValueRssi+0)
MOVT	R0, #hi_addr(_newValueRssi+0)
LDRB	R0, [R0, #0]
CMP	R0, #73
...
BLHI	L_getRSSI383
L__getRSSI421:
;DriverRF4463PROMain.c,780 :: 		UART1_Write_Text("[ Level 6 ]\r\n");
MOVS	R6, #100
ADD	R6, SP, R6
MOVS	R5, #14
ADDS	R5, R5, R6
MOVW	R7, #lo_addr(?ICS?lstr30_DriverRF4463PROMain+0)
MOVT	R7, #hi_addr(?ICS?lstr30_DriverRF4463PROMain+0)
BL	___CC2DW+0
MOVS	R0, #100
ADD	R0, SP, R0
MOV	R4, R0
MOV	R0, R4
BL	_UART1_Write_Text+0
;DriverRF4463PROMain.c,781 :: 		Level1Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #128
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,782 :: 		Level2Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #64
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,783 :: 		Level3Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #32
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,784 :: 		Level4Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #16
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,785 :: 		Level5Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #8
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,786 :: 		Level6Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #4
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,787 :: 		Level7Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #2
...
BLAL	L_getRSSI384
L_getRSSI383:
;DriverRF4463PROMain.c,789 :: 		else if( (newValueRssi >= 88 ) && ( newValueRssi <= 103 )  )
MOVW	R0, #lo_addr(_newValueRssi+0)
MOVT	R0, #hi_addr(_newValueRssi+0)
LDRB	R0, [R0, #0]
CMP	R0, #88
...
BLHI	L_getRSSI387
L__getRSSI420:
;DriverRF4463PROMain.c,791 :: 		UART1_Write_Text("[ Level 7 ]\r\n");
MOVS	R6, #116
ADD	R6, SP, R6
MOVS	R5, #14
ADDS	R5, R5, R6
MOVW	R7, #lo_addr(?ICS?lstr31_DriverRF4463PROMain+0)
MOVT	R7, #hi_addr(?ICS?lstr31_DriverRF4463PROMain+0)
BL	___CC2DW+0
MOVS	R0, #116
ADD	R0, SP, R0
MOV	R4, R0
MOV	R0, R4
BL	_UART1_Write_Text+0
;DriverRF4463PROMain.c,792 :: 		Level1Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #128
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,793 :: 		Level2Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #64
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,794 :: 		Level3Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #32
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,795 :: 		Level4Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #16
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,796 :: 		Level5Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #8
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,797 :: 		Level6Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #4
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,798 :: 		Level7Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #2
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,799 :: 		}
IT	AL
BLAL	L_getRSSI388
L_getRSSI387:
;DriverRF4463PROMain.c,800 :: 		else if( (newValueRssi >= 103 ) && ( newValueRssi <= 118 )  )
MOVW	R0, #lo_addr(_newValueRssi+0)
MOVT	R0, #hi_addr(_newValueRssi+0)
LDRB	R0, [R0, #0]
CMP	R0, #103
...
BLHI	L_getRSSI391
L__getRSSI419:
;DriverRF4463PROMain.c,802 :: 		UART1_Write_Text("[ Level 8 ]\r\n");
MOVS	R6, #132
ADD	R6, SP, R6
MOVS	R5, #14
ADDS	R5, R5, R6
MOVW	R7, #lo_addr(?ICS?lstr32_DriverRF4463PROMain+0)
MOVT	R7, #hi_addr(?ICS?lstr32_DriverRF4463PROMain+0)
BL	___CC2DW+0
MOVS	R0, #132
ADD	R0, SP, R0
MOV	R4, R0
MOV	R0, R4
BL	_UART1_Write_Text+0
;DriverRF4463PROMain.c,803 :: 		Level1Led = 1;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #128
ORRS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,804 :: 		Level2Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #64
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,805 :: 		Level3Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #32
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,806 :: 		Level4Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #16
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,807 :: 		Level5Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #8
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,808 :: 		Level6Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #4
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,809 :: 		Level7Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #2
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,810 :: 		}
IT	AL
BLAL	L_getRSSI392
L_getRSSI391:
;DriverRF4463PROMain.c,811 :: 		else if( newValueRssi >= 118   )
MOVW	R0, #lo_addr(_newValueRssi+0)
MOVT	R0, #hi_addr(_newValueRssi+0)
LDRB	R0, [R0, #0]
CMP	R0, #118
IT	CC
BLCC	L_getRSSI393
;DriverRF4463PROMain.c,813 :: 		UART1_Write_Text("[ Level 9 ]\r\n");
MOVS	R6, #148
ADD	R6, SP, R6
MOVS	R5, #14
ADDS	R5, R5, R6
MOVW	R7, #lo_addr(?ICS?lstr33_DriverRF4463PROMain+0)
MOVT	R7, #hi_addr(?ICS?lstr33_DriverRF4463PROMain+0)
BL	___CC2DW+0
MOVS	R0, #148
ADD	R0, SP, R0
MOV	R4, R0
MOV	R0, R4
BL	_UART1_Write_Text+0
;DriverRF4463PROMain.c,814 :: 		Level1Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #128
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,815 :: 		Level2Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #64
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,816 :: 		Level3Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #32
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,817 :: 		Level4Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #16
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,818 :: 		Level5Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #8
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,819 :: 		Level6Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #4
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,820 :: 		Level7Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #2
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,821 :: 		}
IT	AL
BLAL	L_getRSSI394
L_getRSSI393:
;DriverRF4463PROMain.c,824 :: 		UART1_Write_Text("[ No Level ]\r\n");
MOVS	R6, #164
ADD	R6, SP, R6
MOVS	R5, #15
ADDS	R5, R5, R6
MOVW	R7, #lo_addr(?ICS?lstr34_DriverRF4463PROMain+0)
MOVT	R7, #hi_addr(?ICS?lstr34_DriverRF4463PROMain+0)
BL	___CC2DW+0
MOVS	R0, #164
ADD	R0, SP, R0
MOV	R4, R0
MOV	R0, R4
BL	_UART1_Write_Text+0
;DriverRF4463PROMain.c,825 :: 		Level1Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #128
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,826 :: 		Level2Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #64
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,827 :: 		Level3Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #32
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,828 :: 		Level4Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #16
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,829 :: 		Level5Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #8
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,830 :: 		Level6Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #4
BICS	R0, R1
_SX	[R2, ByteOffset(GPIOA_ODR+0)]
;DriverRF4463PROMain.c,831 :: 		Level7Led = 0;
MOVW	R2, #lo_addr(GPIOA_ODR+0)
MOVT	R2, #hi_addr(GPIOA_ODR+0)
_LX	[R2, ByteOffset(GPIOA_ODR+0)]
MOVS	R1, #2
