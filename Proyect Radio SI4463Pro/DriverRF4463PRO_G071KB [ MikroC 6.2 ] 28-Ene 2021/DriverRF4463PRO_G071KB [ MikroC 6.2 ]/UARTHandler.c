...
//=============================================================================================================
// Funcion para enviar un determinado buffer por DMA. Revisar el tamaño del buffer destino para evitar errores
...
// Por limitación de DMA, solamente pueden borrarse hasta 65536 bytes
