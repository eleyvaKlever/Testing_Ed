...
//#define STM32L072CB            // Placa de Dimmer 16MHz
...
//            EXTI_FTSR.B10   |= 1;
     ...
     #ifdef STM32L072CB            // Placa de Dimmer 16MHz
            /*********************************************************************
             * IRQ Configuration
            *********************************************************************/
     ...
     ucRF4463Rate  = dr_2p4;                // BAUDRATE

     
     ucRF4463Mode  = slave_mode;          // para transmision continua usar: tx_test_mode
