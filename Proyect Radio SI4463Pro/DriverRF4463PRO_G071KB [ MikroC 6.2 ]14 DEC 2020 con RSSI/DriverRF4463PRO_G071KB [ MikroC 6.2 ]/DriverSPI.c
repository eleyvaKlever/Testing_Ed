...
//#ifdef ( STM32F107VC | STM32F407VG )
//// Funcion de inicializacion
//void vSPI3Init ( void ) {
//     SPI3_Init_Advanced( _SPI_FPCLK_DIV8, _SPI_MASTER | _SPI_8_BIT | _SPI_CLK_IDLE_LOW | _SPI_FIRST_CLK_EDGE_TRANSITION | _SPI_MSB_FIRST |
