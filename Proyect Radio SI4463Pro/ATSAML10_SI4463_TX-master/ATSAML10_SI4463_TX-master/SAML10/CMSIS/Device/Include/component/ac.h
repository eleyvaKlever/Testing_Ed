...
#ifndef _SAML10_AC_COMPONENT_
#define _SAML10_AC_COMPONENT_

/* ========================================================================== */
/**  SOFTWARE API DEFINITION FOR AC */
/* ========================================================================== */
/** \addtogroup SAML10_AC Analog Comparators */
/*@{*/
...
#define   AC_COMPCTRL_MUXNEG_OPAMP_Val    _U_(0x7)   /**< \brief (AC_COMPCTRL) OPAMP output (on AC1) */
#define   AC_COMPCTRL_MUXNEG_DAC_Val      _U_(0x7)   /**< \brief (AC_COMPCTRL) DAC output (on AC0) */
...
#define AC_COMPCTRL_MUXNEG_OPAMP    (AC_COMPCTRL_MUXNEG_OPAMP_Val  << AC_COMPCTRL_MUXNEG_Pos)
