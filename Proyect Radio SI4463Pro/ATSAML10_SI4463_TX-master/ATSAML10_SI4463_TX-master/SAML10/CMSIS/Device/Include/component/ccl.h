...
#ifndef _SAML10_CCL_COMPONENT_
#define _SAML10_CCL_COMPONENT_

/* ========================================================================== */
/**  SOFTWARE API DEFINITION FOR CCL */
/* ========================================================================== */
/** \addtogroup SAML10_CCL Configurable Custom Logic */
/*@{*/
...
#define   CCL_LUTCTRL_INSEL0_ASYNCEVENT_Val _U_(0xB)   /**< \brief (CCL_LUTCTRL) Asynchronous event input source. The EVENT input will bypass edge detection logic. */
...
#define   CCL_LUTCTRL_INSEL1_ALT2TC_Val   _U_(0xA)   /**< \brief (CCL_LUTCTRL) Alternate 2 TC input source */
#define   CCL_LUTCTRL_INSEL1_ASYNCEVENT_Val _U_(0xB)   /**< \brief (CCL_LUTCTRL) Asynchronous event input source. The EVENT input will bypass edge detection logic. */
...
#define   CCL_LUTCTRL_INSEL2_ALT2TC_Val   _U_(0xA)   /**< \brief (CCL_LUTCTRL) Alternate 2 TC input source */
#define   CCL_LUTCTRL_INSEL2_ASYNCEVENT_Val _U_(0xB)   /**< \brief (CCL_LUTCTRL) Asynchronous event input source. The EVENT input will bypass edge detection logic. */
...
typedef struct {
  ...
  __IO CCL_SEQCTRL_Type          SEQCTRL[1];  /**< \brief Offset: 0x4 (R/W  8) SEQ Control x */
       RoReg8                    Reserved2[0x3];
  __IO CCL_LUTCTRL_Type          LUTCTRL[2];  /**< \brief Offset: 0x8 (R/W 32) LUT Control x */
} Ccl;
#endif /* !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)) */

/*@}*/

#endif /* _SAML10_CCL_COMPONENT_ */
