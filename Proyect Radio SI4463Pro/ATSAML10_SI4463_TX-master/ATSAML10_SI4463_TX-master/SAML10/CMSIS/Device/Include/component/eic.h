...
#ifndef _SAML10_EIC_COMPONENT_
#define _SAML10_EIC_COMPONENT_

/* ========================================================================== */
/**  SOFTWARE API DEFINITION FOR EIC */
/* ========================================================================== */
/** \addtogroup SAML10_EIC External Interrupt Controller */
/*@{*/
...
#define EIC_INTENCLR_NSCHK_Pos      31           /**< \brief (EIC_INTENCLR) Non-secure Check Interrupt Enable */
#define EIC_INTENCLR_NSCHK          (_U_(0x1) << EIC_INTENCLR_NSCHK_Pos)
#define EIC_INTENCLR_MASK           _U_(0x800000FF) /**< \brief (EIC_INTENCLR) MASK Register */
...
#define EIC_INTENSET_NSCHK_Pos      31           /**< \brief (EIC_INTENSET) Non-secure Check Interrupt Enable */
#define EIC_INTENSET_NSCHK          (_U_(0x1) << EIC_INTENSET_NSCHK_Pos)
#define EIC_INTENSET_MASK           _U_(0x800000FF) /**< \brief (EIC_INTENSET) MASK Register */
...
#define EIC_INTFLAG_NSCHK_Pos       31           /**< \brief (EIC_INTFLAG) Non-secure Check Interrupt */
#define EIC_INTFLAG_NSCHK           (_U_(0x1) << EIC_INTFLAG_NSCHK_Pos)
#define EIC_INTFLAG_MASK            _U_(0x800000FF) /**< \brief (EIC_INTFLAG) MASK Register */
...
#define EIC_ASYNCH_MASK             _U_(0x000000FF) /**< \brief (EIC_ASYNCH) MASK Register */
...
#define EIC_DEBOUNCEN_MASK          _U_(0x000000FF) /**< \brief (EIC_DEBOUNCEN) MASK Register */
...
#define EIC_DPRESCALER_MASK         _U_(0x0001000F) /**< \brief (EIC_DPRESCALER) MASK Register */
...
#define EIC_PINSTATE_MASK           _U_(0x000000FF) /**< \brief (EIC_PINSTATE) MASK Register */
...
#define EIC_NSCHK_OFFSET            0x3C         /**< \brief (EIC_NSCHK offset) Non-secure Interrupt Check Enable */
#define EIC_NSCHK_RESETVALUE        _U_(0x00000000) /**< \brief (EIC_NSCHK reset_value) Non-secure Interrupt Check Enable */

#define EIC_NSCHK_EXTINT_Pos        0            /**< \brief (EIC_NSCHK) External Interrupt Nonsecure Check Enable */
...
#define EIC_NSCHK_NMI_Pos           31           /**< \brief (EIC_NSCHK) Non-Maskable External Interrupt Nonsecure Check Enable */
#define EIC_NSCHK_NMI               (_U_(0x1) << EIC_NSCHK_NMI_Pos)
#define EIC_NSCHK_MASK              _U_(0x800000FF) /**< \brief (EIC_NSCHK) MASK Register */
...
#define EIC_NONSEC_OFFSET           0x40         /**< \brief (EIC_NONSEC offset) Non-secure Interrupt */
#define EIC_NONSEC_RESETVALUE       _U_(0x00000000) /**< \brief (EIC_NONSEC reset_value) Non-secure Interrupt */

#define EIC_NONSEC_EXTINT_Pos       0            /**< \brief (EIC_NONSEC) External Interrupt Nonsecure Enable */
...
#define EIC_NONSEC_NMI_Pos          31           /**< \brief (EIC_NONSEC) Non-Maskable Interrupt Nonsecure Enable */
#define EIC_NONSEC_NMI              (_U_(0x1) << EIC_NONSEC_NMI_Pos)
#define EIC_NONSEC_MASK             _U_(0x800000FF) /**< \brief (EIC_NONSEC) MASK Register */
...
typedef struct {
  ...
  __IO EIC_CONFIG_Type           CONFIG[1];   /**< \brief Offset: 0x1C (R/W 32) External Interrupt Sense Configuration */
  ...
  __IO EIC_NSCHK_Type            NSCHK;       /**< \brief Offset: 0x3C (R/W 32) Non-secure Interrupt Check Enable */
  __IO EIC_NONSEC_Type           NONSEC;      /**< \brief Offset: 0x40 (R/W 32) Non-secure Interrupt */
} Eic;
#endif /* !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)) */
