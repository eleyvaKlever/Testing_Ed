...
#ifndef _SAML10_ADC_COMPONENT_
#define _SAML10_ADC_COMPONENT_

/* ========================================================================== */
/**  SOFTWARE API DEFINITION FOR ADC */
/* ========================================================================== */
/** \addtogroup SAML10_ADC Analog Digital Converter */
/*@{*/
...
#define   ADC_INPUTCTRL_MUXPOS_OPAMP01_Val _U_(0x1E)   /**< \brief (ADC_INPUTCTRL) OPAMP0 or OPAMP1 output */
#define   ADC_INPUTCTRL_MUXPOS_OPAMP2_Val _U_(0x1F)   /**< \brief (ADC_INPUTCTRL) OPAMP2 output */
