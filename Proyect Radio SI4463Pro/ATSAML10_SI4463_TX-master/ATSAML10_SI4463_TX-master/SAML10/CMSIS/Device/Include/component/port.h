...
#ifndef _SAML10_PORT_COMPONENT_
#define _SAML10_PORT_COMPONENT_

/* ========================================================================== */
/**  SOFTWARE API DEFINITION FOR PORT */
/* ========================================================================== */
/** \addtogroup SAML10_PORT Port Module */
/*@{*/
...
/* -------- PORT_INTENCLR : (PORT Offset: 0x60) (R/W 32) GROUP Interrupt Enable Clear -------- */
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  struct {
...
#define PORT_INTENCLR_OFFSET        0x60         /**< \brief (PORT_INTENCLR offset) Interrupt Enable Clear */
#define PORT_INTENCLR_RESETVALUE    _U_(0x00000000) /**< \brief (PORT_INTENCLR reset_value) Interrupt Enable Clear */

#define PORT_INTENCLR_NSCHK_Pos     0            /**< \brief (PORT_INTENCLR) Non-Secure Check Interrupt Enable */
#define PORT_INTENCLR_NSCHK         (_U_(0x1) << PORT_INTENCLR_NSCHK_Pos)
#define PORT_INTENCLR_MASK          _U_(0x00000001) /**< \brief (PORT_INTENCLR) MASK Register */

/* -------- PORT_INTENSET : (PORT Offset: 0x64) (R/W 32) GROUP Interrupt Enable Set -------- */
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  struct {
    uint32_t NSCHK:1;          /*!< bit:      0  Non-Secure Check Interrupt Enable  */
...
#define PORT_INTENSET_OFFSET        0x64         /**< \brief (PORT_INTENSET offset) Interrupt Enable Set */
#define PORT_INTENSET_RESETVALUE    _U_(0x00000000) /**< \brief (PORT_INTENSET reset_value) Interrupt Enable Set */

#define PORT_INTENSET_NSCHK_Pos     0            /**< \brief (PORT_INTENSET) Non-Secure Check Interrupt Enable */
#define PORT_INTENSET_NSCHK         (_U_(0x1) << PORT_INTENSET_NSCHK_Pos)
#define PORT_INTENSET_MASK          _U_(0x00000001) /**< \brief (PORT_INTENSET) MASK Register */

/* -------- PORT_INTFLAG : (PORT Offset: 0x68) (R/W 32) GROUP Interrupt Flag Status and Clear -------- */
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
...
#define PORT_INTFLAG_OFFSET         0x68         /**< \brief (PORT_INTFLAG offset) Interrupt Flag Status and Clear */
#define PORT_INTFLAG_RESETVALUE     _U_(0x00000000) /**< \brief (PORT_INTFLAG reset_value) Interrupt Flag Status and Clear */

#define PORT_INTFLAG_NSCHK_Pos      0            /**< \brief (PORT_INTFLAG) Non-Secure Check */
#define PORT_INTFLAG_NSCHK          (_U_(0x1) << PORT_INTFLAG_NSCHK_Pos)
#define PORT_INTFLAG_MASK           _U_(0x00000001) /**< \brief (PORT_INTFLAG) MASK Register */

/* -------- PORT_NONSEC : (PORT Offset: 0x6C) (R/W 32) GROUP Security Attribution -------- */
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  struct {
...
#define PORT_NONSEC_OFFSET          0x6C         /**< \brief (PORT_NONSEC offset) Security Attribution */
#define PORT_NONSEC_RESETVALUE      _U_(0x00000000) /**< \brief (PORT_NONSEC reset_value) Security Attribution */

#define PORT_NONSEC_NONSEC_Pos      0            /**< \brief (PORT_NONSEC) Port Security Attribution */
...
#define PORT_NONSEC_MASK            _U_(0xFFFFFFFF) /**< \brief (PORT_NONSEC) MASK Register */

/* -------- PORT_NSCHK : (PORT Offset: 0x70) (R/W 32) GROUP Security Attribution Check -------- */
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  struct {
...
#define PORT_NSCHK_OFFSET           0x70         /**< \brief (PORT_NSCHK offset) Security Attribution Check */
#define PORT_NSCHK_RESETVALUE       _U_(0x00000000) /**< \brief (PORT_NSCHK reset_value) Security Attribution Check */

#define PORT_NSCHK_NSCHK_Pos        0            /**< \brief (PORT_NSCHK) Port Security Attribution Check */
...
#define PORT_NSCHK_MASK             _U_(0xFFFFFFFF) /**< \brief (PORT_NSCHK) MASK Register */
...
typedef struct {
  ...
  __IO PORT_INTENCLR_Type        INTENCLR;    /**< \brief Offset: 0x60 (R/W 32) Interrupt Enable Clear */
  __IO PORT_INTENSET_Type        INTENSET;    /**< \brief Offset: 0x64 (R/W 32) Interrupt Enable Set */
  __IO PORT_INTFLAG_Type         INTFLAG;     /**< \brief Offset: 0x68 (R/W 32) Interrupt Flag Status and Clear */
  __IO PORT_NONSEC_Type          NONSEC;      /**< \brief Offset: 0x6C (R/W 32) Security Attribution */
  __IO PORT_NSCHK_Type           NSCHK;       /**< \brief Offset: 0x70 (R/W 32) Security Attribution Check */
