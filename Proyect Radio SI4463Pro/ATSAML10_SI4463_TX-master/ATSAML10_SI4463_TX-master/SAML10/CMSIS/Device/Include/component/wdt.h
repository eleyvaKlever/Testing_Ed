...
#ifndef _SAML10_WDT_COMPONENT_
#define _SAML10_WDT_COMPONENT_

/* ========================================================================== */
/**  SOFTWARE API DEFINITION FOR WDT */
/* ========================================================================== */
/** \addtogroup SAML10_WDT Watchdog Timer */
/*@{*/
...
#define WDT_CTRLA_RUNSTDBY_Pos      6            /**< \brief (WDT_CTRLA) Run During Standby */
#define WDT_CTRLA_RUNSTDBY          (_U_(0x1) << WDT_CTRLA_RUNSTDBY_Pos)
#define WDT_CTRLA_ALWAYSON_Pos      7            /**< \brief (WDT_CTRLA) Always-On */
#define WDT_CTRLA_ALWAYSON          (_U_(0x1) << WDT_CTRLA_ALWAYSON_Pos)
#define WDT_CTRLA_MASK              _U_(0xC6)    /**< \brief (WDT_CTRLA) MASK Register */
...
#define WDT_SYNCBUSY_RUNSTDBY_Pos   3            /**< \brief (WDT_SYNCBUSY) Run During Standby Synchronization Busy */
#define WDT_SYNCBUSY_RUNSTDBY       (_U_(0x1) << WDT_SYNCBUSY_RUNSTDBY_Pos)
#define WDT_SYNCBUSY_ALWAYSON_Pos   4            /**< \brief (WDT_SYNCBUSY) Always-On Synchronization Busy */
#define WDT_SYNCBUSY_ALWAYSON       (_U_(0x1) << WDT_SYNCBUSY_ALWAYSON_Pos)
#define WDT_SYNCBUSY_CLEAR_Pos      5            /**< \brief (WDT_SYNCBUSY) Clear Synchronization Busy */
#define WDT_SYNCBUSY_CLEAR          (_U_(0x1) << WDT_SYNCBUSY_CLEAR_Pos)
#define WDT_SYNCBUSY_MASK           _U_(0x0000003E) /**< \brief (WDT_SYNCBUSY) MASK Register */
