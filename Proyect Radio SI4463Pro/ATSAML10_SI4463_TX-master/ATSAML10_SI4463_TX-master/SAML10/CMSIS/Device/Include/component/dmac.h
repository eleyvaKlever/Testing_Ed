...
#ifndef _SAML10_DMAC_COMPONENT_
#define _SAML10_DMAC_COMPONENT_

/* ========================================================================== */
/**  SOFTWARE API DEFINITION FOR DMAC */
/* ========================================================================== */
/** \addtogroup SAML10_DMAC Direct Memory Access Controller */
/*@{*/

#define DMAC_U2223
#define REV_DMAC                    0x240
...
typedef union {
  ...
  struct {
    uint32_t SWTRIG:8;         /*!< bit:  0.. 7  Channel x Software Trigger         */
    uint32_t :24;              /*!< bit:  8..31  Reserved                           */
  } vec;                       /*!< Structure used for vec  access                  */
  uint32_t reg;                /*!< Type      used for register access              */
...
#define DMAC_SWTRIGCTRL_SWTRIG_Msk  (_U_(0xFF) << DMAC_SWTRIGCTRL_SWTRIG_Pos)
#define DMAC_SWTRIGCTRL_SWTRIG(value) (DMAC_SWTRIGCTRL_SWTRIG_Msk & ((value) << DMAC_SWTRIGCTRL_SWTRIG_Pos))
#define DMAC_SWTRIGCTRL_MASK        _U_(0x000000FF) /**< \brief (DMAC_SWTRIGCTRL) MASK Register */
...
typedef union {
  ...
  struct {
    uint32_t CHINT:8;          /*!< bit:  0.. 7  Channel x Pending Interrupt        */
    uint32_t :24;              /*!< bit:  8..31  Reserved                           */
  } vec;                       /*!< Structure used for vec  access                  */
  uint32_t reg;                /*!< Type      used for register access              */
} DMAC_INTSTATUS_Type;
...
#define DMAC_INTSTATUS_CHINT_Msk    (_U_(0xFF) << DMAC_INTSTATUS_CHINT_Pos)
#define DMAC_INTSTATUS_CHINT(value) (DMAC_INTSTATUS_CHINT_Msk & ((value) << DMAC_INTSTATUS_CHINT_Pos))
#define DMAC_INTSTATUS_MASK         _U_(0x000000FF) /**< \brief (DMAC_INTSTATUS) MASK Register */
...
typedef union {
  ...
  struct {
    uint32_t BUSYCH:8;         /*!< bit:  0.. 7  Busy Channel x                     */
    uint32_t :24;              /*!< bit:  8..31  Reserved                           */
  } vec;                       /*!< Structure used for vec  access                  */
  uint32_t reg;                /*!< Type      used for register access              */
} DMAC_BUSYCH_Type;
...
#define DMAC_BUSYCH_BUSYCH_Msk      (_U_(0xFF) << DMAC_BUSYCH_BUSYCH_Pos)
#define DMAC_BUSYCH_BUSYCH(value)   (DMAC_BUSYCH_BUSYCH_Msk & ((value) << DMAC_BUSYCH_BUSYCH_Pos))
#define DMAC_BUSYCH_MASK            _U_(0x000000FF) /**< \brief (DMAC_BUSYCH) MASK Register */
...
typedef union {
  ...
  struct {
    uint32_t PENDCH:8;         /*!< bit:  0.. 7  Pending Channel x                  */
    uint32_t :24;              /*!< bit:  8..31  Reserved                           */
  } vec;                       /*!< Structure used for vec  access                  */
  uint32_t reg;                /*!< Type      used for register access              */
} DMAC_PENDCH_Type;
...
#define DMAC_PENDCH_PENDCH_Msk      (_U_(0xFF) << DMAC_PENDCH_PENDCH_Pos)
#define DMAC_PENDCH_PENDCH(value)   (DMAC_PENDCH_PENDCH_Msk & ((value) << DMAC_PENDCH_PENDCH_Pos))
#define DMAC_PENDCH_MASK            _U_(0x000000FF) /**< \brief (DMAC_PENDCH) MASK Register */
