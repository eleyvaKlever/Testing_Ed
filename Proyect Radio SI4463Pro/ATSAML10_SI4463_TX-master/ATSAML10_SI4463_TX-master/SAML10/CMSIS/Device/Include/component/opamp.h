...
#ifndef _SAML10_OPAMP_COMPONENT_
#define _SAML10_OPAMP_COMPONENT_

/* ========================================================================== */
/**  SOFTWARE API DEFINITION FOR OPAMP */
/* ========================================================================== */
/** \addtogroup SAML10_OPAMP Operational Amplifier */
/*@{*/
...
#define OPAMP_OPAMPCTRL_RES2VCC_Pos 5            /**< \brief (OPAMP_OPAMPCTRL) Resistor ladder To VCC */
...
#define OPAMP_OPAMPCTRL_RES1EN_Pos  9            /**< \brief (OPAMP_OPAMPCTRL) Resistor 1 Enable */
#define OPAMP_OPAMPCTRL_RES1EN      (_U_(0x1) << OPAMP_OPAMPCTRL_RES1EN_Pos)
#define OPAMP_OPAMPCTRL_RES1MUX_Pos 10           /**< \brief (OPAMP_OPAMPCTRL) Resistor 1 Mux */
...
#define OPAMP_OPAMPCTRL_MASK        _U_(0x00FFFFFE) /**< \brief (OPAMP_OPAMPCTRL) MASK Register */
...
#define OPAMP_RESCTRL_OFFSET        0x10         /**< \brief (OPAMP_RESCTRL offset) Resister Control */
#define OPAMP_RESCTRL_RESETVALUE    _U_(0x00)    /**< \brief (OPAMP_RESCTRL reset_value) Resister Control */

#define OPAMP_RESCTRL_RES2OUT_Pos   0            /**< \brief (OPAMP_RESCTRL) Resistor ladder To Output */
#define OPAMP_RESCTRL_RES2OUT       (_U_(0x1) << OPAMP_RESCTRL_RES2OUT_Pos)
#define OPAMP_RESCTRL_RES1EN_Pos    1            /**< \brief (OPAMP_RESCTRL) Resistor 1 Enable */
#define OPAMP_RESCTRL_RES1EN        (_U_(0x1) << OPAMP_RESCTRL_RES1EN_Pos)
#define OPAMP_RESCTRL_RES1MUX_Pos   2            /**< \brief (OPAMP_RESCTRL) Resistor 1 Mux */
#define OPAMP_RESCTRL_RES1MUX       (_U_(0x1) << OPAMP_RESCTRL_RES1MUX_Pos)
#define OPAMP_RESCTRL_POTMUX_Pos    3            /**< \brief (OPAMP_RESCTRL) Potentiometer Selection */
...
#define OPAMP_RESCTRL_REFBUFLEVEL_Pos 6            /**< \brief (OPAMP_RESCTRL) Reference output voltage level select */
...
#define OPAMP_RESCTRL_MASK          _U_(0xFF)    /**< \brief (OPAMP_RESCTRL) MASK Register */
...
typedef struct {
  ...
  __IO OPAMP_RESCTRL_Type        RESCTRL;     /**< \brief Offset: 0x10 (R/W  8) Resister Control */
} Opamp;
#endif /* !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)) */
