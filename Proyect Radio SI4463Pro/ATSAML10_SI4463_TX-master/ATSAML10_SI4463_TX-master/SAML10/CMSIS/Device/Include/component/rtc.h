...
#ifndef _SAML10_RTC_COMPONENT_
#define _SAML10_RTC_COMPONENT_

/* ========================================================================== */
/**  SOFTWARE API DEFINITION FOR RTC */
/* ========================================================================== */
/** \addtogroup SAML10_RTC Real-Time Counter */
/*@{*/
...
#define RTC_MODE0_CTRLA_MASK        _U_(0xCF8F)  /**< \brief (RTC_MODE0_CTRLA) MASK Register */
...
#define RTC_MODE1_CTRLA_MASK        _U_(0xCF0F)  /**< \brief (RTC_MODE1_CTRLA) MASK Register */
...
#define RTC_MODE2_CTRLA_MASK        _U_(0xCFCF)  /**< \brief (RTC_MODE2_CTRLA) MASK Register */
...
#define RTC_MODE0_CTRLB_DEBF_Pos    8            /**< \brief (RTC_MODE0_CTRLB) Debounce Frequency */
...
#define RTC_MODE0_CTRLB_ACTF_Pos    12           /**< \brief (RTC_MODE0_CTRLB) Active Layer Frequency */
...
#define RTC_MODE0_CTRLB_SEPTO_Pos   15           /**< \brief (RTC_MODE0_CTRLB) Separate Tamper Outputs */
#define RTC_MODE0_CTRLB_SEPTO       (_U_(0x1) << RTC_MODE0_CTRLB_SEPTO_Pos)
#define RTC_MODE0_CTRLB_MASK        _U_(0xF7F1)  /**< \brief (RTC_MODE0_CTRLB) MASK Register */
...
#define RTC_MODE1_CTRLB_DEBF_Pos    8            /**< \brief (RTC_MODE1_CTRLB) Debounce Frequency */
...
#define RTC_MODE1_CTRLB_ACTF_Pos    12           /**< \brief (RTC_MODE1_CTRLB) Active Layer Frequency */
...
#define RTC_MODE1_CTRLB_SEPTO_Pos   15           /**< \brief (RTC_MODE1_CTRLB) Separate Tamper Outputs */
#define RTC_MODE1_CTRLB_SEPTO       (_U_(0x1) << RTC_MODE1_CTRLB_SEPTO_Pos)
#define RTC_MODE1_CTRLB_MASK        _U_(0xF7F1)  /**< \brief (RTC_MODE1_CTRLB) MASK Register */
...
#define RTC_MODE2_CTRLB_DEBF_Pos    8            /**< \brief (RTC_MODE2_CTRLB) Debounce Frequency */
...
#define RTC_MODE2_CTRLB_ACTF_Pos    12           /**< \brief (RTC_MODE2_CTRLB) Active Layer Frequency */
...
#define RTC_MODE2_CTRLB_SEPTO_Pos   15           /**< \brief (RTC_MODE2_CTRLB) Separate Tamper Outputs */
#define RTC_MODE2_CTRLB_SEPTO       (_U_(0x1) << RTC_MODE2_CTRLB_SEPTO_Pos)
#define RTC_MODE2_CTRLB_MASK        _U_(0xF7F1)  /**< \brief (RTC_MODE2_CTRLB) MASK Register */
...
#define RTC_MODE0_EVCTRL_PERDEO_Pos 24           /**< \brief (RTC_MODE0_EVCTRL) Periodic Interval Daily Event Output Enable */
#define RTC_MODE0_EVCTRL_PERDEO     (_U_(0x1) << RTC_MODE0_EVCTRL_PERDEO_Pos)
#define RTC_MODE0_EVCTRL_MASK       _U_(0x0101C1FF) /**< \brief (RTC_MODE0_EVCTRL) MASK Register */
...
#define RTC_MODE1_EVCTRL_PERDEO_Pos 24           /**< \brief (RTC_MODE1_EVCTRL) Periodic Interval Daily Event Output Enable */
#define RTC_MODE1_EVCTRL_PERDEO     (_U_(0x1) << RTC_MODE1_EVCTRL_PERDEO_Pos)
#define RTC_MODE1_EVCTRL_MASK       _U_(0x0101C3FF) /**< \brief (RTC_MODE1_EVCTRL) MASK Register */
...
#define RTC_MODE2_EVCTRL_PERDEO_Pos 24           /**< \brief (RTC_MODE2_EVCTRL) Periodic Interval Daily Event Output Enable */
#define RTC_MODE2_EVCTRL_PERDEO     (_U_(0x1) << RTC_MODE2_EVCTRL_PERDEO_Pos)
#define RTC_MODE2_EVCTRL_MASK       _U_(0x0101C1FF) /**< \brief (RTC_MODE2_EVCTRL) MASK Register */
...
typedef union {
  ...
  struct {
    ...
    uint32_t :4;               /*!< bit: 20..23  Reserved                           */
    uint32_t DEBNC:4;          /*!< bit: 24..27  Debouncer Enable x                 */
    uint32_t :4;               /*!< bit: 28..31  Reserved                           */
  } vec;                       /*!< Structure used for vec  access                  */
  uint32_t reg;                /*!< Type      used for register access              */
} RTC_TAMPCTRL_Type;
...
#define   RTC_TAMPCTRL_IN0ACT_WAKE_Val    _U_(0x1)   /**< \brief (RTC_TAMPCTRL) Wake and set Tamper flag */
#define   RTC_TAMPCTRL_IN0ACT_CAPTURE_Val _U_(0x2)   /**< \brief (RTC_TAMPCTRL) Capture timestamp and set Tamper flag */
#define   RTC_TAMPCTRL_IN0ACT_ACTL_Val    _U_(0x3)   /**< \brief (RTC_TAMPCTRL) Compare IN0 to OUT. When a mismatch occurs, capture timestamp and set Tamper flag */
...
#define   RTC_TAMPCTRL_IN1ACT_WAKE_Val    _U_(0x1)   /**< \brief (RTC_TAMPCTRL) Wake and set Tamper flag */
#define   RTC_TAMPCTRL_IN1ACT_CAPTURE_Val _U_(0x2)   /**< \brief (RTC_TAMPCTRL) Capture timestamp and set Tamper flag */
#define   RTC_TAMPCTRL_IN1ACT_ACTL_Val    _U_(0x3)   /**< \brief (RTC_TAMPCTRL) Compare IN1 to OUT. When a mismatch occurs, capture timestamp and set Tamper flag */
...
#define   RTC_TAMPCTRL_IN2ACT_WAKE_Val    _U_(0x1)   /**< \brief (RTC_TAMPCTRL) Wake and set Tamper flag */
#define   RTC_TAMPCTRL_IN2ACT_CAPTURE_Val _U_(0x2)   /**< \brief (RTC_TAMPCTRL) Capture timestamp and set Tamper flag */
#define   RTC_TAMPCTRL_IN2ACT_ACTL_Val    _U_(0x3)   /**< \brief (RTC_TAMPCTRL) Compare IN2 to OUT. When a mismatch occurs, capture timestamp and set Tamper flag */
...
#define   RTC_TAMPCTRL_IN3ACT_WAKE_Val    _U_(0x1)   /**< \brief (RTC_TAMPCTRL) Wake and set Tamper flag */
#define   RTC_TAMPCTRL_IN3ACT_CAPTURE_Val _U_(0x2)   /**< \brief (RTC_TAMPCTRL) Capture timestamp and set Tamper flag */
#define   RTC_TAMPCTRL_IN3ACT_ACTL_Val    _U_(0x3)   /**< \brief (RTC_TAMPCTRL) Compare IN3 to OUT. When a mismatch occurs, capture timestamp and set Tamper flag */
...
#define RTC_TAMPCTRL_MASK           _U_(0x0F0F00FF) /**< \brief (RTC_TAMPCTRL) MASK Register */
...
#define RTC_TAMPID_MASK             _U_(0x8000000F) /**< \brief (RTC_TAMPID) MASK Register */
...
typedef union {
  ...
  struct {
    uint32_t ALSI:4;           /*!< bit:  0.. 3  Active Layer Select Internal x     */
    uint32_t :28;              /*!< bit:  4..31  Reserved                           */
  } vec;                       /*!< Structure used for vec  access                  */
  uint32_t reg;                /*!< Type      used for register access              */
} RTC_TAMPCTRLB_Type;
...
#define RTC_TAMPCTRLB_OFFSET        0x6C         /**< \brief (RTC_TAMPCTRLB offset) Tamper Control B */
#define RTC_TAMPCTRLB_RESETVALUE    _U_(0x00000000) /**< \brief (RTC_TAMPCTRLB reset_value) Tamper Control B */

#define RTC_TAMPCTRLB_ALSI0_Pos     0            /**< \brief (RTC_TAMPCTRLB) Active Layer Select Internal 0 */
#define RTC_TAMPCTRLB_ALSI0         (_U_(1) << RTC_TAMPCTRLB_ALSI0_Pos)
#define RTC_TAMPCTRLB_ALSI1_Pos     1            /**< \brief (RTC_TAMPCTRLB) Active Layer Select Internal 1 */
#define RTC_TAMPCTRLB_ALSI1         (_U_(1) << RTC_TAMPCTRLB_ALSI1_Pos)
#define RTC_TAMPCTRLB_ALSI2_Pos     2            /**< \brief (RTC_TAMPCTRLB) Active Layer Select Internal 2 */
#define RTC_TAMPCTRLB_ALSI2         (_U_(1) << RTC_TAMPCTRLB_ALSI2_Pos)
#define RTC_TAMPCTRLB_ALSI3_Pos     3            /**< \brief (RTC_TAMPCTRLB) Active Layer Select Internal 3 */
#define RTC_TAMPCTRLB_ALSI3         (_U_(1) << RTC_TAMPCTRLB_ALSI3_Pos)
#define RTC_TAMPCTRLB_ALSI_Pos      0            /**< \brief (RTC_TAMPCTRLB) Active Layer Select Internal x */
...
#define RTC_TAMPCTRLB_MASK          _U_(0x0000000F) /**< \brief (RTC_TAMPCTRLB) MASK Register */
...
typedef struct { /* 32-bit Counter with Single 32-bit Compare */
  ...
  __IO RTC_TAMPCTRLB_Type        TAMPCTRLB;   /**< \brief Offset: 0x6C (R/W 32) Tamper Control B */
} RtcMode0;
#endif /* !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)) */
...
typedef struct { /* Clock/Calendar with Alarm */
  ...
  __IO RTC_MODE2_CLOCK_Type      CLOCK;       /**< \brief Offset: 0x18 (R/W 32) MODE2 Clock Value */
       RoReg8                    Reserved3[0x4];
       RtcMode2Alarm             Mode2Alarm[1]; /**< \brief Offset: 0x20 RtcMode2Alarm groups [NUM_OF_ALARMS] */
