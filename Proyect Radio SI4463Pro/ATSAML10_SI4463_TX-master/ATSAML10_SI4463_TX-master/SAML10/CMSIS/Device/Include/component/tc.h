...
#ifndef _SAML10_TC_COMPONENT_
#define _SAML10_TC_COMPONENT_

/* ========================================================================== */
/**  SOFTWARE API DEFINITION FOR TC */
/* ========================================================================== */
/** \addtogroup SAML10_TC Basic Timer Counter */
/*@{*/
...
#define TC_COUNT32_PER_RESETVALUE   _U_(0xFFFFFFFF) /**< \brief (TC_COUNT32_PER reset_value) COUNT32 Period */

#define TC_COUNT32_PER_PER_Pos      0            /**< \brief (TC_COUNT32_PER) Period Value */
#define TC_COUNT32_PER_PER_Msk      (_U_(0xFFFFFFFF) << TC_COUNT32_PER_PER_Pos)
#define TC_COUNT32_PER_PER(value)   (TC_COUNT32_PER_PER_Msk & ((value) << TC_COUNT32_PER_PER_Pos))
#define TC_COUNT32_PER_MASK         _U_(0xFFFFFFFF) /**< \brief (TC_COUNT32_PER) MASK Register */

/* -------- TC_COUNT16_PER : (TC Offset: 0x1A) (R/W 16) COUNT16 COUNT16 Period -------- */
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  struct {
...
#define TC_COUNT16_PER_RESETVALUE   _U_(0xFFFF)  /**< \brief (TC_COUNT16_PER reset_value) COUNT16 Period */

#define TC_COUNT16_PER_PER_Pos      0            /**< \brief (TC_COUNT16_PER) Period Value */
#define TC_COUNT16_PER_PER_Msk      (_U_(0xFFFF) << TC_COUNT16_PER_PER_Pos)
#define TC_COUNT16_PER_PER(value)   (TC_COUNT16_PER_PER_Msk & ((value) << TC_COUNT16_PER_PER_Pos))
#define TC_COUNT16_PER_MASK         _U_(0xFFFF)  /**< \brief (TC_COUNT16_PER) MASK Register */
...
/* -------- TC_COUNT32_PERBUF : (TC Offset: 0x2C) (R/W 32) COUNT32 COUNT32 Period Buffer -------- */
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  struct {
...
#define TC_COUNT32_PERBUF_RESETVALUE _U_(0xFFFFFFFF) /**< \brief (TC_COUNT32_PERBUF reset_value) COUNT32 Period Buffer */

#define TC_COUNT32_PERBUF_PERBUF_Pos 0            /**< \brief (TC_COUNT32_PERBUF) Period Buffer Value */
#define TC_COUNT32_PERBUF_PERBUF_Msk (_U_(0xFFFFFFFF) << TC_COUNT32_PERBUF_PERBUF_Pos)
#define TC_COUNT32_PERBUF_PERBUF(value) (TC_COUNT32_PERBUF_PERBUF_Msk & ((value) << TC_COUNT32_PERBUF_PERBUF_Pos))
#define TC_COUNT32_PERBUF_MASK      _U_(0xFFFFFFFF) /**< \brief (TC_COUNT32_PERBUF) MASK Register */

/* -------- TC_COUNT16_PERBUF : (TC Offset: 0x2E) (R/W 16) COUNT16 COUNT16 Period Buffer -------- */
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  struct {
...
#define TC_COUNT16_PERBUF_RESETVALUE _U_(0xFFFF)  /**< \brief (TC_COUNT16_PERBUF reset_value) COUNT16 Period Buffer */

#define TC_COUNT16_PERBUF_PERBUF_Pos 0            /**< \brief (TC_COUNT16_PERBUF) Period Buffer Value */
#define TC_COUNT16_PERBUF_PERBUF_Msk (_U_(0xFFFF) << TC_COUNT16_PERBUF_PERBUF_Pos)
#define TC_COUNT16_PERBUF_PERBUF(value) (TC_COUNT16_PERBUF_PERBUF_Msk & ((value) << TC_COUNT16_PERBUF_PERBUF_Pos))
#define TC_COUNT16_PERBUF_MASK      _U_(0xFFFF)  /**< \brief (TC_COUNT16_PERBUF) MASK Register */
