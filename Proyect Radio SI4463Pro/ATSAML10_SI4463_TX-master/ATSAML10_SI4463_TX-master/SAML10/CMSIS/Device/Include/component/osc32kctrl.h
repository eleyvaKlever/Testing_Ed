...
#ifndef _SAML10_OSC32KCTRL_COMPONENT_
#define _SAML10_OSC32KCTRL_COMPONENT_

/* ========================================================================== */
/**  SOFTWARE API DEFINITION FOR OSC32KCTRL */
/* ========================================================================== */
/** \addtogroup SAML10_OSC32KCTRL 32k Oscillators Control */
/*@{*/

#define OSC32KCTRL_U2246
#define REV_OSC32KCTRL              0x400
...
#define OSC32KCTRL_STATUS_ULP32KSW_Pos 4            /**< \brief (OSC32KCTRL_STATUS) OSCULP32K Clock Switch */
#define OSC32KCTRL_STATUS_ULP32KSW  (_U_(0x1) << OSC32KCTRL_STATUS_ULP32KSW_Pos)
#define OSC32KCTRL_STATUS_MASK      _U_(0x0000001D) /**< \brief (OSC32KCTRL_STATUS) MASK Register */
...
#define OSC32KCTRL_OSCULP32K_ULP32KSW_Pos 5            /**< \brief (OSC32KCTRL_OSCULP32K) OSCULP32K Clock Switch Enable */
#define OSC32KCTRL_OSCULP32K_ULP32KSW (_U_(0x1) << OSC32KCTRL_OSCULP32K_ULP32KSW_Pos)
...
#define OSC32KCTRL_OSCULP32K_MASK   _U_(0x00009F20) /**< \brief (OSC32KCTRL_OSCULP32K) MASK Register */
...
#endif /* _SAML10_OSC32KCTRL_COMPONENT_ */
