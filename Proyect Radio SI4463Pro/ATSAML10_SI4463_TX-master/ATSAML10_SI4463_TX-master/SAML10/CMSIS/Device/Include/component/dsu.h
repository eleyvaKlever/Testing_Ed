...
#ifndef _SAML10_DSU_COMPONENT_
#define _SAML10_DSU_COMPONENT_

/* ========================================================================== */
/**  SOFTWARE API DEFINITION FOR DSU */
/* ========================================================================== */
/** \addtogroup SAML10_DSU Device Service Unit */
/*@{*/
...
#define DSU_CTRL_MASK               _U_(0x0D)    /**< \brief (DSU_CTRL) MASK Register */
...
#define DSU_STATUSA_PERR_Pos        4            /**< \brief (DSU_STATUSA) Protection Error Detected by the State Machine */
#define DSU_STATUSA_PERR            (_U_(0x1) << DSU_STATUSA_PERR_Pos)
#define DSU_STATUSA_BREXT_Pos       5            /**< \brief (DSU_STATUSA) BootRom Phase Extension */
#define DSU_STATUSA_BREXT           (_U_(0x1) << DSU_STATUSA_BREXT_Pos)
#define DSU_STATUSA_MASK            _U_(0x3F)    /**< \brief (DSU_STATUSA) MASK Register */
...
#define DSU_STATUSB_DAL_Pos         0            /**< \brief (DSU_STATUSB) Debugger Access Level */
#define DSU_STATUSB_DAL_Msk         (_U_(0x3) << DSU_STATUSB_DAL_Pos)
#define DSU_STATUSB_DAL(value)      (DSU_STATUSB_DAL_Msk & ((value) << DSU_STATUSB_DAL_Pos))
#define   DSU_STATUSB_DAL_SECURED_Val     _U_(0x0)   /**< \brief (DSU_STATUSB)  */
#define   DSU_STATUSB_DAL_NS_DEBUG_Val    _U_(0x1)   /**< \brief (DSU_STATUSB)  */
#define   DSU_STATUSB_DAL_FULL_DEBUG_Val  _U_(0x2)   /**< \brief (DSU_STATUSB)  */
#define DSU_STATUSB_DAL_SECURED     (DSU_STATUSB_DAL_SECURED_Val   << DSU_STATUSB_DAL_Pos)
#define DSU_STATUSB_DAL_NS_DEBUG    (DSU_STATUSB_DAL_NS_DEBUG_Val  << DSU_STATUSB_DAL_Pos)
#define DSU_STATUSB_DAL_FULL_DEBUG  (DSU_STATUSB_DAL_FULL_DEBUG_Val << DSU_STATUSB_DAL_Pos)
#define DSU_STATUSB_DBGPRES_Pos     2            /**< \brief (DSU_STATUSB) Debugger Present */
#define DSU_STATUSB_DBGPRES         (_U_(0x1) << DSU_STATUSB_DBGPRES_Pos)
#define DSU_STATUSB_HPE_Pos         3            /**< \brief (DSU_STATUSB) Hot-Plugging Enable */
#define DSU_STATUSB_HPE             (_U_(0x1) << DSU_STATUSB_HPE_Pos)
#define DSU_STATUSB_DCCD0_Pos       4            /**< \brief (DSU_STATUSB) Debug Communication Channel 0 Dirty */
#define DSU_STATUSB_DCCD0           (_U_(1) << DSU_STATUSB_DCCD0_Pos)
#define DSU_STATUSB_DCCD1_Pos       5            /**< \brief (DSU_STATUSB) Debug Communication Channel 1 Dirty */
#define DSU_STATUSB_DCCD1           (_U_(1) << DSU_STATUSB_DCCD1_Pos)
#define DSU_STATUSB_DCCD_Pos        4            /**< \brief (DSU_STATUSB) Debug Communication Channel x Dirty */
#define DSU_STATUSB_DCCD_Msk        (_U_(0x3) << DSU_STATUSB_DCCD_Pos)
#define DSU_STATUSB_DCCD(value)     (DSU_STATUSB_DCCD_Msk & ((value) << DSU_STATUSB_DCCD_Pos))
#define DSU_STATUSB_BCCD0_Pos       6            /**< \brief (DSU_STATUSB) Boot ROM Communication Channel 0 Dirty */
#define DSU_STATUSB_BCCD0           (_U_(1) << DSU_STATUSB_BCCD0_Pos)
#define DSU_STATUSB_BCCD1_Pos       7            /**< \brief (DSU_STATUSB) Boot ROM Communication Channel 1 Dirty */
#define DSU_STATUSB_BCCD1           (_U_(1) << DSU_STATUSB_BCCD1_Pos)
#define DSU_STATUSB_BCCD_Pos        6            /**< \brief (DSU_STATUSB) Boot ROM Communication Channel x Dirty */
#define DSU_STATUSB_BCCD_Msk        (_U_(0x3) << DSU_STATUSB_BCCD_Pos)
...
#define DSU_STATUSC_MASK            _U_(0x00)    /**< \brief (DSU_STATUSC) MASK Register */
...
#define DSU_CFG_MASK                _U_(0x0000000F) /**< \brief (DSU_CFG) MASK Register */

/* -------- DSU_BCC : (DSU Offset: 0x0020) (R/W 32) Boot ROM Communication Channel n -------- */
#if !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
typedef union {
  struct {
    uint32_t DATA:32;          /*!< bit:  0..31  Data                               */
...
#define DSU_BCC_OFFSET              0x0020       /**< \brief (DSU_BCC offset) Boot ROM Communication Channel n */
#define DSU_BCC_RESETVALUE          _U_(0x00000000) /**< \brief (DSU_BCC reset_value) Boot ROM Communication Channel n */

#define DSU_BCC_DATA_Pos            0            /**< \brief (DSU_BCC) Data */
#define DSU_BCC_DATA_Msk            (_U_(0xFFFFFFFF) << DSU_BCC_DATA_Pos)
#define DSU_BCC_DATA(value)         (DSU_BCC_DATA_Msk & ((value) << DSU_BCC_DATA_Pos))
#define DSU_BCC_MASK                _U_(0xFFFFFFFF) /**< \brief (DSU_BCC) MASK Register */
...
typedef struct {
  ...
  __IO DSU_BCC_Type              BCC[2];      /**< \brief Offset: 0x0020 (R/W 32) Boot ROM Communication Channel n */
