...
#ifndef _SAML10_GCLK_COMPONENT_
#define _SAML10_GCLK_COMPONENT_

/* ========================================================================== */
/**  SOFTWARE API DEFINITION FOR GCLK */
/* ========================================================================== */
/** \addtogroup SAML10_GCLK Generic Clock Generator */
/*@{*/
...
#define   GCLK_GENCTRL_SRC_DFLLULP_Val    _U_(0x6)   /**< \brief (GCLK_GENCTRL) DFLLULP output */
#define   GCLK_GENCTRL_SRC_FDPLL_Val      _U_(0x7)   /**< \brief (GCLK_GENCTRL) FDPLL output */
...
typedef struct {
  ...
  __IO GCLK_PCHCTRL_Type         PCHCTRL[21]; /**< \brief Offset: 0x80 (R/W 32) Peripheral Clock Control */
} Gclk;
#endif /* !(defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)) */

/*@}*/

#endif /* _SAML10_GCLK_COMPONENT_ */
