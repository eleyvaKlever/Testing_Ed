...
#ifndef _SAML10_PAC_INSTANCE_
#define _SAML10_PAC_INSTANCE_
...
#define REG_PAC_NONSECA            (0x40000054) /**< \brief (PAC) Peripheral non-secure status - Bridge A */
#define REG_PAC_NONSECB            (0x40000058) /**< \brief (PAC) Peripheral non-secure status - Bridge B */
#define REG_PAC_NONSECC            (0x4000005C) /**< \brief (PAC) Peripheral non-secure status - Bridge C */
#define REG_PAC_SECLOCKA           (0x40000074) /**< \brief (PAC) Peripheral secure status locked - Bridge A */
#define REG_PAC_SECLOCKB           (0x40000078) /**< \brief (PAC) Peripheral secure status locked - Bridge B */
#define REG_PAC_SECLOCKC           (0x4000007C) /**< \brief (PAC) Peripheral secure status locked - Bridge C */
#else
...
#define REG_PAC_NONSECA            (*(RoReg  *)0x40000054UL) /**< \brief (PAC) Peripheral non-secure status - Bridge A */
#define REG_PAC_NONSECB            (*(RoReg  *)0x40000058UL) /**< \brief (PAC) Peripheral non-secure status - Bridge B */
#define REG_PAC_NONSECC            (*(RoReg  *)0x4000005CUL) /**< \brief (PAC) Peripheral non-secure status - Bridge C */
#define REG_PAC_SECLOCKA           (*(RoReg  *)0x40000074UL) /**< \brief (PAC) Peripheral secure status locked - Bridge A */
#define REG_PAC_SECLOCKB           (*(RoReg  *)0x40000078UL) /**< \brief (PAC) Peripheral secure status locked - Bridge B */
#define REG_PAC_SECLOCKC           (*(RoReg  *)0x4000007CUL) /**< \brief (PAC) Peripheral secure status locked - Bridge C */
#endif /* (defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__)) */

/* ========== Instance parameters for PAC peripheral ========== */
#define PAC_CLK_AHB_ID              6        // AHB clock index
