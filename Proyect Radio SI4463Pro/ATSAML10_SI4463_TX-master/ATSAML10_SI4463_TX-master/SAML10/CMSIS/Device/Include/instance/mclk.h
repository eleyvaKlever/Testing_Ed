...
#ifndef _SAML10_MCLK_INSTANCE_
#define _SAML10_MCLK_INSTANCE_

/* ========== Register definition for MCLK peripheral ========== */
#if (defined(__ASSEMBLY__) || defined(__IAR_SYSTEMS_ASM__))
#define REG_MCLK_CTRLA             (0x40000800) /**< \brief (MCLK) Control */
...
#else
#define REG_MCLK_CTRLA             (*(RwReg8 *)0x40000800UL) /**< \brief (MCLK) Control */
