...
#define REG_DSU_BCC0               (0x41002020) /**< \brief (DSU) Boot ROM Communication Channel 0 */
#define REG_DSU_BCC1               (0x41002024) /**< \brief (DSU) Boot ROM Communication Channel 1 */
...
#define REG_DSU_BCC0               (*(RwReg  *)0x41002020UL) /**< \brief (DSU) Boot ROM Communication Channel 0 */
#define REG_DSU_BCC1               (*(RwReg  *)0x41002024UL) /**< \brief (DSU) Boot ROM Communication Channel 1 */
