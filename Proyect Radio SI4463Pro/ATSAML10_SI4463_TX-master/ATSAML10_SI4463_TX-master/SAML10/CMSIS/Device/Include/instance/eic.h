...
#define REG_EIC_NSCHK              (0x4000283C) /**< \brief (EIC) Non-secure Interrupt Check Enable */
#define REG_EIC_NONSEC             (0x40002840) /**< \brief (EIC) Non-secure Interrupt */
#else
...
#define REG_EIC_NSCHK              (*(RwReg  *)0x4000283CUL) /**< \brief (EIC) Non-secure Interrupt Check Enable */
#define REG_EIC_NONSEC             (*(RwReg  *)0x40002840UL) /**< \brief (EIC) Non-secure Interrupt */
