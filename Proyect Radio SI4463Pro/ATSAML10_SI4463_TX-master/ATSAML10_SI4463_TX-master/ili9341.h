...
#define DC_ON		(PORT->Group[0].OUTCLR.reg = PORT_PA07);//set 0 PA07
#define DC_OFF          (PORT->Group[0].OUTSET.reg = PORT_PA07);//set 1 PA07
#define RESET_ON 	(PORT->Group[0].OUTCLR.reg = PORT_PA06);//set 0 PA06
#define RESET_OFF 	(PORT->Group[0].OUTSET.reg = PORT_PA06);//set 1 PA06 

/*alternatywny zapis do rejestru OUT bez użycia "atomistyki"*/
//#define DC_ON		(PORT->Group[0].OUT.reg &= ~PORT_PA07);//set 0 PA07
//#define DC_OFF	(PORT->Group[0].OUT.reg |= PORT_PA07);//set 1 PA07
//#define RESET_ON 	(PORT->Group[0].OUT.reg &= ~PORT_PA06);//set 0 PA06
//#define RESET_OFF 	(PORT->Group[0].OUT.reg |= PORT_PA06);//set 1 PA06 
