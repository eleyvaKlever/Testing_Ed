...
{	
	...
	app_command_buf[10]  = 0x20;   // Establezca el período de activación Cristal de 30 Mhz  
	app_command_buf[11]  = 0xfe;   //Adjust target count for VCO calibration in RX mode. signed -2 actual  
    spi_write(12, app_command_buf); 	
} 
